<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Export.aspx.cs" Inherits="Edge.Web.Enquiry.StockQuery.Export" %>
...
<body>
    ...
    <input type="hidden" id="hidStoreID" name="hidStoreID" runat="server" />
...
<%--        <asp:Button ID="btnWord" runat="server" Text="Word" UseSubmitBehavior="False" CssClass="options_button"
        ...
        <asp:Button ID="btnExcel" runat="server" Text="Excel" UseSubmitBehavior="False" CssClass="options_button" OnClick="btnExcel_Click" />
        <ActiveReportsWeb:WebViewer ID="WebViewerStockQueryOrder" runat="server" Height="550"  BorderStyle="None"
            Width="1500">
