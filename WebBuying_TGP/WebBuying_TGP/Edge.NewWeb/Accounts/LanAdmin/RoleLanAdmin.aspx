...
<body>
    ...
    <ext:Form ID="Form2" runat="server" BodyPadding="10px" ShowBorder="false" ShowHeader="false"
        ...
        <Rows>
            <ext:FormRow ID="FormRow1" runat="server">
                <Items>
                    <ext:DropDownList ID="ddlList" runat="server" Label="选择角色" AutoPostBack="True" OnSelectedIndexChanged="ddlList_SelectedIndexChanged">
                    </ext:DropDownList>
    ...
    <ext:Form ID="UpdateForm" runat="server" BodyPadding="10px" ShowBorder="false" ShowHeader="false"
        ...
        <Rows>
            <ext:FormRow ID="FormRow2" runat="server">
                <Items>
                    <ext:TextBox ID="txtModifyLan" runat="server" Label="角色名称">
                    </ext:TextBox>
    ...
    <ext:Form ID="InsertForm" runat="server" BodyPadding="10px" ShowBorder="false" ShowHeader="false"
        ...
        <Rows>
            <ext:FormRow ID="FormRow3" runat="server" ColumnWidths="40% 30% 10% 10%">
                <Items>
                    <ext:TextBox ID="txtNewLan" runat="server" Label="角色名称">
                    </ext:TextBox>
    ...
    <ext:Grid ID="Grid1" ShowHeader="false" runat="server" EnableCheckBoxSelect="True"
        DataKeyNames="RoleID,Description,Lan" ShowBorder="false" AllowPaging="false"
        ForceFit="true" Title="该角色的语言列表" OnRowCommand="Grid1_RowCommand">
        <Toolbars>
        ...
        <Columns>
            <ext:TemplateField Width="60px" HeaderText="角色编码">
                <ItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("RoleID") %>'>
                    </asp:Label>
                </ItemTemplate>
            </ext:TemplateField>
            <ext:TemplateField Width="60px" HeaderText="角色名称">
                <ItemTemplate>
