<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PermissionCategoriesLanAdmin.aspx.cs"
    Inherits="Edge.Web.Accounts.LanAdmin.PermissionCategoriesLanAdmin" %>
...
<body>
    ...
    <ext:Form ID="Form2" runat="server" BodyPadding="10px" 
        ...
        <Rows>
            <ext:FormRow ID="FormRow1" runat="server">
                <Items>
                    <ext:DropDownList ID="ddlList" runat="server" Label="选择权限类别"  AutoPostBack="True"
    ...
    <ext:Form ID="UpdateForm" runat="server" BodyPadding="10px" 
        ...
        <Rows>
            <ext:FormRow ID="FormRow2" runat="server">
                <Items>
                    <ext:TextBox ID="txtModifyLan" runat="server" Label="权限类别名称">
                    </ext:TextBox>
    ...
    <ext:Form ID="InsertForm" runat="server" BodyPadding="10px" 
        ...
        <Rows>
            <ext:FormRow ID="FormRow3" runat="server" ColumnWidths="40% 30% 10% 10%">
                <Items>
                    <ext:TextBox ID="txtNewLan" runat="server" Label="权限类别名称">
                    </ext:TextBox>
    ...
    <ext:Grid ID="Grid1" ShowHeader="false"  runat="server" EnableCheckBoxSelect="True"
        DataKeyNames="CategoryID,Description,Lan" ShowBorder="false" 
         AllowPaging="false" ForceFit="true"  Title="该权限类别的语言列表"
        ...
        <Columns>
            <ext:TemplateField Width="60px" HeaderText="权限类别编码">
                <ItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("CategoryID") %>'>
                    </asp:Label>
                </ItemTemplate>
            </ext:TemplateField>
            <ext:TemplateField Width="60px" HeaderText="权限类别名称">
                <ItemTemplate>
