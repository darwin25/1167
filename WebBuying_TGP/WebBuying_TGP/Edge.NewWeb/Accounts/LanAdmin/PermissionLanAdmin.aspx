<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PermissionLanAdmin.aspx.cs"
    Inherits="Edge.Web.Accounts.LanAdmin.PermissionLanAdmin" %>
...
<body>
    ...
    <ext:Form ID="Form2" runat="server" BodyPadding="10px" 
        ShowBorder="false" ShowHeader="false" Title="&nbsp;" LabelAlign="Right">
        <Rows>
            <ext:FormRow ID="FormRow1" runat="server" ColumnWidths="40% 40% 20%">
                <Items>
                    <ext:DropDownList ID="ddlCategoryList" runat="server" Label="选择类别权限" AutoPostBack="True"
                        OnSelectedIndexChanged="ddlCategoryList_SelectedIndexChanged" >
                    </ext:DropDownList>
                    <ext:DropDownList ID="ddlList" runat="server" Label="选择权限" AutoPostBack="True" OnSelectedIndexChanged="ddlList_SelectedIndexChanged" >
                    </ext:DropDownList>
    ...
    <ext:Form ID="UpdateForm" runat="server" BodyPadding="10px" 
        ShowBorder="false" ShowHeader="false" Title="&nbsp;" LabelAlign="Right">
        <Rows>
            <ext:FormRow ID="FormRow2" runat="server">
                <Items>
                    <ext:TextBox ID="txtModifyLan" runat="server" Label="权限名称">
                    </ext:TextBox>
    ...
    <ext:Form ID="InsertForm" runat="server" BodyPadding="10px" 
        ShowBorder="false" ShowHeader="false" Title="&nbsp;" LabelAlign="Right" LabelWidth="150">
        <Rows>
            <ext:FormRow ID="FormRow3" runat="server" ColumnWidths="40% 30% 10% 10%">
                <Items>
                    <ext:TextBox ID="txtNewLan" runat="server" Label="权限名称">
                    </ext:TextBox>
    ...
    <ext:Grid ID="Grid1" ShowHeader="false"  runat="server" EnableCheckBoxSelect="True"
        DataKeyNames="PermissionID,Description,Lan" ShowBorder="false" 
         AllowPaging="false" ForceFit="true"  Title="该角色的语言列表"
        ...
        <Columns>
            <ext:TemplateField Width="60px" HeaderText="权限编码">
                <ItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("PermissionID") %>'>
                    </asp:Label>
                </ItemTemplate>
            </ext:TemplateField>
