...
namespace Edge.Web.Accounts
{
    ...
    public partial class Index : PageBase
	{
		...
		{            			
			...
			{
                SVASessionInfo.MessageOfApprove = Resources.MessageTips.YouNotApprove;
                SVASessionInfo.ReturnPage = Request.RawUrl;
			...
			{
                SVASessionInfo.MessageOfApprove = Resources.MessageTips.YouNotUserPermission;
                SVASessionInfo.ReturnPage = Request.RawUrl;
				Response.Redirect("../Login.aspx",true);
			}
