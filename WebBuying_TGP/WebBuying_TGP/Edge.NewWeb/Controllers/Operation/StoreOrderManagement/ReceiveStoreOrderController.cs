...
namespace Edge.Web.Controllers.Operation.StoreOrderManagement.ReceiveStoreOrder
{
    public class ReceiveStoreOrderController
    {
        ...
        public DataSet GetTransactionList(string strWhere, int pageSize, int pageIndex, out int recodeCount, string sortFieldStr)
        {
            ...
            DataSet ds;
            Edge.SVA.BLL.Ord_ReceiveOrder_H bll = new Edge.SVA.BLL.Ord_ReceiveOrder_H()
            {
                StrWhere = strWhere,
                Order = "CreatedOn",
                Fields = fields,
            ...
            //获取排序字段
            string orderStr = "ReceiveOrderNumber";
        ...
        public static string Approve(Edge.SVA.Model.Ord_ReceiveOrder_H model, out bool isSuccess)
        {
            isSuccess = false;
            ...
            if (bll.Update(model))
            {
                model = new Edge.SVA.BLL.Ord_ReceiveOrder_H().GetModel(model.ReceiveOrderNumber);
                isSuccess = true;
        ...
        public static string Void(Edge.SVA.Model.Ord_ReceiveOrder_H model, out bool isSuccess)
        {
            isSuccess = false;
            if (model == null) return "No Data";
        ...
        {
            Edge.SVA.BLL.Ord_ReceiveOrder_H bll = new Edge.SVA.BLL.Ord_ReceiveOrder_H();
            DataSet ds = bll.ExportStoreReceiveData(ReceiveOrderNumber, OrderType);
            return ds;
        }
        ...
        {
            Edge.SVA.BLL.Ord_ReceiveOrder_H bll = new Edge.SVA.BLL.Ord_ReceiveOrder_H();
            DataSet ds = bll.GetReceiveOrderHeader(ShipmentOrderNumber);
            return ds;
        }
        ...
        {
            Edge.SVA.BLL.Ord_ReceiveOrder_H bll = new Edge.SVA.BLL.Ord_ReceiveOrder_H();
            DataSet ds = bll.GetReceiveOrderDetail(ShipmentOrderNumber);
            return ds;
        }
    }
}