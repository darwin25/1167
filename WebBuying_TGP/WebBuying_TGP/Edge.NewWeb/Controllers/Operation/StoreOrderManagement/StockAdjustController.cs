...
namespace Edge.Web.Controllers.Operation.StoreOrderManagement.StockAdjust
{
    public class StockAdjustController
    {
        private const string fields = " [StockAdjustNumber],[OrderType],[ReferenceNo],[StoreID],[Remark],[CreatedBusDate],[ApproveBusDate],[ApprovalCode],[ApproveStatus],[ApproveOn],[ApproveBy],[CreatedOn],[CreatedBy],[UpdatedOn],[UpdatedBy]";
        ...
        public DataSet GetTransactionList(string strWhere, int pageSize, int pageIndex, out int recodeCount, string sortFieldStr)
        {
            ...
            //获取排序字段
            string orderStr = "StockAdjustNumber";
        ...
        public static string Approve(Edge.SVA.Model.Ord_StockAdjust_H model, out bool isSuccess)
        {
            isSuccess = false;
            ...
            if (bll.Update(model))
            {
                model = new Edge.SVA.BLL.Ord_StockAdjust_H().GetModel(model.StockAdjustNumber);
                isSuccess = true;
        ...
        public static string Void(Edge.SVA.Model.Ord_StockAdjust_H model, out bool isSuccess)
        {
            isSuccess = false;
            if (model == null) return "No Data";
