...
namespace Edge.Web.Controllers.Operation.StoreOrderManagement.TransOutStoreOrder
{
    public class TransOutStoreOrderController
    {
        ...
        public DataSet GetTransactionList(string strWhere, int pageSize, int pageIndex, out int recodeCount, string sortFieldStr)
        {
            ...
            DataSet ds;
            Edge.SVA.BLL.Ord_TransOutOrder_H bll = new Edge.SVA.BLL.Ord_TransOutOrder_H()
            {  
                StrWhere = strWhere,
                Order = "CreatedOn",
                Fields = fields,
            ...
            //获取排序字段
            string orderStr = "TransOutOrderNumber";
        ...
        public static string Approve(Edge.SVA.Model.Ord_TransOutOrder_H model, out bool isSuccess)
        {
            isSuccess = false;
            ...
            if (bll.Update(model))
            {
                model = new Edge.SVA.BLL.Ord_TransOutOrder_H().GetModel(model.TransOutOrderNumber);
                isSuccess = true;
        ...
        public static string Void(Edge.SVA.Model.Ord_TransOutOrder_H model, out bool isSuccess)
        {
            isSuccess = false;
            if (model == null) return "No Data";
