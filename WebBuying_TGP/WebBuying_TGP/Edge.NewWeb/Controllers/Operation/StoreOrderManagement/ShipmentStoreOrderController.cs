...
namespace Edge.Web.Controllers.Operation.StoreOrderManagement.ShipmentStoreOrder
{
    public class ShipmentStoreOrderController
    {
        ...
        public DataSet GetTransactionList(string strWhere, int pageSize, int pageIndex, out int recodeCount, string sortFieldStr)
        {
            ...
            DataSet ds;
            Edge.SVA.BLL.Ord_ShipmentOrder_H bll = new Edge.SVA.BLL.Ord_ShipmentOrder_H()
            {
                StrWhere = strWhere,
                Order = "CreatedOn",
                Fields = fields,
            ...
            //获取排序字段
            string orderStr = "ShipmentOrderNumber";
        ...
        public static string Approve(Edge.SVA.Model.Ord_ShipmentOrder_H model, out bool isSuccess)
        {
            isSuccess = false;
            ...
            if (bll.Update(model))
            {
                model = new Edge.SVA.BLL.Ord_ShipmentOrder_H().GetModel(model.ShipmentOrderNumber);
                isSuccess = true;
        ...
        public static string Void(Edge.SVA.Model.Ord_ShipmentOrder_H model, out bool isSuccess)
        {
            isSuccess = false;
            if (model == null) return "No Data";
