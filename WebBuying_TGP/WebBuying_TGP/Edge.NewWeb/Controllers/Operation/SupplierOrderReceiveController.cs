...
namespace Edge.Web.Controllers.Operation.SupplierOrderReceive
{
    public class SupplierOrderReceiveController
    {
        private const string fields = " [HQReceiveOrderNumber],[OrderType],[ReferenceNo],[ReceiveType],[FromStoreID],[FromContactName],[FromContactPhone],[FromMobile],[FromEmail],[FromAddress],[StoreID],[StoreContactName],[StoreContactPhone],[StoreContactEmail],[StoreMobile],[StoreAddress],[Remark],[CreatedBusDate],[ApproveBusDate],[ApprovalCode],[ApproveStatus],[ApproveOn],[ApproveBy],[CreatedOn],[CreatedBy],[UpdatedOn],[UpdatedBy]";
        ...
        public DataSet GetTransactionList(string strWhere, int pageSize, int pageIndex, out int recodeCount, string sortFieldStr)
        {
            ...
            DataSet ds;
            Edge.SVA.BLL.Ord_HQReceiveOrder_H bll = new Edge.SVA.BLL.Ord_HQReceiveOrder_H()
            {
                StrWhere = strWhere,
                Order = "CreatedOn",
                Fields = fields,
            ...
            //获取排序字段
            string orderStr = "HQReceiveOrderNumber";
        ...
        public static string Approve(Edge.SVA.Model.Ord_HQReceiveOrder_H model, out bool isSuccess)
        {
            isSuccess = false;
            ...
            if (bll.Update(model))
            {
                model = new Edge.SVA.BLL.Ord_HQReceiveOrder_H().GetModel(model.HQReceiveOrderNumber);
                isSuccess = true;
        ...
        public static string Void(Edge.SVA.Model.Ord_HQReceiveOrder_H model, out bool isSuccess)
        {
            isSuccess = false;
            if (model == null) return "No Data";
