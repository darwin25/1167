...
<%@ Page Language="c#" ValidateRequest="false" CodeBehind="modify.aspx.cs" AutoEventWireup="True"
    Inherits="Edge.Web.SysManage.modify" %>
...
<body>
    ...
    <ext:SimpleForm ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server"
        ...
        <Items>
            <ext:HiddenField ID="hfID" runat="server">
            </ext:HiddenField>
            ...
            <ext:DropDownList ID="ddlCategoryList" runat="server" Label="权限类别" OnSelectedIndexChanged="ddlCategoryList_SelectedIndexChanged"
                AutoPostBack="True">
            </ext:DropDownList>
