	...
	public partial class show : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			if(!Page.IsPostBack)
			{
				...
				if(node.ParentID==0)
				{
                    this.lblTarget.Text = Resources.MessageTips.Root;
				}
				else
				{
				...
				Edge.Security.Manager.Permissions perm=new Edge.Security.Manager.Permissions();
				if(node.PermissionID==-1)
				{
                    this.lblPermission.Text = Resources.MessageTips.NotPermissionLimit;
				}
				else
				{
...
//				if(node.KeShiDM!=-1)
//				{
//					this.lblModuledept.Text=Edge.BLL.PubConstant.GetKeshiName(node.KeShiDM);
//				}
//				else
//				{
