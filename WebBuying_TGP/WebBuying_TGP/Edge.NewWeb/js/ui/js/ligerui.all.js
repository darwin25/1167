...
(function ($)
{
    ...
    $.ligerDefaults.Dialog = {
        ...
        allowClose: true, //允许Close
        opener: null,
        timeParmName: null,  //是否给URL后面加上值为new Date().getTime()的参数，如果需要指定一个参数名即可
        closeWhenEnter: null, //回车时是否Closedialog
        isHidden: true,        //Close对话框时是否只是隐藏，还是销毁对话框
...
(function ($)
{
    ...
    //@description 默认表单Edit器构造器扩展(如果创建的表单效果不满意 建议重载)
...
(function ($)
{
    ...
    $.ligerDefaults.Grid = {
        ...
        onBeforeEdit: null,                      //Edit前事件
        onBeforeSubmitEdit: null,               //验证Edit器结果是否通过
        onAfterEdit: null,                       //结束Edit后事件
        ...
        clickToEdit: true,                      //是否点击单元格的时候就Edit
        detailToEdit: false,                     //是否点击明细的时候进入Edit
        onEndEdit: null,
        minColumnWidth: 80,
    ...
    $.ligerui.controls.Grid.ligerExtend($.ligerui.core.UIComponent, {
        ...
        _render: function ()
        {
            ...
            g.currentData = null;
            g.changedCells = {};
            g.editors = {};                 //多Edit器同时存在
            g.editor = { editing: false };  //单Edit器,配置clickToEdit
            if (p.height == "auto")
            {
        ...
        /*
        @description 使一行进入Edit状态
        @param  {rowParm} rowindex或者rowdata
        @param {containerBulider} Edit器填充层构造器
        */
        ...
        _onClick: function (e)
        {
            ...
            else if (src.groupbtn)
            {
                ...
                while (true)
                {
                    ...
                    {
                        currentRow.show();
                        //如果是明细展开的行，并且之前的状态已经是Close的，隐藏之
...
(function ($)
{
    ...
    $.ligerDefaults.Tab = {
        ...
        changeHeightOnResize: false,
        contextmenu: true,
        dblClickToClose: false, //是否双击时Close
    ...
    $.ligerDefaults.TabString = {
        closeMessage: "Close当前页",
        closeOtherMessage: "Close其他",
        closeAllMessage: "Close所有",
        reloadMessage: "刷新"
    };
...
(function ($)
{
    ...
    //Close指定在Dom Element(附加了ligerui对象ID,属性名"ligeruitipid")显示的气泡
    ...
    $.ligerDefaults.Tip = {
        ...
        target: null,
        auto: null,             //是否自动模式，如果是，那么：鼠标经过时显示，移开时Close,并且当content为空时自动读取attr[title]
