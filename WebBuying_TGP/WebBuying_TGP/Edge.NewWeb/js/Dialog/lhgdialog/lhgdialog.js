...
lhgdialog.fn =
{
	...
	_init: function( config )
	{
		...
		DOM.close[config.cancel===false?'hide':'show'](true); //当cancel参数为false时隐藏Close按钮
	 ...
	 * @param   {Function}  Close窗口前执行的回调函数
	 */
	...
	_reset: function( test )
	{
		...
		//IE9以下的IE会在Close遮罩时使之前打开的窗口回到原位的BUG 
...
lhgdialog.setting =
{
	...
	close: null,				// 对话框Close前执行的函数
	okVal: '\u786E\u5B9A',		// 确定按钮文本. 默认'确定'
	cancelVal: '\u53D6\u6D88',	// 取消按钮文本. 默认'取消'
	skin: '',					// 皮肤名
	esc: true,					// 是否支持Esc键Close
