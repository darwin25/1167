<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Edge.Web.Operation.SupplierOrder.Add" %>
                        ...
                        <Rows>
                            <ext:FormRow>
                                <Items>
                                    ...
                                    <ext:TextBox ID="SupplierAddress" runat="server" Label="Address">
                                    </ext:TextBox>
                                </Items>
                            </ext:FormRow>
                            <ext:FormRow>
                                <Items>
                                    <ext:TextBox ID="SupplierContactName" runat="server" Label="Contact">
                                    </ext:TextBox>
                                    <ext:TextBox ID="SupplierPhone" runat="server" Label="Contact Phone">
                                    </ext:TextBox>
                                </Items>
                            </ext:FormRow>
                        </Rows>
