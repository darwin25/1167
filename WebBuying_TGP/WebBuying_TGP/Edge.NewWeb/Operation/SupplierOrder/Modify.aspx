<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Edge.Web.Operation.SupplierOrder.Modify" %>
                ...
                <Items>
                    ...
                    <ext:Form ID="sform1" runat="server" ShowBorder="false" ShowHeader="false" Title=""
                        ...
                        <Rows>
                            <ext:FormRow>
                                <Items>
                                    <ext:Label ID="POCode" runat="server" Label="Transaction Number">
                                    </ext:Label>
                            ...
                            <ext:FormRow>
                                <Items>
                                    <ext:DatePicker ID="ExpectDate" runat="server" Label="Expected Delivery Date" Required="true" ShowRedStar="true">
                                    </ext:DatePicker>
                ...
                <Items>
                    <ext:Form ID="sForm4" runat="server" ShowBorder="false" ShowHeader="false" Title=""
                        ...
                        <Rows>
                            <ext:FormRow>
                                <Items>
                                    <ext:DropDownList ID="VendorID" runat="server" Label="Supplier ID" OnSelectedIndexChanged="SupplierID_SelectedIndexChanged"
                                        AutoPostBack="True"  Required="true" ShowRedStar="true">
                                    </ext:DropDownList>
                                    <ext:Label ID="SupplierAddress" runat="server" Label="Address">
                                    </ext:Label>
                                </Items>
                            </ext:FormRow>
                            <ext:FormRow>
                                <Items>
                                    <ext:Label ID="SupplierContactName" runat="server" Label="Contact">
                                    </ext:Label>
                                    <ext:Label ID="SupplierPhone" runat="server" Label="Contact Phone">
                                    </ext:Label>
                                </Items>
                            </ext:FormRow>
                        </Rows>
                           ...
                           <ext:FormRow>
                            ...
                            <ext:FormRow>
                                <Items>
                                    ...
                                    <ext:Label ID="StorePhone" runat="server" Label="Contact Phone">
                                    </ext:Label>
                                </Items>
                            </ext:FormRow>
                        </Rows>
            ...
            <ext:GroupPanel ID="GroupPanel4" runat="server" EnableCollapse="True" Title="Order Details">
                <Items>
                    <ext:Grid ID="Grid2" ShowBorder="false" ShowHeader="false"  PageSize="3"
                        ...
                        OnPageIndexChange="Grid2_PageIndexChange" OnRowCommand="Grid2_RowCommand" EnableSummary="true" SummaryPosition="Bottom">
                        <Toolbars>
                        ...
                        <Columns>
                            ...
                            <ext:BoundField Width="60px" DataField="QTY" HeaderText="Order Quantity"  ColumnID="onhandQty" ></ext:BoundField>
