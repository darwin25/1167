<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Show.aspx.cs" Inherits="Edge.Web.Operation.SupplierOrder.Show" %>
                ...
                <Items>
                    ...
                    <ext:Form ID="sform1" runat="server" ShowBorder="false" ShowHeader="false" Title=""
                        ...
                        <Rows>
                            <ext:FormRow>
                                <Items>
                                    <ext:Label ID="POCode" runat="server" Label="Transaction Number" Width="200">
                                    </ext:Label>
                            ...
                            <ext:FormRow>
                                <Items>
                                    <ext:Label ID="ExpectDate" runat="server" Label="Expected Delivery Date">
                                    </ext:Label>
                ...
                <Items>
                    <ext:Form ID="sForm4" runat="server" ShowBorder="false" ShowHeader="false" Title=""
                        ...
                        <Rows>
                            <ext:FormRow>
                                <Items>
                                    <ext:Label ID="lblSupplierID" runat="server" Label="Supplier ID">
                                    </ext:Label>
                                    <ext:Label ID="lblSupplierAddress" runat="server" Label="Address">
                                    </ext:Label>
                                </Items>
                            </ext:FormRow>
                            <ext:FormRow>
                                <Items>
                                    <ext:Label ID="lblSupplierContactName" runat="server" Label="Contact">
                                    </ext:Label>
                                    <ext:Label ID="lblSupplierPhone" runat="server" Label="Contact Phone">
                                    </ext:Label>
                                </Items>
                            </ext:FormRow>
                        </Rows>
                ...
                <Items>
                    <ext:Form ID="sform2" runat="server" ShowBorder="false" ShowHeader="false" Title=""
                        ...
                        <Rows>
                            <ext:FormRow>
                                <Items>
                                    <ext:Label ID="lblStoreID" runat="server" Label="Warehouse">
                                    </ext:Label>
                                    <ext:Label ID="lblStoreAddress" runat="server" Label="Address">
                                    </ext:Label>
                                </Items>
                            </ext:FormRow>
                            <ext:FormRow>
                                <Items>
                                    <ext:Label ID="lblStoreContactName" runat="server" Label="Contact">
                                    </ext:Label>
                                    <ext:Label ID="lblStorePhone" runat="server" Label="Contact Phone">
                                    </ext:Label>
                                </Items>
                            </ext:FormRow>
                        </Rows>
