<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Print.aspx.cs" Inherits="Edge.Web.Operation.SupplierOrder.Print" %>
...
<body>
    <form name="formSubmit" id="formSubmit" runat="server" method="post" action="/Operation/SupplierOrder/Print.aspx">
    ...
    <ActiveReportsWeb:WebViewer ID="WebViewerSupplierOrderList" runat="server" Width="100%"
