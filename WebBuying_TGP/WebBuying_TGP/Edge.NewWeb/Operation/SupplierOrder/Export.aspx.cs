...
namespace Edge.Web.Operation.SupplierOrder
{
    public partial class Export : PageBase
    {
        ...
        {
            this.WebViewerSupplierOrderList.FlashViewerOptions.ResourceLocale = Request.Form["hidlanguage"];
            ...
            rpt.DataSource = reportTool.GetDataBind(Request.Form["hidIds"], webset.WebName, "SupplierOrder");
            rpt.DataMember = "";
            rpt.Run();
            WebViewerSupplierOrderList.Report = rpt;
...
GrapeCity.ActiveReports.Export.Word.Section.RtfExport();
            ...
            {
                exportlanguage = "SupplierOrders";
            }
            else if (Request.Form["hidlanguage"] == "zh-cn")
            {
                exportlanguage = "供应商订单";
            }
            else
            {
                exportlanguage = "供應商訂單";
            }
