<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Export.aspx.cs" Inherits="Edge.Web.Operation.StockTake.Export" %>
...
<body>
    ...
    <input type="hidden" id="hidlanguage" name="hidlanguage" runat="server" />
     <input type="hidden" id="hidControlName" name="hidControlName" runat="server" />
    ...
    <ActiveReportsWeb:WebViewer ID="WebViewerStockTake" runat="server" Height="650"
        Width="100%"   >
