<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Print.aspx.cs" Inherits="Edge.Web.Operation.StockTake.Print" %>
...
<body>
    <form name="formSubmit" id="formSubmit" runat="server" method="post" action="/Operation/StockTake/Print.aspx">
    ...
    <ActiveReportsWeb:WebViewer ID="WebViewerStockTake" runat="server" Width="100%"
