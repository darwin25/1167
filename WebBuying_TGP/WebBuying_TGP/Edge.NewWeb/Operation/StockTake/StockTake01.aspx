<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StockTake01.aspx.cs" Inherits="Edge.Web.Operation.StockTake.StockTake01" %>
...
<body>
    ...
    <ext:Panel ID="Panel1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
        ...
        <Items>
            <ext:GroupPanel ID="GroupPanel1" runat="server" EnableCollapse="True" Title="库存盘点一">
                <Items>
                    <ext:Grid ID="Grid1" ShowBorder="false" ShowHeader="false" PageSize="3" runat="server"
                        ...
                        ClicksToEdit="1" OnSort="Grid1_Sort" AllowSorting="true" SortDirection="ASC"  AllowCellEditing="true" EnableSummary="true" SummaryPosition="Bottom">
                        <Columns>
