<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Approve.aspx.cs" Inherits="Edge.Web.Operation.StockTake.Approve" %>
...
<body >
    ...
    <ext:Grid ID="Grid1" ShowBorder="false" ShowHeader="false" 
        ...
        <Columns>
            <ext:TemplateField Width="60px" HeaderText="Inventory Number">
                <ItemTemplate>
             ...
             <ext:TemplateField Width="60px" HeaderText="Status">
                <ItemTemplate>
                    <asp:Label ID="Label1" runat="server" Text='<%# Eval("Status") %>' ForeColor="Red"></asp:Label>
                </ItemTemplate>
            </ext:TemplateField>
        </Columns>
    </ext:Grid>
