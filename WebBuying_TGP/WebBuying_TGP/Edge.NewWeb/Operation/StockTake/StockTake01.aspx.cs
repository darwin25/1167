...
{
    public partial class StockTake01 : Edge.Web.Tools.BasePage<Edge.SVA.BLL.STK_STake01, Edge.SVA.Model.STK_STAKE01>
    {
        DataSet detail;
        ...
        protected override void OnLoadComplete(EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                ...
                int count = 0;
                detail = controller.GetSTK01(strWhere, Grid1.PageSize, Grid1.PageIndex, out count, "ProdCode");
        ...
        protected void btnSaveClose_Click(object sender, EventArgs e)
        {
            ...
            {
                Logger.Instance.WriteOperationLog(this.PageName, "STK_STAKE01 no data");
            ...
            {
                Edge.SVA.Model.STK_STAKE01 item = new SVA.Model.STK_STAKE01();
                ...
                if (modifiedDict.ContainsKey(i))
                {
                    ...
                    if (rowDict.ContainsKey("Panel1_GroupPanel1_Grid1_ctl04"))
                    {
                        ...
                        try
                        {
                            Tools.DALTool.Update<Edge.SVA.BLL.STK_STake01>(item);
                        }
                        catch (Exception ex)
                        {
                            Logger.Instance.WriteErrorLog(this.PageName, string.Format("Stock Take 01 {0} Update Failed", item.StockTakeNumber), ex);
                            ShowAddFailed();
                            return;
                        }
                    }
            ...
            controller.UpdateStatus(Request.Params["id"], 2);
            Logger.Instance.WriteOperationLog(this.PageName, " Stock Take 01 Update Success");
            CloseAndRefresh();
        }

        protected override SVA.Model.STK_STAKE01 GetPageObject(SVA.Model.STK_STAKE01 obj)
        {
        ...
        private void BindGridWithSort(string sortField, string sortDirection)
        {
            ...
            string strWhere = "StockTakeNumber='" + StockTakeNumber + "'";
            int count = 0;
            DataSet ds = controller.GetSTK01(strWhere, Grid1.PageSize, Grid1.PageIndex, out count, "ProdCode");
