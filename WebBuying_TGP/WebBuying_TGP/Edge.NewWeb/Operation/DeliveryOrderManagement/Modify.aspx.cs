...
{
    public partial class Modify : Edge.Web.Tools.BasePage<Edge.SVA.BLL.Sales_H, Edge.SVA.Model.Sales_H>
    {
        ...
        protected override void OnLoadComplete(EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                ...
                if (controller.ViewModel.MainTable != null)
                {
                    ...
                    Status.Text =controller.ViewModel.MainTable.Status.ToString();
                    //交易日期
                    ...
                    //物流公司
                    LogisticsProviderID.Text = controller.ViewModel.MainTable.LogisticsProviderID.ToString();
                    //送货员
        ...
        protected void btnSaveClose_Click(object sender, EventArgs e)
        {
            ...
            if (controller.ViewModel.MainTable != null)
            {
                ...
                controller.ViewModel.MainTable.Status = this.Status.SelectedValue == "-1" ? 0 :Convert.ToInt32(this.Status.SelectedValue);
                controller.ViewModel.MainTable.DeliveryNumber = this.DeliveryNumber.Text;
            }

            ExecResult er = controller.Update();
            if (er.Success)
            {
                Tools.Logger.Instance.WriteOperationLog(this.PageName, "Update LogisticsPrice Success TransNum:" + controller.ViewModel.MainTable.TransNum.ToString());
                CloseAndRefresh();
            }
            else
            {
                Tools.Logger.Instance.WriteOperationLog(this.PageName, "Update LogisticsPrice Failed TransNum:" + controller.ViewModel.MainTable == null ? "No Data" : controller.ViewModel.MainTable.TransNum.ToString());
            }
        }
