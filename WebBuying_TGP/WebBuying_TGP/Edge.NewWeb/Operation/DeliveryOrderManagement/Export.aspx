<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Export.aspx.cs" Inherits="Edge.Web.Operation.DeliveryOrderManagement.Export" %>
...
<body>
    <form name="formSubmit" id="formSubmit" runat="server" metohd="post" action="/Operation/DeliveryOrderManagement/Export.aspx">
    ...
    <div style="margin-bottom: 10px;">
        ...
        <ActiveReportsWeb:WebViewer ID="WebViewerDeliveryOrderList" runat="server"
            Height="650" Width="100%" ViewerType="FlashViewer">
            <FlashViewerOptions MultiPageViewColumns="1" MultiPageViewRows="1"  url="/Flash/Grapecity.ActiveReports.Flash.v10.swf"   resourceurl="/Flash/Grapecity.ActiveReports.Flash.v10.Resources.swf">
            </FlashViewerOptions>
