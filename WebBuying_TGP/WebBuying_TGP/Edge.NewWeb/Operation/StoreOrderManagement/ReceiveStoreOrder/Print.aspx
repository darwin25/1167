<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Print.aspx.cs" Inherits="Edge.Web.Operation.StoreOrderManagement.ReceiveStoreOrder.Print" %>
...
<body>
    <form name="formSubmit" id="formSubmit" runat="server" method="post" action="/Operation/StoreOrderManagement/ReceiveStoreOrder/Print.aspx">
    ...
    <ActiveReportsWeb:WebViewer ID="WebViewerReceiveStoreOrder" runat="server" Width="100%"
