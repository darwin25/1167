...
namespace Edge.Web.Operation.StoreOrderManagement.ReceiveStoreOrder
{
    public partial class List : PageBase
    {
            ...
            try
            {
                ...
                if (SearchFlag.Text == "1")
                {
                    ...
                    if (!string.IsNullOrEmpty(code))
                    {
                        ...
                        sb.Append(" ReceiveOrderNumber like '%");
                        sb.Append(code);
                        sb.Append("%'");
                    }
                    ...
                    if (!string.IsNullOrEmpty(prodcode))
                    {
                        ...
                        sb.Append(" exists(select d.prodcode from ord_receiveorder_d d where d.receiveordernumber=ord_receiveorder_h.receiveordernumber and prodcode='");
                        sb.Append(prodcode);
                        sb.Append("')");
                    }
                    if (!string.IsNullOrEmpty(proddesc))
                    {
                        ...
                        sb.Append(" exists(select d.prodcode from ord_receiveorder_d d left join buy_product p on d.prodcode=p.prodcode where d.receiveordernumber=ord_receiveorder_h.receiveordernumber and proddesc1+proddesc2+proddesc3 like '%");
                        sb.Append(proddesc);
                        sb.Append("%')");
                    }
        ...
        protected void btnApprove_Click(object sender, EventArgs e)
        {
            ...
            //ExportStoreReceiveData(Grid1, 1);
        }
        //作废
        ...
        public void ExportStoreReceiveData(FineUI.Grid Grid, int OrderType)
        {
            ...
            foreach (int row in Grid.SelectedRowIndexArray)
            {
                ...
                ds = controller.ExportStoreReceiveData(Grid.DataKeys[row][0].ToString(), OrderType);
        ...
        private void SaveCSV(DataSet ds, string fullPath)
        {
