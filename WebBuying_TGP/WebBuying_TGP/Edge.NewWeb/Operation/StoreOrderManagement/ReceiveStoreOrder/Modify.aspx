<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Edge.Web.Operation.StoreOrderManagement.ReceiveStoreOrder.Modify" %>
                ...
                <Items>
                    ...
                    <ext:Form ID="sform1" runat="server" ShowBorder="false" ShowHeader="false" Title=""
                        ...
                        <Rows>
                            <ext:FormRow>
                                <Items>
                                    <ext:Label ID="ReceiveOrderNumber" runat="server" Label="Transaction Number">
                                    </ext:Label>
                            ...
                            <ext:FormRow>
                                <Items>
                                    ...
                                    <ext:Label ID="ShipmentOrderNumber" runat="server" Label="Shipment Order Number">
                                    </ext:Label>
                                </Items>
                            </ext:FormRow>
                            <ext:FormRow>
                                <Items>
                                    <ext:Label ID="StoreOrderNumber" runat="server" Label="Store Order Number">
                                    </ext:Label>
                                    <ext:Label ID="PickingOrderNumber" runat="server" Label="HQ Order Number">
                                    </ext:Label>
                                </Items>
                            </ext:FormRow>
                        </Rows>
                ...
                <Items>
                    <ext:Form ID="sForm4" runat="server" ShowBorder="false" ShowHeader="false" Title=""
                        ...
                        <Rows>
                            <ext:FormRow>
                                <Items>
                                    <ext:DropDownList ID="FromStoreID" runat="server" Label="Warehouse" OnSelectedIndexChanged="FromStoreID_SelectedIndexChanged"
            ...
            <ext:GroupPanel ID="GroupPanel3" runat="server" EnableCollapse="True" Title="Search Details">
                <Items>
                    ...
                    <ext:Grid ID="Grid1" ShowBorder="false" ShowHeader="false" PageSize="3" runat="server"
                        EnableCheckBoxSelect="true" DataKeyNames="KeyID" AllowPaging="true" ForceFit="true" OnPageIndexChange="Grid1_PageIndexChange">
                        <Toolbars>
            ...
            <ext:GroupPanel ID="GroupPanel4" runat="server" EnableCollapse="True" Title="Receipt List Details">
                <Items>
                    <ext:Grid ID="Grid2" ShowBorder="false" ShowHeader="false" PageSize="3" runat="server"
                        ...
                        OnRowCommand="Grid2_RowCommand" EnableSummary="true" SummaryPosition="Bottom">
                        <Toolbars>
                        ...
                        <Columns>
                            ...
                            <ext:BoundField Width="60px" DataField="ReceiveQTY" HeaderText="Receipt Quantity" ColumnID="receiveQty" ></ext:BoundField>
                            <ext:BoundField Width="60px" DataField="Price" HeaderText="Order Amount" DataFormatString="{0:F2}" ColumnID="money" ></ext:BoundField>
