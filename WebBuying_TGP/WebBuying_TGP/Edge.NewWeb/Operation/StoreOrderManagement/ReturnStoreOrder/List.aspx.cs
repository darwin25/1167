...
namespace Edge.Web.Operation.StoreOrderManagement.ReturnStoreOrder
{
    public partial class List : PageBase
    {
        ...
        ReturnStoreOrderController controller = new ReturnStoreOrderController();
            ...
            try
            {
                ...
                if (SearchFlag.Text == "1")
                {
                    ...
                    if (!string.IsNullOrEmpty(code))
                    {
                        ...
                        sb.Append(" ReturnOrderNumber like '%");
                        sb.Append(code);
                        sb.Append("%'");
                    }
                    ...
                    if (!string.IsNullOrEmpty(prodcode))
                    {
                        ...
                        sb.Append(" exists(select d.prodcode from ord_returnorder_d d where d.returnordernumber=ord_returnorder_h.returnordernumber and prodcode='");
                        sb.Append(prodcode);
                        sb.Append("')");
                    }
                    if (!string.IsNullOrEmpty(proddesc))
                    {
                        ...
                        sb.Append(" exists(select d.prodcode from ord_returnorder_d d left join buy_product p on d.prodcode=p.prodcode where d.returnordernumber=ord_returnorder_h.returnordernumber and proddesc1+proddesc2+proddesc3 like '%");
                        sb.Append(proddesc);
                        sb.Append("%')");
                    }
