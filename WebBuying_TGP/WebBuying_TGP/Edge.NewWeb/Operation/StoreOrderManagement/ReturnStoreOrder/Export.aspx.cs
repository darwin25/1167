...
namespace Edge.Web.Operation.StoreOrderManagement.ReturnStoreOrder
{
    public partial class Export : PageBase
    {
        ...
        //英文Url
        protected string enusUrl = "\\StoreOrderManagement\\ReturnStoreOrder\\rptReturnStoreOrderByEnglish.rpx";
        //中文简体Url
        protected string zhcnUrl = "\\StoreOrderManagement\\ReturnStoreOrder\\rptReturnStoreOrder.rpx";
        //中文繁体Url
        protected string zhhkUrl = "\\StoreOrderManagement\\ReturnStoreOrder\\rptReturnStoreOrderByTraditional.rpx";
        #endregion
        ...
        private void LoadReport(string ids, int orderType)
        {
            ...
            reportTool.LoadReport(ids, WebViewerReturnStoreOrder, url, webset.WebName, "ReturnStoreOrder");
        }
        ...
        protected void btnWord_Click(object sender, EventArgs e)
        {
            ...
            this.WebViewerReturnStoreOrder.FlashViewerOptions.ResourceLocale = Request.Form["hidlanguage"];
            ...
            rpt.DataSource = reportTool.GetDataBind(Request.Form["hidIds"], webset.WebName, "ReturnStoreOrder");
            rpt.DataMember = "";
            rpt.Run();
            WebViewerReturnStoreOrder.Report = rpt;
...
GrapeCity.ActiveReports.Export.Word.Section.RtfExport();
            ...
            {
                exportlanguage = "ReturnStoreOrder";
            }
            else if (Request.Form["hidlanguage"] == "zh-cn")
            {
                exportlanguage = "店铺退货单";
            }
            else
            {
                exportlanguage = "店鋪退貨單";
            }
