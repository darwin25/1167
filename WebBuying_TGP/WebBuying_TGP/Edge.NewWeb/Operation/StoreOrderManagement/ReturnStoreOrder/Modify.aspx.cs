...
{
    public partial class Modify : Edge.Web.Tools.BasePage<Edge.SVA.BLL.Ord_ReturnOrder_H, Edge.SVA.Model.Ord_ReturnOrder_H>
    {
        ...
        protected void btnSaveClose_Click(object sender, EventArgs e)
        {
            ...
            Edge.SVA.Model.Ord_ReturnOrder_H item = null;
            Edge.SVA.Model.Ord_ReturnOrder_H dataItem = this.GetDataObject();
            ...
            if (Tools.DALTool.Update<Edge.SVA.BLL.Ord_ReturnOrder_H>(item))
            {
                ...
                {
                    Logger.Instance.WriteErrorLog(this.PageName, string.Format("Return Store Order {0} Update Success But Detail Failed", item.ReturnOrderNumber), ex);
                    ShowAddFailed();
                    return;
                }
                Logger.Instance.WriteOperationLog(this.PageName, string.Format("Return Store Order {0} Update Success", item.ReturnOrderNumber));
                CloseAndRefresh();
            }
        }
        ...
        protected void StoreID_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (model != null)
            {
                ...
                StoreContactName.Text = model.ContactPhone;
