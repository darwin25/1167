<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Edge.Web.Operation.StoreOrderManagement.ReturnStoreOrder.Add" %>
                ...
                <Items>
                    <ext:Grid ID="Grid2" ShowBorder="false" ShowHeader="false" PageSize="3" runat="server"
                        ...
                        <Columns>
                            ...
                            <ext:TemplateField Width="60px" HeaderText="Return Quantity" SortField="ReturnQTY">
                                <ItemTemplate>
                                    <%#((System.Data.DataRow)Container.DataItem)["ReturnQTY"]%>
                                </ItemTemplate>
                            </ext:TemplateField>
