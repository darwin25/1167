<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Show.aspx.cs" Inherits="Edge.Web.Operation.StoreOrderManagement.ReturnStoreOrder.Show" %>
...
<body>
    ...
    <ext:Panel ID="Panel1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
        ...
        <Items>
                ...
                <Items>
                    ...
                    <ext:Form ID="sform1" runat="server" ShowBorder="false" ShowHeader="false" Title=""
                        ...
                        <Rows>
                            <ext:FormRow>
                                <Items>
                                    <ext:Label ID="ReturnOrderNumber" runat="server" Label="Transaction Number" Width="200">
                                    </ext:Label>
            ...
            <ext:GroupPanel ID="GroupPanel3" runat="server" EnableCollapse="True" Title="Return Order Detail">
                <Items>
                    <ext:Grid ID="Grid1" ShowBorder="false" ShowHeader="false" PageSize="3" runat="server"
                        ...
                        <Columns>
                            ...
                            <ext:BoundField Width="60px" DataField="ReturnQTY"  HeaderText="Return Quantity"  ColumnID="onReturnQTY" ></ext:BoundField>
                        </Columns>
                    </ext:Grid>
                </Items>
            </ext:GroupPanel>
