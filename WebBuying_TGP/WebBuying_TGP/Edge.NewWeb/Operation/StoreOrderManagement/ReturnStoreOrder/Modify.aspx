<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Edge.Web.Operation.StoreOrderManagement.ReturnStoreOrder.Modify" %>
...
<body>
    ...
    <ext:Panel ID="Panel1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
        ...
        <Items>
                ...
                <Items>
                    ...
                    <ext:Form ID="sform1" runat="server" ShowBorder="false" ShowHeader="false" Title=""
                        ...
                        <Rows>
                            <ext:FormRow>
                                <Items>
                                    <ext:Label ID="ReturnOrderNumber" runat="server" Label="Transaction Number">
                                    </ext:Label>
            ...
            <ext:GroupPanel ID="GroupPanel5" runat="server" EnableCollapse="True" Title="Inventory (out) Location Information">
                <Items>
                ...
                <Items>
                    <ext:Form ID="sform3" runat="server" ShowBorder="false" ShowHeader="false" Title=""
                        ...
                        <Rows>
                            ...
                            <ext:FormRow>
                                <Items>
                                    <ext:NumberBox ID="ReturnQty" runat="server" Label="Return Quantity" MaxValue="1000000" NoDecimal="true"
            ...
            <ext:GroupPanel ID="GroupPanel4" runat="server" EnableCollapse="True" Title="Return Order Detail">
                <Items>
                    <ext:Grid ID="Grid2" ShowBorder="false" ShowHeader="false" PageSize="3" runat="server"
                        ...
                        <Columns>
                            ...
                            <ext:BoundField Width="60px" DataField="ReturnQTY" HeaderText="Return Quantity" ColumnID="onReturnQTY">
                            </ext:BoundField>
