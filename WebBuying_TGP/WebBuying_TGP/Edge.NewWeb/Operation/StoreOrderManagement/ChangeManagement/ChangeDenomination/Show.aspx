<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Show.aspx.cs" Inherits="Edge.Web.Operation.CouponManagement.ChangeManagement.ChangeDenomination.Show" %>
                ...
                <Items>
                    <ext:Form ID="form2" runat="server" ShowBorder="false" ShowHeader="false" Title=""
                        ...
                        <Rows>
                            ...
                            <ext:FormRow>
                                <Items>
                                    <ext:Label ID="ActAmount" runat="server" Label="面额：">
                                    </ext:Label>
   ...
   <%-- <div class="navigation">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="ActAmount" runat="server">
                </asp:Label>
            </td>
            <td align="right">
                原因：
