...
namespace Edge.Web.Operation.CouponManagement.ChangeManagement.ChangeDenomination
{
    public partial class List : PageBase
    {
        ...
        protected static string strWhere = " OprID =" + ((int)CouponController.OprID.ChangeDenomination).ToString();
        ...
        private void RptBind(string strWhere, string orderby)
        {
            ...
            {
                Tools.Logger.Instance.WriteErrorLog("Load ChangeDenomination", "error", ex);
            }
        }
        #endregion
