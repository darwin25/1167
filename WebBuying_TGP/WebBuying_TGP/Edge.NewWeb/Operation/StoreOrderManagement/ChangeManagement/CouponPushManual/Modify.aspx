<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Edge.Web.Operation.CouponManagement.ChangeManagement.CouponPushManual.Modify" %>
    ...
    <ext:Panel ID="Panel1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="20px"
        ...
        <Items>
            ...
            <ext:GroupPanel ID="GroupPanel3" runat="server" EnableCollapse="True" Title="推送优惠券类型列表"
                AutoHeight="true" AutoWidth="true">
                <Items>
                    <ext:Grid ID="AddResultListGrid" ShowBorder="false" ShowHeader="false" AutoHeight="true" PageSize="3"
                        runat="server" EnableCheckBoxSelect="false" DataKeyNames="CouponTypeCode"
