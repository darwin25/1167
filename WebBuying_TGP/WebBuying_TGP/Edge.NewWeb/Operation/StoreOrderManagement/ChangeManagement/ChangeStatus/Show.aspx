<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Show.aspx.cs" Inherits="Edge.Web.Operation.CouponManagement.ChangeManagement.ChangeStatus.Show" %>
                    ...
                    <ext:Grid ID="Grid1" ShowBorder="false" ShowHeader="false" AutoHeight="true" PageSize="3"
                        ...
                        <Columns>
                            ...
                            <ext:TemplateField Width="60px" HeaderText="原状态">
                                ...
                                <ItemTemplate>
                                    <asp:Label ID="Label2" runat="server" Text='<%#Eval("StatusName")%>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
