...
namespace Edge.Web.Operation.CouponManagement.ChangeManagement.ChangeStatus
{
    public partial class Modify : Edge.Web.Tools.BasePage<Edge.SVA.BLL.Ord_CouponAdjust_H, Edge.SVA.Model.Ord_CouponAdjust_H>
    {
        ...
        protected void btnSaveClose_Click(object sender, EventArgs e)
        {
            ...
            if (count)
            {
                //Logger.Instance.WriteOperationLog(this.PageName, "Update Coupon Change Status " + item.CouponAdjustNumber + " " + Resources.MessageTips.UpdateSuccess);
            ...
            {
                //Logger.Instance.WriteOperationLog(this.PageName, "Update Coupon Change Status " + item.CouponAdjustNumber + " " + Resources.MessageTips.AddFailed);
