        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
                try
                {
                    ...
                    Logger.Instance.WriteOperationLog(this.PageName, "Void Coupon Change Status " + idList.ToString());
                ...
                {
                    Logger.Instance.WriteOperationLog(this.PageName, "Void Coupon Change Status:" + ex);
