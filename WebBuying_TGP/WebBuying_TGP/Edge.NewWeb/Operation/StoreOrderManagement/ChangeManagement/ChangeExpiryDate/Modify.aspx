<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Edge.Web.Operation.CouponManagement.ChangeManagement.ChangeExpiryDate.Modify" %>
                ...
                <Items>
                    <ext:Form ID="form2" runat="server" ShowBorder="false" ShowHeader="false" Title=""
                        ...
                        <Rows>
                            ...
                            <ext:FormRow>
                                <Items>
                                    <ext:DatePicker ID="ActExpireDate" runat="server" Label="有效日期：" DateFormatString="yyyy-MM-dd"
                                        ShowRedStar="true" Required="true" MaxLength="512">
                                    </ext:DatePicker>
