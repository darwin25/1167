<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Edge.Web.Operation.CouponManagement.ChangeManagement.CouponActive.Coupon.Add" %>
            ...
            <Toolbars>
                    <ext:Toolbar ID="Toolbar3" runat="server">
                        <Items>
                            ...
                            <ext:Button ID="BtnScanStart" Icon="ServerGo" OnClick="BtnScanStart_Click" runat="server" Text="扫描" HideMode="Offsets">
                            </ext:Button>                            
                            <ext:Button ID="BtnScanStop" Icon="ServerGo" OnClick="BtnScanStop_Click" runat="server" Text="停止扫描" HideMode="Offsets" Hidden="true">
                            </ext:Button>                                                    
                            <ext:Button ID="BtnAddScan" Icon="Add" OnClick="BtnAddScan_Click" runat="server" Text="添加扫描号码" HideMode="Offsets" Hidden="true">
                            </ext:Button>
                        ...
                        <Items>
                            <ext:Form ID="Form5" runat="server" ShowBorder="false" ShowHeader="false" Title=""
                                ...
                                <Rows>
                                    <ext:FormRow>
                                        <Items>
                                            <ext:NumberBox ID="CouponTypeAmount" runat="server" Label="面额：" MaxValue="100000000"
