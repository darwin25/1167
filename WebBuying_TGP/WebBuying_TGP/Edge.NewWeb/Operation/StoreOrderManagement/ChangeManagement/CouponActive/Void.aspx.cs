        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
                try
                {
                    ...
                    Logger.Instance.WriteOperationLog(this.PageName, "Void Coupon Active " + idList.ToString());
                ...
                {
                    Logger.Instance.WriteOperationLog(this.PageName, "Void Coupon Active:" + ex);
