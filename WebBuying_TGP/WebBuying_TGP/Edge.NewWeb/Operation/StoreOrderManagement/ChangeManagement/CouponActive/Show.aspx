<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Show.aspx.cs" Inherits="Edge.Web.Operation.CouponManagement.ChangeManagement.CouponActive.Show" %>
...
<body>
                        ...
                        <Toolbars>
                            <ext:Toolbar ID="Toolbar1" runat="server" Position="Top">
                                <Items>
                                    ...
                                    <ext:Label ID="Label1" runat="server" Text="面额汇总：">
                                    </ext:Label>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="ReasonID" TabIndex="2" runat="server">
                </asp:Label>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="RegisterCode" TabIndex="2" runat="server">
                </asp:Label>
            </td>
        </tr>
        <tr>
