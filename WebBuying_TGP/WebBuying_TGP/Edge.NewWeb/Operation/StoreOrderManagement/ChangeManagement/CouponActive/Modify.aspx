<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Edge.Web.Operation.CouponManagement.ChangeManagement.CouponActive.Modify" %>
...
<body>
                    ...
                    <ext:Grid ID="Grid1" ShowBorder="false" ShowHeader="false" AutoHeight="true" PageSize="3"
                        ...
                        <Columns>
                            ...
                            <ext:TemplateField Width="60px" HeaderText="面额">
                                <ItemTemplate>
                                    <asp:Label ID="lblApproveBusDate" runat="server" Text='<%#Eval("OrdCouponAmount","{0:0.00}")%>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="Brand" TabIndex="2" runat="server" CssClass="dropdownlist cancel required"
                    AutoPostBack="True" Enabled="false" OnSelectedIndexChanged="Brand_SelectedIndexChanged">
                </asp:DropDownList>
                <span class="star">*</span>
            </td>
            <td align="right">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="RegisterCode" TabIndex="2" runat="server" CssClass="input required">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="OriginalTxnNo" TabIndex="2" runat="server" MaxLength="30" CssClass="input required">
                </asp:TextBox><span class="star">*</span>
            </td>
        </tr>
        <tr>
                ...
                <asp:Repeater ID="rptList" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td align="center">
                                <asp:Label ID="lblCouponAmount" runat="server" Text='<%#Eval("OrdCouponAmount","{0:0.00}")%>'></asp:Label>
                            </td>
                            <td align="center">
                                <asp:Label ID="lblStatus" runat="server" Text='<%#Eval("OrgStatusName")%>'></asp:Label>
                            </td>
                            <td align="center">
