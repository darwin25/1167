<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Show.aspx.cs" Inherits="Edge.Web.Operation.CouponManagement.ChangeManagement.CouponIssue.Show" %>
                        ...
                        <Rows>
                            <ext:FormRow>
                                <Items>
                                    ...
                                    <ext:Label ID="StoreCode" runat="server" Label="发行对象：">
                                    </ext:Label>
                                </Items>
                            </ext:FormRow>
                            <ext:FormRow>
