    ...
    public partial class Add : Edge.Web.Tools.BasePage<Edge.SVA.BLL.Ord_CouponAdjust_H, Edge.SVA.Model.Ord_CouponAdjust_H>
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
                ...
                InitData();
                SVASessionInfo.CouponIssueController = null;
            }
            controller = SVASessionInfo.CouponIssueController;
        }
        ...
        protected void btnSaveClose_Click(object sender, EventArgs e)
        {
            ...
            if (item != null)
            {
                ...
                item.OprID = Convert.ToInt32(Enum.Parse(typeof(Edge.Web.Controllers.CouponController.OprID), Edge.Web.Controllers.CouponController.OprID.Issued.ToString()));
            ...
            if (count > 0)
            {
                ...
                Logger.Instance.WriteOperationLog(this.PageName, "Add Coupon Issue  " + item.CouponAdjustNumber + " " + Resources.MessageTips.AddSuccess);

                CloseAndRefresh();
            }
            else
            {
                Logger.Instance.WriteOperationLog(this.PageName, "Add Coupon Issue  " + item.CouponAdjustNumber + " " + Resources.MessageTips.AddFailed);
        ...
        {
            this.CouponAdjustNumber.Text = DALTool.GetREFNOCode(Edge.Web.Controllers.CouponController.CouponRefnoCode.OrderCouponIssued);
        ...
        //    string strWhere = string.Format(" Coupon.Status in ( {0} )", (int)CouponController.CouponStatus.Dormant);
        ...
        //    //{
        //    //    if ((Convert.ToInt32(dt.Rows[i + 1]["CouponNumber"]) - Convert.ToInt32(dt.Rows[i]["CouponNumber"])) > 1)
        //    //    {
        //    //        ShowWarming("aaa");
        //    //        return;
        //    //    }
