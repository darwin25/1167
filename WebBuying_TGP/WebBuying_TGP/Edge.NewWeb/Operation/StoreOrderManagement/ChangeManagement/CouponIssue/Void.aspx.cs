            ...
            if (!this.IsPostBack)
            {
                try
                {
                    ...
                    if (string.IsNullOrEmpty(ids))
                    {
                        ...
                        Alert.ShowInTop(Resources.MessageTips.NotSelected, "", MessageBoxIcon.Warning, ActiveWindow.GetHideReference());
                        return;
                    }
                    ...
                    Logger.Instance.WriteOperationLog(this.PageName, "Void Coupon Issue " + idList.ToString());
                ...
                {
                    Logger.Instance.WriteOperationLog(this.PageName, "Void Coupon Issue:" + ex);
