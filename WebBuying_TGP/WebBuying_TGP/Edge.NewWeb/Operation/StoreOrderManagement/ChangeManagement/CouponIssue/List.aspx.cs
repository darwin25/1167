...
namespace Edge.Web.Operation.CouponManagement.ChangeManagement.CouponIssue
{
    public partial class List : PageBase
    {
        ...
        protected static string strWhere = " OprID =" + ((int)CouponController.OprID.Issued).ToString();
        ...
        private void RptBind(string strWhere, string orderby)
        {
            ...
            {
                Tools.Logger.Instance.WriteErrorLog("Load CouponIssue", "error", ex);
            }
        }
        #endregion
        ...
        protected void btnVoid_Click(object sender, EventArgs e)
        {
            ...
            //    sbMsg.Append(";\n");
            //}
            ////VoidTxns(Window2,sbMsg.ToString(), "Void.aspx?ids=" + sb.ToString().TrimEnd(','), "");  
