<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Edge.Web.Operation.CouponManagement.ChangeManagement.CouponIssue.Add" %>
                        ...
                        <Rows>
                            <ext:FormRow>
                                <Items>
                                    ...
                                    <ext:DropDownList ID="StoreID" runat="server" Label="发行对象：" ShowRedStar="true" Required="true"
    ...
    <%--<ext:Window ID="Window1" Title="" Popup="false" EnableIFrame="true" runat="server"
        ...
        <Items>
            <ext:Panel ID="Panel2" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="5px"
                EnableBackgroundColor="true" Title="" Layout="Form" Width="720px"
