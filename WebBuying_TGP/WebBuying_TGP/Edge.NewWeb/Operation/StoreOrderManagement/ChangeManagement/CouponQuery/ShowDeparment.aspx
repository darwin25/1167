<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ShowDeparment.aspx.cs"
    Inherits="Edge.Web.Operation.CouponManagement.ChangeManagement.CouponQuery.ShowDeparment" %>
...
<body>
    ...
    <ext:Grid ID="Grid1" ShowBorder="false" ShowHeader="false" AutoHeight="true" PageSize="3"
        ...
        <Columns>
            ...
            <ext:TemplateField Width="60px" HeaderText="部门">
                <ItemTemplate>
        ...
        <tr>
            <td>
                <div style="text-align: center">
                    <input type="button" id="btnClose" class="submit" onclick="javascript:window.top.tb_remove();"
                        value="关 闭" />
                </div>
            </td>
        </tr>
