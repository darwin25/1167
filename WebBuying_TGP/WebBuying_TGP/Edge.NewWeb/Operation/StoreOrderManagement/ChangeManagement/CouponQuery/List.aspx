                ...
                <Items>
                    <ext:Form ID="form2" runat="server" ShowBorder="false" ShowHeader="false" Title=""
                        ...
                        <Rows>
                            <ext:FormRow>
                                <Items>
                                    <ext:TextBox ID="MemberMobilePhone" runat="server" Label="会员手机号码：" MaxLength="20">
                                    </ext:TextBox>
                                </Items>
                                <Items>
                                    <ext:TextBox ID="MemberEmail" runat="server" Label="会员邮箱地址：" MaxLength="100">
                                    </ext:TextBox>
                                </Items>
                            </ext:FormRow>
                            <ext:FormRow>
                            ...
                            <ext:FormRow>
                                <Items>
                                    <ext:DropDownList ID="StockStatus" runat="server" Label="库存状态：" Resizable="true">
                                    </ext:DropDownList >
                                </Items>
                                <Items>
                            ...
                            <ext:FormRow>
                                ...
                                <Items>
                                    <ext:TextBox ID="TextBox1" runat="server" Label="" MaxLength="100" Hidden=true>
                                    </ext:TextBox>
                                </Items>
                            </ext:FormRow>
                            <ext:FormRow>
                    ...
                    <ext:Grid ID="ResultGrid" ShowBorder="false" ShowHeader="false" AutoHeight="true"
                        ...
                        <Columns>
                            ...
                            <ext:WindowField ColumnID="ViewWindowField" Width="60px" WindowID="Window1" Icon="Page"
                                Text="详细" ToolTip="详细" DataTextFormatString="{0}" DataIFrameUrlFields="CouponNumber,CouponUID,BatchCode,CouponTypeCode,CouponTypeName,StatusName,StockStatusName,NewCouponAmount,CreatedOnText,CouponExpiryDateText,CouponTypeID"
                                DataIFrameUrlFormatString="Show.aspx?id={0}&couponUID={1}&batchCode={2}&CouponTypeCode={3}&CouponTypeName={4}&status={5}&stockstatus={6}&amount={7}&CouponIssueDate={8}&CouponExpiryDate={9}&couponTypeID={10}"
                                Title="详细" />
                        </Columns>
                    </ext:Grid>
                ...
                <asp:Repeater ID="rptList" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td align="center">
                                <span class="btn_bg"><a href="Show.aspx?id=<%#Eval("CouponNumber") %>&couponUID=<%#Eval("CouponUID") %>&batchCode=<%#Eval("BatchCode")%>&CouponTypeCode=<%#Eval("CouponTypeCode") %>&CouponTypeName=<%#Eval("CouponTypeName") %>&status=<%#Eval("StatusName")%>&stockstatus=<%#Eval("StockStatusName")%>&amount= <%#Eval("NewCouponAmount","{0:N02}")%>&CouponIssueDate=<%#Eval("CreatedOn","{0:yyyy-MM-dd}")%>&CouponExpiryDate=<%#Eval("CouponExpiryDate","{0:yyyy-MM-dd}")%>&couponTypeID=<%#Eval("CouponTypeID") %>">
                                    详细</a> </span>
                            </td>
                        </tr>
                    </ItemTemplate>
