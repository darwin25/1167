<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Show.aspx.cs" Inherits="Edge.Web.Operation.CouponManagement.ChangeManagement.CouponVoid.Show" %>
...
<body>
    ...
    <ext:Panel ID="Panel1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
        ...
        <Items>
            ...
            <ext:GroupPanel ID="GroupPanel3" runat="server" EnableCollapse="True" Title="作废优惠券列表"
                AutoHeight="true" AutoWidth="true">
                <Items>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="ReasonID" runat="server"></asp:Label>
            </td>
        </tr>
        <tr>
            <th colspan="4" align="left">
