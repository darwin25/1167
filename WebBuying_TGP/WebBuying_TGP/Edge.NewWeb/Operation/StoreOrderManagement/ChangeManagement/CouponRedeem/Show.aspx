<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Show.aspx.cs" Inherits="Edge.Web.Operation.CouponManagement.ChangeManagement.CouponRedeem.Show" %>
...
<body>
    ...
    <ext:Panel ID="Panel1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
        ...
        <Items>
                        ...
                        <Rows>
                            <ext:FormRow>
                                <Items>
                                    ...
                                    <ext:Label ID="ReasonID" runat="server" Label="原因：">
                                    </ext:Label>
                                </Items>
                            </ext:FormRow>
                        </Rows>
                        ...
                        <Rows>
                            <ext:FormRow>
                                <Items>
                                    ...
                                    <ext:Label ID="StoreCode" runat="server" Label="店铺号：">
                                    </ext:Label>
                                </Items>
                            </ext:FormRow>
                             <ext:FormRow>
                                <Items>
                                    <ext:Label ID="ServerCode" runat="server" Label="服务器编号：">
                                    </ext:Label>
                                    <ext:Label ID="RegisterCode" runat="server" Label="收银机号：">
                                    </ext:Label>
                                </Items>
                            </ext:FormRow>
                            <ext:FormRow>
                                <Items>
                                    <ext:Label ID="TxnDate" runat="server" Label="收银端交易日期：">
                                    </ext:Label>
                                    <ext:Label ID="OriginalTxnNo" runat="server" Label="收银端交易编号：">
                                    </ext:Label>
                                </Items>
                            </ext:FormRow>
                        </Rows>
            ...
            <ext:GroupPanel ID="GroupPanel3" runat="server" EnableCollapse="True" Title="消费优惠券列表"
                AutoHeight="true" AutoWidth="true">
                <Items>
                    <ext:Grid ID="Grid1" ShowBorder="false" ShowHeader="false" AutoHeight="true" PageSize="3"
                        ...
                        <Columns>
                            ...
                            <ext:TemplateField Width="60px" HeaderText="有效日期">
                                <ItemTemplate>
                                    <asp:Label ID="lblApproveBy" runat="server" Text='<%#Eval("CouponExpiryDate","{0:yyyy-MM-dd}")%>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
                        </Columns>
                    </ext:Grid>
   ...
   <%-- <div class="navigation">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="ReasonID" runat="server">
                </asp:Label>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="Brand" runat="server">
                </asp:Label>
            </td>
            <td align="right">
                店铺号：
            ...
            <td>
                <asp:Label ID="StoreCode" runat="server">
                </asp:Label>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <asp:Label ID="ServerCode" runat="server"></asp:Label>
            </td>
            <td align="right">
                收银机号：
            </td>
            <td>
                <asp:Label ID="RegisterCode" runat="server">
                </asp:Label>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <asp:Label ID="TxnDate" TabIndex="2" runat="server">
                </asp:Label>
            </td>
            <td align="right">
                收银端交易编号：
            ...
            <td>
                <asp:Label ID="OriginalTxnNo" TabIndex="2" runat="server">
                </asp:Label>
            </td>
        </tr>
        <tr>
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td align="center">
                             ...
                             <td align="center">
                                <asp:Label ID="lblActualTxnAmount" runat="server" Text='<%#Eval("OrdCouponAmount","{0:0.00}")%>'></asp:Label>
                            </td>
                            <td align="center">
                                <asp:Label ID="lblForfeitAmount" runat="server" Text='<%#Eval("ForfeitAmount","{0:0.00}")%>'></asp:Label>
                            </td>
                            <td align="center">
