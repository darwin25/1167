<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Edge.Web.Operation.CouponManagement.ChangeManagement.CouponRedeem.Coupon.Add" %>
                    ...
                    <ext:GroupPanel ID="GroupPanel7" runat="server" EnableCollapse="True" Title="添加选项"
                        ...
                        <Items>
                            <ext:Form ID="Form5" runat="server" ShowBorder="false" ShowHeader="false" Title=""
                                EnableBackgroundColor="true" LabelAlign="Right"  LabelWidth="300">
                                <Rows>
                                    <ext:FormRow>
                                        <Items>
