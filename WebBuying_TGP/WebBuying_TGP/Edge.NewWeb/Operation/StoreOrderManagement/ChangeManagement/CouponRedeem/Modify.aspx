<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Edge.Web.Operation.CouponManagement.ChangeManagement.CouponRedeem.Modify" %>
...
<body>
    ...
    <ext:Panel ID="Panel1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
        ...
        <Toolbars>
            <ext:Toolbar ID="Toolbar2" runat="server">
                <Items>
                    ...
                    <ext:Button ID="btnSaveClose" ValidateForms="form1,form2,form3" Icon="SystemSaveClose"
        ...
        <Items>
            ...
            <ext:GroupPanel ID="GroupPanel4" runat="server" EnableCollapse="True" Title="参考交易资料"
                AutoHeight="true" AutoWidth="true">
                <Items>
                    <ext:Form ID="form3" runat="server" ShowBorder="false" ShowHeader="false" Title=""
                        ...
                        <Rows>
                            <ext:FormRow>
                                <Items>
                                    <ext:DropDownList ID="Brand" runat="server" Label="品牌：" ShowRedStar="true" OnSelectedIndexChanged="Brand_SelectedIndexChanged"
                                        AutoPostBack="true" Enabled="false" Resizable="true">
                                    </ext:DropDownList>
                                    <ext:DropDownList ID="StoreID" runat="server" Label="店铺号：" ShowRedStar="true" Enabled="false"
                                        Resizable="true">
                                    </ext:DropDownList>
                                    <%--<ext:DropDownList ID="StoreCode" runat="server" Label="店铺号：" ShowRedStar="true" Required="true">
                                    </ext:DropDownList>--%>
                                </Items>
                            </ext:FormRow>
                            <ext:FormRow>
            ...
            <ext:GroupPanel ID="GroupPanel3" runat="server" EnableCollapse="True" Title="激活优惠券列表"
                AutoHeight="true" AutoWidth="true">
                <Items>
                    <ext:Grid ID="Grid1" ShowBorder="false" ShowHeader="false" AutoHeight="true" PageSize="3"
                        ...
                        <Toolbars>
                            <ext:Toolbar ID="Toolbar1" runat="server" Position="Top">
                                <Items>
                                    <ext:Label ID="Label4" runat="server" Text="汇总：">
                                    </ext:Label>
                                    ...
                                    <ext:Label ID="Label1" runat="server" Text="实际扣除金额汇总：">
                                    </ext:Label>
                        ...
                        <Columns>
                            ...
                            <ext:TemplateField Width="60px" HeaderText="实际扣除金额">
                                <ItemTemplate>
                                    <asp:Label ID="Label5" runat="server" Text='<%#Eval("OrdCouponAmount","{0:0.00}")%>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
                            <ext:TemplateField Width="60px" HeaderText="没收金额">
                                <ItemTemplate>
                                    <asp:Label ID="Label6" runat="server" Text='<%#Eval("ForfeitAmount","{0:0.00}")%>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="CouponStatus" runat="server" MaxLength="512" CssClass="input" Enabled="False"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="Brand" TabIndex="2" runat="server" CssClass="dropdownlist cancel required"
                    AutoPostBack="True" OnSelectedIndexChanged="Brand_SelectedIndexChanged" Enabled="false">
                </asp:DropDownList>
                <span class="star">*</span>
            </td>
            <td align="right">
            ...
            <td>
                <asp:DropDownList ID="StoreCode" TabIndex="2" MaxLength="30" runat="server" CssClass="dropdownlist cancel required"
                    Enabled="false">
                </asp:DropDownList>
                <span class="star">*</span>
            </td>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="ServerCode" runat="server" MaxLength="30" CssClass="input"></asp:TextBox>
            </td>
            <td align="right">
                收银机号：
            </td>
            <td>
                <asp:TextBox ID="RegisterCode" TabIndex="2" MaxLength="30" runat="server" CssClass="input required">
                </asp:TextBox><span class="star">*</span>
            </td>
        </tr>
        <tr>
            <td align="right">
            ...
            <td>
                <asp:TextBox ID="TxnDate" TabIndex="2" runat="server" onfocus="WdatePicker()" CssClass="input dateISO required"
                    Enabled="False"></asp:TextBox><span class="star">*</span>
            </td>
            <td align="right">
                收银端交易编号：
            </td>
            <td>
                <asp:TextBox ID="OriginalTxnNo" TabIndex="2" MaxLength="30" runat="server" CssClass="input required">
                </asp:TextBox><span class="star">*</span>
            </td>
        </tr>
        <tr>
                ...
                <asp:Repeater ID="rptList" runat="server">
                    ...
                    <ItemTemplate>
                        <tr>
                            ...
                            <td align="center">
                                <asp:Label ID="lblExpiryDate" runat="server" Text='<%#Eval("OrgExpiryDate","{0:yyyy-MM-dd}")%>'></asp:Label>
                            </td>
                        </tr>
                    </ItemTemplate>
                    <FooterTemplate>
          ...
          <td colspan="4">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtablelist"
                    ...
                    <tr>
                        ...
                        <td align="center">
                            实际扣除金额汇总：
                            <asp:Label ID="lblTotalActualTxnAmount" runat="server"></asp:Label>
                        </td>
                        <td align="center">
                            没收金额汇总：
                            <asp:Label ID="lblTotalForfeitAmount" runat="server"></asp:Label>
                        </td>
                    </tr>
                </table>
           </td>
        ...
        <tr>
            <td class="showMessage" colspan="4">
                *为必填项
            </td>
        </tr>
        <tr>
