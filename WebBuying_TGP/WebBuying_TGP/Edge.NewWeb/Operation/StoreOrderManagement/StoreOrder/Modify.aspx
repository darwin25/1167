<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Edge.Web.Operation.StoreOrderManagement.StoreOrder.Modify" %>
                ...
                <Items>
                    <ext:Grid ID="Grid2" ShowBorder="false" ShowHeader="false" PageSize="3" runat="server"
                        ...
                        <Columns>
                            ...
                            <ext:BoundField Width="60px" DataField="OrderQTY" HeaderText="Order Quantity" ColumnID="orderQty">
                            </ext:BoundField>
