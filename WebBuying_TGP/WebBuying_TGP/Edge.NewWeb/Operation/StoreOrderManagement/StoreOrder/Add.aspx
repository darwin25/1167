<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Edge.Web.Operation.StoreOrderManagement.StoreOrder.Add" %>
                ...
                <Items>
                    ...
                    <ext:Form ID="sform1" runat="server" ShowBorder="false" ShowHeader="false" Title=""
                        ...
                        <Rows>
                            <ext:FormRow>
                                <Items>
                                    <ext:Label ID="StoreOrderNumber" runat="server" Label="Transaction Number">
                                    </ext:Label>
                ...
                <Items>
                    <ext:Form ID="sform3" runat="server" ShowBorder="false" ShowHeader="false" Title=""
                        ...
                        <Rows>
                            ...
                            <ext:FormRow>
                                <Items>
                                    <ext:NumberBox ID="OrderQty" runat="server" Label="Order Qty" MaxValue="1000000" NoDecimal="true"
                            ...
                            <ext:FormRow>
                                <Items>
                                     ...
                                     <ext:RadioButtonList ID="RADSubstitute" runat="server" Label="Subtitutable" AutoPostBack="true" OnSelectedIndexChanged="Substitute_SelectedIndexChanged" >
                            ...
                            <ext:FormRow>
                            <Items>
                             <ext:DropDownList ID="DropDownList2" runat="server" Label="Assigned Items for Substitution" OnSelectedIndexChanged="DropDownList1Substitute_SelectedIndexChanged"
