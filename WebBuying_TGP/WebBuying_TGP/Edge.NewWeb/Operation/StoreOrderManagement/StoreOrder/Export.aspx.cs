...
namespace Edge.Web.Operation.StoreOrderManagement.StoreOrder
{
    public partial class Export : PageBase
    {
        ...
        //英文Url
        protected string enusUrl = "\\StoreOrderManagement\\StoreOrder\\rptStoreOrderByEnglish.rpx";
        //中文简体Url
        protected string zhcnUrl = "\\StoreOrderManagement\\StoreOrder\\rptStoreOrder.rpx";
        //中文繁体Url
        protected string zhhkUrl = "\\StoreOrderManagement\\StoreOrder\\rptStoreOrderByTraditional.rpx";
        #endregion
        ...
        private void LoadReport(string ids, int orderType)
        {
            ...
            reportTool.LoadReport(ids, WebViewerStoreOrderList, url, webset.WebName, "StoreOrder");
        }
        ...
        protected void btnWord_Click(object sender, EventArgs e)
        {
            ...
            this.WebViewerStoreOrderList.FlashViewerOptions.ResourceLocale = Request.Form["hidlanguage"];
            ...
            rpt.DataSource = reportTool.GetDataBind(Request.Form["hidIds"], webset.WebName, "StoreOrder");
            rpt.DataMember = "";
            rpt.Run();
            WebViewerStoreOrderList.Report = rpt;
