<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Export.aspx.cs" Inherits="Edge.Web.Operation.StoreOrderManagement.StoreOrder.Export" %>
...
<body>
    ...
    <div style="margin-bottom: 10px;">
        ...
        <ActiveReportsWeb:WebViewer ID="WebViewerStoreOrderList" runat="server" Height="550"
            BorderStyle="None" Width="1500">
