<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Edge.Web.Operation.StoreOrderManagement.StoreOrder.List" %>
                ...
                <Rows>
                    ...
                    <ext:FormRow ID="FormRow2" runat="server" ColumnWidths="23% 23% 23% 23% 8%">
                        <Items>
                            ...
                            <ext:DropDownList ID="StoreID" runat="server" Label="Inventory (in) location">
                            </ext:DropDownList>
            ...
            <ext:Panel ID="Panel2" ShowBorder="false" ShowHeader="false" runat="server" Title=""
                ...
                <Items>
                    <ext:Grid ID="Grid1" ShowBorder="false" ShowHeader="false" PageSize="3" runat="server"
                        EnableCheckBoxSelect="True" DataKeyNames="StoreOrderNumber,OrderType" AllowPaging="true"
                        ...
                        OnSort="Grid1_Sort" AllowSorting="true" SortDirection="DESC">
                        <Toolbars>
                            <ext:Toolbar ID="Toolbar1" runat="server">
                                <Items>
                                    ...
                                    <ext:Button ID="btnExport" Text="Export" Icon="Mail" runat="server" OnClick="btnExport_Click">
                                    </ext:Button>
                        ...
                        <Columns>
                            <ext:TemplateField Width="90px" HeaderText="Transaction Number" SortField="StoreOrderNumber">
                                <ItemTemplate>
                                    <asp:Label ID="lb_id" runat="server" Text='<%# Eval("StoreOrderNumber") %>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
                            ...
                            <ext:TemplateField Width="40px" HeaderText="Created Business Date" SortField="CreatedBusDate">
                                <ItemTemplate>
                                    <asp:Label ID="lblCreatedBusDate" runat="server" Text='<%#Eval("CreatedBusDate","{0:yyyy-MM-dd}")%>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
                            <ext:TemplateField Width="40px" HeaderText="Approve Business Date" SortField="ApproveBusDate">
                                <ItemTemplate>
                            ...
                            <ext:TemplateField Width="40px" HeaderText="Approve Date Time">
                                <ItemTemplate>
                            ...
                            <ext:TemplateField Width="60px" HeaderText="Delivery Status">
                                <ItemTemplate>
                                    <asp:Label ID="lblDeliveryStatus" runat="server" Text='<%# Eval("DeliveryStatusName") %>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
                            <ext:WindowField ColumnID="ViewWindowField" Width="60px" WindowID="Window1" Icon="Page"
                                Text="View" ToolTip="View" DataTextFormatString="{0}" DataIFrameUrlFields="StoreOrderNumber"
                            ...
                            <ext:WindowField ColumnID="EditWindowField" Width="60px" WindowID="Window2" Icon="PageEdit"
                                Text="Edit" ToolTip="Edit" DataTextFormatString="{0}" DataIFrameUrlFields="StoreOrderNumber"
