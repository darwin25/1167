<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Print.aspx.cs" Inherits="Edge.Web.Operation.StoreOrderManagement.StoreOrder.Print" %>
...
<body>
    <form name="formSubmit" id="formSubmit" runat="server" method="post" action="/Operation/StoreOrderManagement/StoreOrder/Print.aspx">
    ...
    <ActiveReportsWeb:WebViewer ID="WebViewerStoreOrderList" runat="server" Width="100%"
