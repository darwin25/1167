...
{
    public partial class Show : Edge.Web.Tools.BasePage<Edge.SVA.BLL.Ord_PickingOrder_H, Edge.SVA.Model.Ord_PickingOrder_H>
    {
        ...
        private System.Data.DataTable Detail
        {
            get
            {
                if (ViewState["DetailResult"] == null)
                {
                    ...
                    //System.Data.DataSet ds = new Edge.SVA.BLL.Ord_PickingOrder_D().GetListByPage(string.Format("PickingOrderNumber = '{0}'", Request.Params["id"]) + strWhere, "", pagesize * pageindex + 1, pagesize * (pageindex + 1));
