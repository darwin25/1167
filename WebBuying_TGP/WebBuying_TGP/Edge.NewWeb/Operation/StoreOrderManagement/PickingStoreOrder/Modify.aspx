<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Edge.Web.Operation.StoreOrderManagement.PickingStoreOrder.Modify" %>
            ...
            <ext:GroupPanel ID="GroupPanel4" runat="server" EnableCollapse="True" Title="Pick up order details">
                <Items>
                    <ext:Grid ID="Grid2" ShowBorder="false" ShowHeader="false" PageSize="3" runat="server"
                        EnableCheckBoxSelect="false" DataKeyNames="ProdCode,OrderQTY,ActualQTY,Remark,KeyID"
                        AllowPaging="true" IsDatabasePaging="true" ForceFit="true" OnPageIndexChange="Grid2_PageIndexChange"
