...
namespace Edge.Web.Operation.StoreOrderManagement.PickingStoreOrder
{
    ...
    public partial class Export : PageBase
    {
        ...
        protected void btnWord_Click(object sender, EventArgs e)
        {
            ...
            this.WebViewerPickingStoreOrder.FlashViewerOptions.ResourceLocale = Request.Form["hidlanguage"];
            ...
            rpt.DataSource = reportTool.GetDataBind(Request.Form["hidIds"], webset.WebName, "PickingStoreOrder");
            rpt.DataMember = "";
            rpt.Run();
            WebViewerPickingStoreOrder.Report = rpt;
...
GrapeCity.ActiveReports.Export.Word.Section.RtfExport();
            ...
            {
                exportlanguage = "PickingStoreOrder";
            }
            else if (Request.Form["hidlanguage"] == "zh-cn")
            {
                exportlanguage = "总部拣货单";
            }
            else
            {
                exportlanguage = "總部揀貨單";
            }
