<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Edge.Web.Operation.StoreOrderManagement.PickingStoreOrder.Add" %>
                ...
                <Items>
                    ...
                    <ext:Form ID="sform1" runat="server" ShowBorder="false" ShowHeader="false" Title=""
                        ...
                        <Rows>
                            <ext:FormRow>
                                <Items>
                                    <ext:Label ID="PickingOrderNumber" runat="server" Label="Transaction Number">
                                    </ext:Label>
                        ...
                        <Rows>
                            ...
                            <ext:FormRow>
                                <Items>
                                    ...
                                    <ext:TextBox ID="StorePhone" runat="server" Label="Contact Phone">
                                    </ext:TextBox>
                                </Items>
                            </ext:FormRow>
                        </Rows>
                ...
                <Items>
                    <ext:Form ID="sform3" runat="server" ShowBorder="false" ShowHeader="false" Title=""
                        ...
                        <Rows>
                            ...
                            <ext:FormRow>
                                <Items>
                                    <ext:NumberBox ID="ActualQty" runat="server" Label="Actual Qty" MaxValue="1000000" NoDecimal="true"
                ...
                <Items>
                    <ext:Grid ID="Grid2" ShowBorder="false" ShowHeader="false" PageSize="3" runat="server"
                        ...
                        <Columns>
                            ...
                            <ext:TemplateField Width="60px" HeaderText="Actual Qty" SortField="ActualQTY">
                                <ItemTemplate>
                                    <%#((System.Data.DataRow)Container.DataItem)["ActualQTY"].ToString("N")%>
                                </ItemTemplate>
                            </ext:TemplateField>
