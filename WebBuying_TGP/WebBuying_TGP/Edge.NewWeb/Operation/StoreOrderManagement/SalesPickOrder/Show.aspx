<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Show.aspx.cs" Inherits="Edge.Web.Operation.StoreOrderManagement.SalesPickOrder.Show" %>
                ...
                <Items>
                    ...
                    <ext:Form ID="sform1" runat="server" ShowBorder="false" ShowHeader="false" Title=""
                        ...
                        <Rows>
                            ...
                            <ext:FormRow>
                                <Items>
                                    <ext:Label ID="lblPickupLocation" runat="server" Label="拣货仓库编号">
                                    </ext:Label>
                            ...
                            <ext:FormRow>
                                <Items>
                                    <ext:Label ID="PickupStaff" runat="server" Label="拣货人">
                                    </ext:Label>
            ...
            <ext:GroupPanel ID="GroupPanel4" runat="server" EnableCollapse="True" Title="Pick up order details">
                <Items>
                    <ext:Grid ID="Grid1" ShowBorder="false" ShowHeader="false" PageSize="3" runat="server"
                        ...
                        SummaryPosition="Bottom" EnableTextSelection="true" AllowCellEditing="true" ClicksToEdit="1">
                        <Columns>
                            ...
                            <ext:TemplateField Width="60px" HeaderText="On hand Qty" SortField="SalesPickOrderNumber">
                                <ItemTemplate>
                                    <%#((System.Data.DataRow)Container.DataItem)["OnhandQty"]%>
                                </ItemTemplate>
                            </ext:TemplateField>
