<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Void.aspx.cs" Inherits="Edge.Web.Operation.StoreOrderManagement.SalesPickOrder.Void" %>
...
<body>
    ...
    <ext:Grid ID="Grid1" ShowBorder="false" ShowHeader="false" runat="server" EnableCheckBoxSelect="false"
        DataKeyNames="TxnNo" ForceFit="true">
        <Toolbars>
