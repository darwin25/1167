...
namespace Edge.Web.Operation.StoreOrderManagement.TransOutOrder
{
    public partial class Export : PageBase
    {
        ...
        //英文Url
        protected string enusUrl = "\\StoreOrderManagement\\TransOutOrder\\rptTransOutOrderByEnglish.rpx";
        //中文简体Url
        protected string zhcnUrl = "\\StoreOrderManagement\\TransOutOrder\\rptTransOutOrder.rpx";
        //中文繁体Url
        protected string zhhkUrl = "\\StoreOrderManagement\\TransOutOrder\\rptTransOutOrderByTraditional.rpx";
        #endregion
        ...
        private void LoadReport(string ids)
        {
            ...
            reportTool.LoadReport(ids, WebViewerTransOutOrderrList, url, webset.WebName, "TransOutOrder");
        }
        ...
        protected void btnWord_Click(object sender, EventArgs e)
        {
            ...
            this.WebViewerTransOutOrderrList.FlashViewerOptions.ResourceLocale = Request.Form["hidlanguage"];
            ...
            rpt.DataSource = reportTool.GetDataBind(Request.Form["hidIds"], webset.WebName, "TransOutOrder");
            rpt.DataMember = "";
            rpt.Run();
            WebViewerTransOutOrderrList.Report = rpt;
