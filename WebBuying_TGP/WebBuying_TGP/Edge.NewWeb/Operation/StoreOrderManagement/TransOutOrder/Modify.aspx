<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Edge.Web.Operation.StoreOrderManagement.TransOutOrder.Modify" %>
                ...
                <Items>
                    <ext:Grid ID="Grid2" ShowBorder="false" ShowHeader="false" PageSize="3" runat="server"
                        ...
                        <Columns>
                            ...
                            <ext:BoundField Width="60px" DataField="TransOutQTY" HeaderText="Trans Out Qty" ColumnID="onTransOutQTY">
                            </ext:BoundField>
                            <ext:TemplateField Width="100px" HeaderText="Remarks" SortField="Remark">
                                <ItemTemplate>
