<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Export.aspx.cs" Inherits="Edge.Web.Operation.StoreOrderManagement.TransOutOrder.Export" %>
...
<body>
    ...
    <div style="margin-bottom: 10px;">
        ...
        <ActiveReportsWeb:WebViewer ID="WebViewerTransOutOrderrList" runat="server" Height="650"
            Width="100%">
