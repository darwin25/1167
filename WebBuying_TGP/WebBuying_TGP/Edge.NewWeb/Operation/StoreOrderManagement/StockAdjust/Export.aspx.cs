...
namespace Edge.Web.Operation.StoreOrderManagement.StockAdjust
{
    ...
    public partial class Export : PageBase
    {
        ...
        //英文Url
        protected string enusUrl = "\\StoreOrderManagement\\StockAdjust\\rptStockAdjustOrderByEnglish.rpx";
        //中文简体Url
        protected string zhcnUrl = "\\StoreOrderManagement\\StockAdjust\\rptStockAdjustOrder.rpx";
        //中文繁体Url
        protected string zhhkUrl = "\\StoreOrderManagement\\StockAdjust\\rptStockAdjustOrderByTraditional.rpx";
        #endregion
        ...
        private void LoadReport(string ids, int orderType)
        {
            ...
            reportTool.LoadReport(ids, WebViewerStockAdjustOrder, url, webset.WebName, "StockAdjustOrder");
        }
        ...
        {
            this.WebViewerStockAdjustOrder.FlashViewerOptions.ResourceLocale = Request.Form["hidlanguage"];
            ...
            rpt.DataSource = reportTool.GetDataBind(Request.Form["hidIds"], webset.WebName, "StockAdjustOrder");
            rpt.DataMember = "";
            rpt.Run();
            WebViewerStockAdjustOrder.Report = rpt;
...
GrapeCity.ActiveReports.Export.Word.Section.RtfExport();
            ...
            {
                exportlanguage = "StockAdjust";
            }
            else if (Request.Form["hidlanguage"] == "zh-cn")
            {
                exportlanguage = "店铺库存调整单";
            }
            else
            {
                exportlanguage = "店鋪庫存調整單";
            }
