<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Edge.Web.Operation.StoreOrderManagement.StockAdjust.List" %>
...
<body>
            ...
            <ext:Form ID="SearchForm" ShowBorder="True" BodyPadding="5px" 
                ...
                <Rows>
                    <ext:FormRow ID="FormRow1" runat="server" ColumnWidths="23% 23% 23% 23% 8%">
                        <Items>
                            <ext:TextBox ID="Code" runat="server" Label="Transaction Number" MaxLength="64">
                            </ext:TextBox>
                           ...
                           <ext:DropDownList ID="OrderType" runat="server" Label="Order Type"  Hidden="true">
                                <ext:ListItem Text="-------" Value=""  Selected="true"/>
                                <ext:ListItem Text="Manual" Value="0" />
                                <ext:ListItem Text="Automatic" Value="1" />
                            </ext:DropDownList>
                            <ext:TextBox ID="ReferenceNo" runat="server" Label="Reference No." MaxLength="64"></ext:TextBox>
                    ...
                    <ext:FormRow ID="FormRow2" runat="server" ColumnWidths="23% 23% 23% 23% 8%">
                        <Items>
                            <ext:DropDownList ID="StoreID" runat="server" Label="Store / Warehouse" ></ext:DropDownList>
                    ...
                    <ext:FormRow ID="FormRow4" runat="server" ColumnWidths="23% 23% 23% 23% 8%">
                        <Items>
                            ...
                            <ext:Label ID="Label7" runat="server" Label="" Hidden="true" HideMode="Offsets"></ext:Label>
                            <ext:Label ID="Label8" runat="server" Label="" Hidden="true" HideMode="Offsets"></ext:Label>
                        </Items>
                    </ext:FormRow>
                </Rows>
            </ext:Form>
            <ext:Panel ID="Panel2" ShowBorder="false" ShowHeader="false" runat="server" 
                ...
                <Items>
                    <ext:Grid ID="Grid1" ShowBorder="false" ShowHeader="false"  PageSize="3"
                        runat="server" EnableCheckBoxSelect="True" DataKeyNames="StockAdjustNumber,OrderType"
                        ...
                        <Columns>
                            <ext:TemplateField Width="80px" HeaderText="Transaction Number" SortField="StockAdjustNumber">
                                <ItemTemplate>
                                    <asp:Label ID="lb_id" runat="server" Text='<%# Eval("StockAdjustNumber") %>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
                            ...
                            <ext:TemplateField Width="60px" HeaderText="Order Type" Hidden=true SortField="OrderType">
                                <ItemTemplate>
                                    <asp:Label ID="lblOrderType" runat="server" Text='<%# Eval("OrderTypeName") %>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
                            <ext:TemplateField Width="80px" HeaderText="Reference No.">
                                <ItemTemplate>
                            ...
                            <ext:TemplateField Width="60px" HeaderText="Store / Warehouse" SortField="StoreID">
                                <ItemTemplate>
                                    <asp:Label ID="lblStoreID" runat="server" Text='<%# Eval("StoreName") %>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
                            <ext:TemplateField Width="60px" HeaderText="Created Business Date" SortField="CreatedBusDate">
                                <ItemTemplate>
                                    <asp:Label ID="lblCreatedBusDate" runat="server" Text='<%#Eval("CreatedBusDate","{0:yyyy-MM-dd}")%>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
                            <ext:TemplateField Width="60px" HeaderText="Approve Business Date" SortField="ApproveBusDate">
                                <ItemTemplate>
                            ...
                            <ext:TemplateField Width="60px" HeaderText="Approve By">
                             ...
                             <ext:WindowField ColumnID="ViewWindowField" Width="60px" WindowID="Window1" Icon="Page"
                                Text="View" ToolTip="View" DataTextFormatString="{0}" DataIFrameUrlFields="StockAdjustNumber"
                            ...
                            <ext:WindowField ColumnID="EditWindowField" Width="60px" WindowID="Window2" Icon="PageEdit"
                                Text="Edit" ToolTip="Edit" DataTextFormatString="{0}" DataIFrameUrlFields="StockAdjustNumber"
    ...
    <ext:Window ID="Window1" Title="" Hidden="true" EnableIFrame="true"
