...
namespace Edge.Web.Operation.StoreOrderManagement.StockAdjust
{
    public partial class List : PageBase
    {
        ...
        StockAdjustController controller = new StockAdjustController();
            ...
            try
            {
                ...
                if (SearchFlag.Text == "1")
                {
                    ...
                    if (!string.IsNullOrEmpty(code))
                    {
                        ...
                        sb.Append(" StockAdjustNumber like '%");
                        sb.Append(code);
                        sb.Append("%'");
                    }
                    ...
                    if (!string.IsNullOrEmpty(prodcode))
                    {
                        ...
                        sb.Append(" exists(select d.prodcode from ord_stockadjust_d d where d.stockadjustnumber=ord_stockadjust_h.stockadjustnumber and prodcode='");
                        sb.Append(prodcode);
                        sb.Append("')");
                    }
                    if (!string.IsNullOrEmpty(proddesc))
                    {
                        ...
                        sb.Append(" exists(select d.prodcode from ord_stockadjust_d d left join buy_product p on d.prodcode=p.prodcode where d.stockadjustnumber=ord_stockadjust_h.stockadjustnumber and proddesc1+proddesc2+proddesc3 like '%");
                        sb.Append(proddesc);
                        sb.Append("%')");
                    }
