<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Edge.Web.Operation.StoreOrderManagement.StockAdjust.Add" %>
...
<body>
    ...
    <ext:Panel ID="Panel1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
        ...
        <Items>
                ...
                <Items>
                    ...
                    <ext:Form ID="sform1" runat="server" ShowBorder="false" ShowHeader="false" Title=""
                        ...
                        <Rows>
                            <ext:FormRow>
                                <Items>
                                    <ext:Label ID="StockAdjustNumber" runat="server" Label="Transaction Number">
                                    </ext:Label>
                                    <ext:Label ID="ReferenceNo" runat="server" Label="Reference No.">
                                    </ext:Label>
                                </Items>
                            </ext:FormRow>
                            <ext:FormRow>
                            ...
                            <ext:FormRow>
                                <Items>
                                    <ext:DropDownList ID="ReasonID" runat="server" Label="Reason ID"  Required="true" ShowRedStar="true">
                                    </ext:DropDownList>
                                    <ext:DropDownList ID="StockTypeCode" runat="server" Label="Stock Type Code" AutoPostBack="True"
                                        Required="true" ShowRedStar="true">
                                        <ext:ListItem Text="Good Stock" Value="G" Selected="true" />
                                        <ext:ListItem Text="Damaged Stock" Value="F" />
                                        <ext:ListItem Text="Show Inventory" Value="D" />
                                    </ext:DropDownList>
                                </Items>
                            </ext:FormRow>
                            <ext:FormRow>
                ...
                <Items>
                    <ext:Form ID="sform3" runat="server" ShowBorder="false" ShowHeader="false" Title=""
                        ...
                        <Rows>
                            ...
                            <ext:FormRow>
                                <Items>
                                    <ext:NumberBox ID="AdjustQty" runat="server" Label="Adjust Qty" MaxValue="1000000" NoDecimal="true"
                                        Required="true" ShowRedStar="true">
                                    </ext:NumberBox>
            ...
            <ext:GroupPanel ID="GroupPanel4" runat="server" EnableCollapse="True" Title="Adjust Single Details">
                <Items>
                    <ext:Grid ID="Grid2" ShowBorder="false" ShowHeader="false" PageSize="3" runat="server"
                        ...
                        <Columns>
                            ...
                            <ext:TemplateField Width="60px" HeaderText="Adjust Qty" SortField="AdjustQty">
                                <ItemTemplate>
                                    <%#((System.Data.DataRow)Container.DataItem)["AdjustQty"]%>
                                </ItemTemplate>
                            </ext:TemplateField>
