<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Print.aspx.cs" Inherits="Edge.Web.Operation.StoreOrderManagement.StockAdjust.Print" %>
...
<body>
    <form name="formSubmit" id="formSubmit" runat="server" method="post" action="/Operation/StoreOrderManagement/StockAdjust/Print.aspx">
    ...
    <ActiveReportsWeb:WebViewer ID="WebViewerStockAdjustList" runat="server" Width="100%"
