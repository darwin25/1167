...
namespace Edge.Web.Operation.StoreOrderManagement.TransInOrder
{
    public partial class Export : PageBase
    {
        ...
        private void LoadReport(string ids, int orderType)
        {
            ...
            reportTool.LoadReport(ids, WebViewerTransInOrderrList, url, webset.WebName, "TransInOrder");
        }
        ...
        protected void btnWord_Click(object sender, EventArgs e)
        {
            ...
            this.WebViewerTransInOrderrList.FlashViewerOptions.ResourceLocale = Request.Form["hidlanguage"];
            ...
            rpt.DataSource = reportTool.GetDataBind(Request.Form["hidIds"], webset.WebName, "TransInOrder");
            rpt.DataMember = "";
            rpt.Run();
            WebViewerTransInOrderrList.Report = rpt;
