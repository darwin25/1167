<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Edge.Web.Operation.StoreOrderManagement.TransInOrder.Add" %>
                ...
                <Items>
                    <ext:Form ID="sform3" runat="server" ShowBorder="false" ShowHeader="false" Title=""
                        ...
                        <Rows>
                            ...
                            <ext:FormRow>
                                <Items>
                                    <ext:NumberBox ID="TransInQty" runat="server" Label="Trans In Qty" MaxValue="1000000" NoDecimal="true"
                ...
                <Items>
                    <ext:Grid ID="Grid2" ShowBorder="false" ShowHeader="false" PageSize="3" runat="server"
                        ...
                        <Columns>
                            ...
                            <ext:TemplateField Width="60px" HeaderText="Trans In Qty" SortField="TransInQty">
                                <ItemTemplate>
                                    <%#((System.Data.DataRow)Container.DataItem)["TransInQty"]%>
                                </ItemTemplate>
                            </ext:TemplateField>
