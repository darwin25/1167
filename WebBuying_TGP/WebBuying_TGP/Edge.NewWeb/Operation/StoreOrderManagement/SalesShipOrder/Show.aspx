<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Show.aspx.cs" Inherits="Edge.Web.Operation.StoreOrderManagement.SalesShipOrder.Show" %>
            ...
            <ext:GroupPanel ID="GroupPanel4" runat="server" EnableCollapse="True" Title="Delivery Note Details">
                <Items>
                    <ext:Grid ID="Grid1" ShowBorder="false" ShowHeader="false" PageSize="3" runat="server"
                        ...
                        SummaryPosition="Bottom" EnableTextSelection="true">
                        <Columns>
