<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Print.aspx.cs" Inherits="Edge.Web.Operation.StoreOrderManagement.SalesShipOrder.Print" %>
...
<body>
    <form name="formSubmit" id="formSubmit" runat="server" method="post" action="/Operation/StoreOrderManagement/SalesShipOrder/Print.aspx">
    ...
    <ActiveReportsWeb:WebViewer ID="WebViewerShipmentSalesShipOrderList" runat="server" Width="100%"
        ViewerType="FlashViewer"  Height="550" BackColor="White">
