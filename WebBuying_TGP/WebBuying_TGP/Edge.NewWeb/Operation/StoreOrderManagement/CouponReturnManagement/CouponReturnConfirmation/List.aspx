<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Edge.Web.Operation.CouponManagement.CouponReturnManagement.CouponReturnConfirmation.List" %>
...
<body>
            ...
            <ext:Form ID="SearchForm" ShowBorder="True" BodyPadding="5px" EnableBackgroundColor="true"
                ...
                <Rows>
                    <ext:FormRow ID="FormRow1" runat="server" ColumnWidths="23% 23% 23% 23% 8%">
                        <Items>
                            <ext:TextBox ID="CouponReceiveNumber" runat="server" Label="交易编号：" MaxLength="64"></ext:TextBox>
                            <ext:DropDownList ID="ApproveStatus" runat="server" Label="交易状态：" Resizable="true">
                            ...
                            <ext:TextBox ID="ReferenceNo" runat="server" Label="参考编号：" MaxLength="64"></ext:TextBox>
                    ...
                    <ext:FormRow ID="FormRow2" runat="server" ColumnWidths="23% 23% 23% 23% 8%">
                        <Items>
                            <ext:DropDownList ID="SupplierID" runat="server" Label="库存(出)地点：" Resizable="true">
                            </ext:DropDownList>
                            <ext:DropDownList ID="StoreID" runat="server" Label="库存(入)地点：" Resizable="true">
                            </ext:DropDownList>
            ...
            <ext:Panel ID="Panel2" ShowBorder="false" ShowHeader="false" runat="server" EnableBackgroundColor="true"
                ...
                <Items>
                    <ext:Grid ID="Grid1" ShowBorder="false" ShowHeader="false" AutoHeight="true" PageSize="3"
                        runat="server" EnableCheckBoxSelect="True" DataKeyNames="CouponReceiveNumber"
                        ...
                        <Toolbars>
                            <ext:Toolbar ID="Toolbar1" runat="server">
                                <Items>
                                    <ext:Button ID="btnConfirm" Text="确认退回" Icon="Accept" runat="server" OnClick="btnConfirm_Click">
                                    </ext:Button>
                        ...
                        <Columns>
                            <ext:TemplateField Width="60px" HeaderText="交易编号" SortField="CouponReceiveNumber">
                                <ItemTemplate>
                                    <asp:Label ID="lb_id" runat="server" Text='<%# Eval("CouponReceiveNumber") %>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
                            <ext:TemplateField Width="60px" HeaderText="参考编号" SortField="ReferenceNo">
                                <ItemTemplate>
                            ...
                            <ext:TemplateField Width="60px" HeaderText="库存(出)地点">
                                <ItemTemplate>
                                    <asp:Label ID="lblSupplierID" runat="server" Text='<%# Eval("FullSupplierID") %>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
                            ...
                            <ext:WindowField ColumnID="ViewWindowField" Width="60px" WindowID="Window1" Icon="Page"
                                Text="查看" ToolTip="查看" DataTextFormatString="{0}" DataIFrameUrlFields="CouponReceiveNumber"
                            ...
                            <ext:WindowField ColumnID="EditWindowField" Width="60px" WindowID="Window2" Icon="PageEdit"
                                Text="修改" ToolTip="修改" DataTextFormatString="{0}" DataIFrameUrlFields="CouponReceiveNumber"
    ...
    <ext:HiddenField ID="SearchFlag" Text="1" runat="server"></ext:HiddenField>
