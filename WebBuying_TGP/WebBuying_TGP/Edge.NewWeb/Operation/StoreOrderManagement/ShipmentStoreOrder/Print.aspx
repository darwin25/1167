<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Print.aspx.cs" Inherits="Edge.Web.Operation.StoreOrderManagement.ShipmentStoreOrder.Print" %>
...
<body>
    <form name="formSubmit" id="formSubmit" runat="server" method="post" action="/Operation/StoreOrderManagement/ShipmentStoreOrder/Print.aspx">
    ...
    <ActiveReportsWeb:WebViewer ID="WebViewerShipmentStoreOrderList" runat="server" Width="100%"
