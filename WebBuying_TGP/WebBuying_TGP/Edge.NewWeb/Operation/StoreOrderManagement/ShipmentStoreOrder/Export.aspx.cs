...
namespace Edge.Web.Operation.StoreOrderManagement.ShipmentStoreOrder
{
    public partial class Export : PageBase
    {
        ...
        //英文Url
        protected string enusUrl = "\\StoreOrderManagement\\ShipmentStoreOrder\\rptShipmentStoreOrderByEnglish.rpx";
        //中文简体Url
        protected string zhcnUrl = "\\StoreOrderManagement\\ShipmentStoreOrder\\rptShipmentStoreOrder.rpx";
        //中文繁体Url
        protected string zhhkUrl = "\\StoreOrderManagement\\ShipmentStoreOrder\\rptShipmentStoreOrderByTraditional.rpx";
        #endregion
        ...
        private void LoadReport(string ids, int orderType)
        {
            ...
            reportTool.LoadReport(ids, WebViewerShipmentStoreOrderList, url, webset.WebName, "ShipmentStoreOrder");
        }
        ...
        {
            this.WebViewerShipmentStoreOrderList.FlashViewerOptions.ResourceLocale = Request.Form["hidlanguage"];
            ...
            rpt.DataSource = reportTool.GetDataBind(Request.Form["hidIds"], webset.WebName, "ShipmentStoreOrder");
            rpt.DataMember = "";
            rpt.Run();
            WebViewerShipmentStoreOrderList.Report = rpt;
...
GrapeCity.ActiveReports.Export.Word.Section.RtfExport();
            ...
            {
                exportlanguage = "ShipmentStoreOrder";
            }
            else if (Request.Form["hidlanguage"] == "zh-cn")
            {
                exportlanguage = "总部送货单";
            }
            else
            {
                exportlanguage = "總部送貨單";
            }
