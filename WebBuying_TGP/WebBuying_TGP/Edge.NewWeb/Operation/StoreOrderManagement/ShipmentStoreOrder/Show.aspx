<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Show.aspx.cs" Inherits="Edge.Web.Operation.StoreOrderManagement.ShipmentStoreOrder.Show" %>
                ...
                <Items>
                    ...
                    <ext:Form ID="sform1" runat="server" ShowBorder="false" ShowHeader="false" Title=""
                        ...
                        <Rows>
                            <ext:FormRow>
                                <Items>
                                    <ext:Label ID="ShipmentOrderNumber" runat="server" Label="Transaction Number" Width="200">
                                    </ext:Label>
                ...
                <Items>
                    <ext:Form ID="Form2" runat="server" ShowBorder="false" ShowHeader="false" Title=""
                        ...
                        <Rows>
                            <ext:FormRow>
                                <Items>
                                    <ext:Label runat="server" ID="DeliveryNumber" Label="Delivery Note Number" >
                                    </ext:Label>
                                    <ext:Label runat="server" ID="LogisticsProviderID" Label="Logistics Provider ID">
                                    </ext:Label>
                                </Items>
                            </ext:FormRow>
                        </Rows>
