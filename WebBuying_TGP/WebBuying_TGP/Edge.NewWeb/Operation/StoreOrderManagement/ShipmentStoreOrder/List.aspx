<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Edge.Web.Operation.StoreOrderManagement.ShipmentStoreOrder.List" %>
            ...
            <ext:Form ID="SearchForm" ShowBorder="True" BodyPadding="5px" 
                ...
                <Rows>
                    ...
                    <ext:FormRow ID="FormRow2" runat="server" ColumnWidths="23% 23% 23% 23% 8%">
                        <Items>
                            <ext:DropDownList ID="FromStoreID" runat="server" Label="Inventory (out) location" ></ext:DropDownList>
                            <ext:DropDownList ID="StoreID" runat="server" Label="Inventory (into) location" ></ext:DropDownList>
                    ...
                    <ext:FormRow ID="FormRow4" runat="server" ColumnWidths="23% 23% 23% 23% 8%">
                        <Items>
                            ...
                            <ext:Label ID="Label9" runat="server" Label="" Hidden="true" HideMode="Offsets"></ext:Label>
                        </Items>
                    </ext:FormRow>
                </Rows>
            </ext:Form>
            <ext:Panel ID="Panel2" ShowBorder="false" ShowHeader="false" runat="server" 
                ...
                <Items>
                    <ext:Grid ID="Grid1" ShowBorder="false" ShowHeader="false"  PageSize="3"
                        runat="server" EnableCheckBoxSelect="True" DataKeyNames="ShipmentOrderNumber,OrderType"
                        ...
                        <Toolbars>
                            <ext:Toolbar ID="Toolbar1" runat="server">
                                <Items>
                                    <ext:Button ID="btnNew" Text="Add" Icon="Add" EnablePostBack="false" runat="server" Hidden=true>
                                    </ext:Button>
                                    ...
                                    <%--<ext:Button ID="btnExport"   Text="Send" Icon="Mail" runat="server" OnClick="btnExport_Click">
                                    </ext:Button>--%>
                        ...
                        <Columns>
                            <ext:TemplateField Width="80px" HeaderText="Transaction Number" SortField="ShipmentOrderNumber">
                                <ItemTemplate>
                                    <asp:Label ID="lb_id" runat="server" Text='<%# Eval("ShipmentOrderNumber") %>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
                            ...
                            <ext:TemplateField Width="80px" HeaderText="Reference No." SortField="ReferenceNo">
                                <ItemTemplate>
                            ...
                            <ext:TemplateField Width="60px" HeaderText="Approve By">
                             ...
                             <ext:WindowField ColumnID="ViewWindowField" Width="60px" WindowID="Window1" Icon="Page"
                                Text="View" ToolTip="View" DataTextFormatString="{0}" DataIFrameUrlFields="ShipmentOrderNumber"
                            ...
                            <ext:WindowField ColumnID="EditWindowField" Width="60px" WindowID="Window2" Icon="PageEdit"
                                Text="Edit" ToolTip="Edit" DataTextFormatString="{0}" DataIFrameUrlFields="ShipmentOrderNumber"
