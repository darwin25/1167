<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Edge.Web.Operation.StoreOrderManagement.ShipmentStoreOrder.Modify" %>
...
<body>
    ...
    <ext:Panel ID="Panel1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
        ...
        <Items>
            ...
            <ext:GroupPanel ID="GroupPanel6" runat="server" EnableCollapse="True" Title="Delivery Information">
                <Items>
                    <ext:Form ID="Form2" runat="server" ShowBorder="false" ShowHeader="false" Title=""
                        ...
                        <Rows>
                            <ext:FormRow>
                                <Items>
                                    <ext:DropDownList ID="LogisticsProviderID" runat="server" Label="物流公司">
                                    </ext:DropDownList>
                                    <ext:TextBox ID="DeliveryNumber" runat="server" Label="Delivery Note Number">
                                    </ext:TextBox>
                                </Items>
                            </ext:FormRow>
                        </Rows>
                ...
                <Items>
                    <ext:Grid ID="Grid2" ShowBorder="false" ShowHeader="false" PageSize="3" runat="server"
                        ...
                        <Columns>
                            ...
                            <ext:BoundField Width="60px" DataField="ActualQTY" HeaderText="Delivery Quantity" ColumnID="onActualQty">
                            </ext:BoundField>
