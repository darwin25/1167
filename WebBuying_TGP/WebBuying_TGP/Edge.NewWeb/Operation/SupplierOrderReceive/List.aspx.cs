...
namespace Edge.Web.Operation.SupplierOrderReceive
{
    public partial class List : PageBase
    {
        ...
        SupplierOrderReceiveController controller = new SupplierOrderReceiveController();
            ...
            try
            {
                ...
                if (SearchFlag.Text == "1")
                {
                    ...
                    if (!string.IsNullOrEmpty(code))
                    {
                        ...
                        sb.Append(" HQReceiveOrderNumber like '%");
                        sb.Append(code);
                        sb.Append("%'");
                    }
                    ...
                    if (!string.IsNullOrEmpty(prodcode))
                    {
                        ...
                        sb.Append(" exists(select d.prodcode from ord_hqreceiveorder_d d where d.hqreceiveordernumber=ord_hqreceiveorder_h.hqreceiveordernumber and prodcode='");
                        sb.Append(prodcode);
                        sb.Append("')");
                    }
                    if (!string.IsNullOrEmpty(proddesc))
                    {
                        ...
                        sb.Append(" exists(select d.prodcode from ord_hqreceiveorder_d d left join buy_product p on d.prodcode=p.prodcode where d.hqreceiveordernumber=ord_hqreceiveorder_h.hqreceiveordernumber and proddesc1+proddesc2+proddesc3 like '%");
                        sb.Append(proddesc);
                        sb.Append("%')");
                    }
