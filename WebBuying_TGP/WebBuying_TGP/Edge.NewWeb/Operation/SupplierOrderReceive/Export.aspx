<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Export.aspx.cs" Inherits="Edge.Web.Operation.SupplierOrderReceive.Export" %>
...
<body>
    ...
    <input type="hidden" id="hidIds" name="hidIds" runat="server" />
    ...
    <div style="margin-bottom: 10px;">
        ...
        <ActiveReportsWeb:WebViewer ID="WebViewerSupplierOrderReceive" runat="server" Height="650"
            Width="100%">
