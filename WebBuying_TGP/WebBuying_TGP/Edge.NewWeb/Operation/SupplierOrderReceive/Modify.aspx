<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Edge.Web.Operation.SupplierOrderReceive.Modify" %>
...
<body>
    ...
    <ext:Panel ID="Panel1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
        ...
        <Items>
                ...
                <Items>
                    ...
                    <ext:Form ID="sform1" runat="server" ShowBorder="false" ShowHeader="false" Title=""
                        ...
                        <Rows>
                            <ext:FormRow>
                                <Items>
                                    <ext:Label ID="HQReceiveOrderNumber" runat="server" Label="Transaction Number">
                                    </ext:Label>
                ...
                <Items>
                    <ext:Form ID="sForm4" runat="server" ShowBorder="false" ShowHeader="false" Title=""
                        ...
                        <Rows>
                            <ext:FormRow>
                                <Items>
                                    <ext:RadioButtonList ID="ReceiveType" runat="server" Label="Receipt Type" AutoPostBack="True"
                                        OnSelectedIndexChanged="ReceiveType_SelectedIndexChanged" Width="250">
                                        <ext:RadioItem Text="Supply Order Receipt" Value="1" Selected="true" />
                                        <ext:RadioItem Text="Store Return Receipt" Value="2" />
                                    </ext:RadioButtonList>
                                </Items>
                            </ext:FormRow>
                            <ext:FormRow>
                                <Items>
                                    <ext:DropDownList ID="VendorID" runat="server" Label="Supplier" OnSelectedIndexChanged="SupplierID_SelectedIndexChanged"
                                        AutoPostBack="True" Required="false" ShowRedStar="true">
                                    </ext:DropDownList>
                                    <ext:DropDownList ID="FromStoreID" runat="server" Label="Shipping Store" OnSelectedIndexChanged="FromStoreID_SelectedIndexChanged"
                                        AutoPostBack="True" Required="false" ShowRedStar="true">
                                    </ext:DropDownList>
                                </Items>
                            </ext:FormRow>
                ...
                <Items>
                    <ext:Form ID="sform2" runat="server" ShowBorder="false" ShowHeader="false" Title=""
                        ...
                        <Rows>
                            <ext:FormRow>
                                <Items>
                                    <ext:DropDownList ID="StoreID" runat="server" Label="Warehouse" OnSelectedIndexChanged="StoreID_SelectedIndexChanged"
                ...
                <Items>
                    <ext:Form ID="sform3" runat="server" ShowBorder="false" ShowHeader="false" Title=""
                        ...
                        <Rows>
                            ...
                            <ext:FormRow>
                                <Items>
                                    <ext:NumberBox ID="ReceiveQty" runat="server" Label="Receipt Quantity" MaxValue="1000000" NoDecimal="true"
            ...
            <ext:GroupPanel ID="GroupPanel4" runat="server" EnableCollapse="True" Title="Receipt List Details">
                <Items>
                    <ext:Grid ID="Grid2" ShowBorder="false" ShowHeader="false" PageSize="3" runat="server"
                        ...
                        ForceFit="true" OnPageIndexChange="Grid2_PageIndexChange" OnRowCommand="Grid2_RowCommand" EnableSummary="true" SummaryPosition="Bottom">
                        <Toolbars>
                        ...
                        <Columns>
                            ...
                            <ext:BoundField Width="60px" DataField="OrderQTY"  HeaderText="Order Quantity"  ColumnID="onOrderQty" ></ext:BoundField>
                            <ext:BoundField Width="60px" DataField="ReceiveQTY" HeaderText="Receipt Quantity"  ColumnID="onReceiveQTY" ></ext:BoundField>
