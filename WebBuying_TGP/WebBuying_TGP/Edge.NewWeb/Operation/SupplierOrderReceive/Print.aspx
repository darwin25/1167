<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Print.aspx.cs" Inherits="Edge.Web.Operation.SupplierOrderReceive.Print" %>
...
<body>
    ...
    <form name="formSubmit" id="formSubmit" runat="server" method="post" action="/Operation/SupplierOrderReceive/Print.aspx">
    ...
    <ActiveReportsWeb:WebViewer ID="WebViewerSupplierOrderReceive" runat="server" Width="100%"
