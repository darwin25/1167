<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Show.aspx.cs" Inherits="Edge.Web.Operation.SupplierOrderReceive.Show" %>
                ...
                <Items>
                    ...
                    <ext:Form ID="sform1" runat="server" ShowBorder="false" ShowHeader="false" Title=""
                        ...
                        <Rows>
                            <ext:FormRow>
                                <Items>
                                    <ext:Label ID="HQReceiveOrderNumber" runat="server" Label="Transaction Number" Width="200">
                                    </ext:Label>
                ...
                <Items>
                    <ext:Form ID="sForm4" runat="server" ShowBorder="false" ShowHeader="false" Title=""
                        ...
                        <Rows>
                            <ext:FormRow>
                                <Items>
                                    <ext:Label ID="FromStoreID" runat="server" Label="供应商/店铺">
                                    </ext:Label>
