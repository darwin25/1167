<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Edge.Web.Operation.SupplierOrderReceive.Add" %>
                ...
                <Items>
                    <ext:Grid ID="Grid2" ShowBorder="false" ShowHeader="false" PageSize="3" runat="server"
                        ...
                        <Columns>
                            ...
                            <ext:TemplateField Width="60px" HeaderText="Order Quantity" SortField="OrderQTY">
                                <ItemTemplate>
                                    <%#((System.Data.DataRow)Container.DataItem)["OrderQTY"]%>
                                </ItemTemplate>
                            </ext:TemplateField>
                            <ext:TemplateField Width="60px" HeaderText="Receipt Quantity" SortField="ReceiveQTY">
                                <ItemTemplate>
                                    <%#((System.Data.DataRow)Container.DataItem)["ReceiveQTY"]%>
                                </ItemTemplate>
                            </ext:TemplateField>
