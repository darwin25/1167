<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Edge.Web.WebBuying.StoreManager.POSStaff.Modify" %>
                ...
                <Items>
                    <ext:SimpleForm ID="SimpleForm2" ShowBorder="false" ShowHeader="false" runat="server"
                        ...
                        <Items>
                            ...
                            <ext:NumberBox ID="StaffLevel" runat="server" Label="员工级别" MaxValue="3" NoDecimal="true"
                            ...
                            <ext:Label ID="lblstaffpwd" runat="server" Hidden="true" />
                        </Items>
                    </ext:SimpleForm>
