<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Show.aspx.cs" Inherits="Edge.Web.WebBuying.MasterFiles.ComplexInformations.BUY_PRODUCT.Bauhaus.Show" %>
                                ...
                                <Rows>
                                    ...
                                    <ext:FormRow ID="FormRow37" runat="server" ColumnWidths="50% 50%">
                                     ...
                                     <ext:FormRow ID="FormRow24" runat="server" ColumnWidths="50% 50%">
                                        <Items>
                                            <ext:Label ID="DepartCode" runat="server" Label="Department">
                                            </ext:Label>
                                        </Items>
                                    </ext:FormRow>
                        ...
                        <Items>
                            <ext:Form ID="Form6" ShowHeader="false" ShowBorder="false" runat="server" HideMode="Display"
                                ...
                                <Rows>
                                    ...
                                    <ext:FormRow ID="FormRow48" runat="server" ColumnWidths="100%">
                                        <Items>
                                            <ext:Label ID="CreatedOn" runat="server" Label="Created Date Time">
                                            </ext:Label>
                                        </Items>
                                    </ext:FormRow>
                                    <ext:FormRow ID="FormRow56" runat="server" ColumnWidths="100%">
                                        <Items>
                                            <ext:Label ID="CreatedBy" runat="server" Label="Created By">
                                            </ext:Label>
                                        </Items>
                                    </ext:FormRow>
                                    <ext:FormRow ID="FormRow49" runat="server" ColumnWidths="100%">
                                        <Items>
                                            <ext:Label ID="UpdatedOn" runat="server" Label="更新日期">
                                            </ext:Label>
                                        </Items>
                                    </ext:FormRow>
                                    <ext:FormRow ID="FormRow57" runat="server" ColumnWidths="100%">
                                        <Items>
                                    ...
                                    <ext:FormRow ID="FormRow26" runat="server" ColumnWidths="100%">
                                        <Items>
                                            <ext:Label ID="ApprovedBy" runat="server" Label="审核人">
                                            </ext:Label>
                                        </Items>
                                    </ext:FormRow>
                                </Rows>
                        ...
                        <Items>
                            ...
                            <ext:Form ID="Form7" ShowHeader="false" ShowBorder="false" runat="server" HideMode="Display"
                                ...
                                <Rows>
                                    ...
                                    <ext:FormRow ID="FormRow5" runat="server" ColumnWidths="100%">
                                        <Items>
