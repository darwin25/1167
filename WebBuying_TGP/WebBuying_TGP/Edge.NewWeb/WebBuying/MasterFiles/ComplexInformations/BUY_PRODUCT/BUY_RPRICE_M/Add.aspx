<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Edge.Web.WebBuying.MasterFiles.ComplexInformations.BUY_PRODUCT.BUY_RPRICE_M.Add" %>
...
<body>
    ...
    <ext:SimpleForm ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server"
        ...
        <Items>
            ...
            <ext:NumberBox ID="RefPrice" runat="server" Label="Reference price" DecimalPrecision="2">
            </ext:NumberBox>
            <%--<ext:TextBox ID="Price" runat="server" Label="Retail Price" OnTextChanged="ConvertTextboxToDecimal" AutoPostBack="true"/>--%>
            <ext:NumberBox ID="Price" runat="server" Label="Retail Price" DecimalPrecision="2">
            </ext:NumberBox>
            ...
            <%--<ext:NumberBox ID="PromotionPrice" runat="server" Label="Promotion Price" DecimalPrecision="2" NoDecimal="false"/>--%>
