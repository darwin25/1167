<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Edge.Web.WebBuying.MasterFiles.ComplexInformations.BUY_BLACKLIST.Modify" %>
...
<body>
    ...
    <ext:SimpleForm ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server"
        ...
        <Items>
            ...
            <ext:TextBox ID="MobileNo" runat="server" Label="手机号码" Required="true" ShowRedStar="true"  Enabled="false" />
