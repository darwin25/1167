    ...
    public partial class List : PageBase
    {
        ...
        private void RptBind(string strWhere, string orderby)
        {
            try
            {
                ...
                BuyingBlackListController controller = new BuyingBlackListController();
                int count = 0;
            ...
            {
                logger.WriteErrorLog("BlackList", "Load Field", ex);
            }
        }
