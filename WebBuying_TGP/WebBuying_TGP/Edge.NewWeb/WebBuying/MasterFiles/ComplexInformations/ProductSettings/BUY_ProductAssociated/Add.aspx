<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Edge.Web.WebBuying.MasterFiles.ComplexInformations.ProductSettings.BUY_ProductAssociated.Add" %>
...
<body>
    ...
    <ext:SimpleForm ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server"
        ...
        <Items>
            ...
            <ext:Form ID="FormLoad"   ShowHeader="false"
                ...
                <Rows>
                    <ext:FormRow ID="FormRow1" ColumnWidths="50% 5% 45%" runat="server">
                        <Items>
                            <ext:TextBox ID="AssociatedProdCode" runat="server" Label="Associated Product Code" Width="223"
            ...
            <ext:Form ID="Form3" ShowHeader="false"  ShowBorder="false" runat="server" LabelAlign="Left" >
                <Rows>
                    <ext:FormRow ID="FormRow3" runat="server"  ColumnWidths="88% 12%">
                        <Items>
                            <ext:TextBox ID="AssociatedProdFile" runat="server"  Label="Picture of Goods" Readonly="true" ></ext:TextBox>                                
                            <ext:FileUpload ID="AssociatedProdFilePath" runat="server" ShowLabel="false"  Width="65px"
                                AutoPostBack="true" OnFileSelected="AssociatedProdFilePath_OnFileSelected" Height="20px" ButtonOnly="true">
                            </ext:FileUpload>
                        </Items>
                    </ext:FormRow>
                </Rows>
