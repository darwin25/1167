<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Edge.Web.WebBuying.MasterFiles.ComplexInformations.ProductSettings.BUY_ProductAssociated.List" %>
                ...
                <Items>
                    <ext:Grid ID="Grid1" ShowBorder="false" ShowHeader="false"  PageSize="3"
                        ...
                        <Columns>
                            ...
                            <ext:TemplateField Width="60px" HeaderText="Associated Product Code">
                                <ItemTemplate>
                                    <asp:Label ID="lblAssociatedProdCode" runat="server" Text='<%# Eval("AssociatedProdCode") %>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
                            <ext:TemplateField Width="60px" HeaderText="Associated Product Name">
                                <ItemTemplate>
                                    <asp:Label ID="Label3" runat="server" Text='<%# Eval("AssociatedProdName") %>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
