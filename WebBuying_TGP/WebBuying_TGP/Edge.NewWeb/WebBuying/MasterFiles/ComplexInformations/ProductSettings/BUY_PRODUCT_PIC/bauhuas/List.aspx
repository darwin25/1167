<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Edge.Web.WebBuying.MasterFiles.ComplexInformations.ProductSettings.BUY_PRODUCT_PIC.bauhuas.List" %>
...
<body>
            ...
            <ext:Form ID="SearchForm" ShowBorder="True" BodyPadding="5px" ShowHeader="False"
                ...
                <Rows>
                    <ext:FormRow ID="FormRow1" runat="server" ColumnWidths="30% 5% 65%">
                        <Items>
                            <ext:TextBox ID="txtSelect" runat="server" Label="Select Product" Width="135px" Readonly="true">
                            </ext:TextBox>
                            <ext:Button ID="btnSelect" runat="server" Text="...">
                            </ext:Button>
                            <ext:Label ID="Label1" runat="server" Hidden="true" HideMode="Display">
                            </ext:Label>
                        </Items>
                    </ext:FormRow>
                </Rows>
                ...
                <Items>
                    <ext:Grid ID="Grid1" ShowBorder="false" ShowHeader="false" PageSize="3" runat="server"
                        ...
                        <Columns>
                            ...
                            <ext:TemplateField Width="60px" HeaderText="Product Picture Notes 1">
                                <ItemTemplate>
                                    <asp:Label ID="Label2" runat="server" Text='<%# Eval("ProductPicNote1") %>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
    ...
    <ext:Window ID="Window3" Title="Edit" Hidden="true" EnableIFrame="true" runat="server"
        CloseAction="Hide" OnClose="WindowEdit_Close" IFrameUrl="about:blank" EnableMaximize="true"
        EnableResize="true" Target="Top" IsModal="True" Width="900px" Height="450px">
    </ext:Window>
