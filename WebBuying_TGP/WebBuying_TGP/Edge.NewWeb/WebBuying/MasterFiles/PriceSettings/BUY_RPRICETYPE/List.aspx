<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Edge.Web.WebBuying.MasterFiles.PriceSettings.BUY_RPRICETYPE.List" %>
            ...
            <ext:Panel ID="Panel2" ShowBorder="false" ShowHeader="false" runat="server" 
                ...
                <Items>
                    <ext:Grid ID="Grid1" ShowBorder="false" ShowHeader="false"  PageSize="3"
                        runat="server" EnableCheckBoxSelect="True" DataKeyNames="RPriceTypeID"
                        ...
                        <Columns>
                            <ext:TemplateField Width="60px" HeaderText="Retail Price Type Code" SortField="RPriceTypeCode">
                                <ItemTemplate>
                                    <asp:Label ID="lblRPriceTypeCode" runat="server" Text='<%# Eval("RPriceTypeCode") %>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
                            <ext:TemplateField Width="60px" HeaderText="零售价类型名称1">
                                <ItemTemplate>
                                    <asp:Label ID="lblRPriceTypeName1" runat="server" Text='<%# Eval("RPriceTypeName1") %>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
                            <ext:WindowField ColumnID="ViewWindowField" Width="60px" WindowID="Window1" Icon="Page"
                                Text="View" ToolTip="View" DataTextFormatString="{0}" DataIFrameUrlFields="RPriceTypeID"
                            ...
                            <ext:WindowField ColumnID="EditWindowField" Width="60px" WindowID="Window2" Icon="PageEdit"
                                Text="Edit" ToolTip="Edit" DataTextFormatString="{0}" DataIFrameUrlFields="RPriceTypeID"
