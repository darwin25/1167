...
namespace Edge.Web.WebBuying.MasterFiles.PriceSettings.BUY_RPRICETYPE
{
    public partial class List : PageBase
    {
        ...
        private void RptBind(string strWhere, string orderby)
        {
            try
            {
                ...
                if (SearchFlag.Text == "1")
                {
                    ...
                    if (!string.IsNullOrEmpty(desc))
                    {
                        ...
                        string descLan = "RPriceTypeName1";
                        sb.Append(descLan);
                        sb.Append(" like '%");
                        sb.Append(desc);
                        sb.Append("%'");
                ...
                BuyingPriceTypeController controller = new BuyingPriceTypeController();
                int count = 0;
            ...
            {
                logger.WriteErrorLog("PriceType", "Load Field", ex);
            }
        }
