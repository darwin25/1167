<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Edge.Web.WebBuying.MasterFiles.PriceSettings.BUY_RPRICE_H.List" %>
            ...
            <ext:Panel ID="Panel2" ShowBorder="false" ShowHeader="false" runat="server" 
                ...
                <Items>
                     <ext:Grid ID="Grid1" ShowBorder="false" ShowHeader="false"  PageSize="3"
                        runat="server" EnableCheckBoxSelect="True" DataKeyNames="RPriceCode"
                        ...
                        <Columns>
                            <ext:TemplateField Width="60px" HeaderText="Price Code" SortField="RPriceCode">
                                <ItemTemplate>
                                    <asp:Label ID="lblRPriceCode" runat="server" Text='<%# Eval("RPriceCode") %>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
                            ...
                            <ext:WindowField ColumnID="ViewWindowField" Width="60px" WindowID="Window1" Icon="Page"
                                Text="View" ToolTip="View" DataTextFormatString="{0}" DataIFrameUrlFields="RPriceCode"
                            ...
                            <ext:WindowField ColumnID="EditWindowField" Width="60px" WindowID="Window2" Icon="PageEdit"
                                Text="Edit" ToolTip="Edit" DataTextFormatString="{0}" DataIFrameUrlFields="RPriceCode"
