...
namespace Edge.Web.WebBuying.MasterFiles.PriceSettings.BUY_PROMO_H.BUY_DAYFLAG
{
    public partial class List : PageBase
    {
        ...
        private void RptBind(string strWhere, string orderby)
        {
            try
            {
                ...
                BuyingDayFlagController controller = new BuyingDayFlagController();
                int count = 0;
            ...
            {
                logger.WriteErrorLog("DayFlag", "Load Field", ex);
            }
        }
        ...
        {
            ctr.ViewModel.DayCode = this.Grid1.DataKeys[e.RowIndex][0].ToString();
            CloseAndPostBack();
        }
    }
}