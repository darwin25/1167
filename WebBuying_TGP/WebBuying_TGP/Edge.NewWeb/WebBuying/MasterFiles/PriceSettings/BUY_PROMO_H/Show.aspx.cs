...
{
    public partial class Show : Edge.Web.Tools.BasePage<Edge.SVA.BLL.BUY_PROMO_H, Edge.SVA.Model.BUY_PROMO_H>
    {
        ...
        protected override void OnLoadComplete(EventArgs e)
        {
            ...
            if (!this.IsPostBack)
            {
                ...
                this.MemberPromotionFlagView.Text = this.MemberPromotionFlag.SelectedItem == null ? "" : this.MemberPromotionFlag.SelectedItem.Text;
                this.BirthdayFlagView.Text = this.BirthdayFlag.SelectedItem == null ? "" : this.BirthdayFlag.SelectedItem.Text;
