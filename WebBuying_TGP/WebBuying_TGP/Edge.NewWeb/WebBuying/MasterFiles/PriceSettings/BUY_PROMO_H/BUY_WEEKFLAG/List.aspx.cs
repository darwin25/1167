    ...
    public partial class List : PageBase
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                RptBind("", "WeekFlagCode");

                //SVASessionInfo.BuyingPromotionController = null;
            }
            ctr = SVASessionInfo.BuyingPromotionController;
        }
        ...
        private void RptBind(string strWhere, string orderby)
        {
            try
            {
                ...
                BuyingWeekFlagController controller = new BuyingWeekFlagController();
                int count = 0;
            ...
            {
                logger.WriteErrorLog("WeekFlag", "Load Field", ex);
            }
        }
        ...
        {
            ctr.ViewModel.WeekCode = this.Grid1.DataKeys[e.RowIndex][0].ToString();
            CloseAndPostBack();
        }
    }
}