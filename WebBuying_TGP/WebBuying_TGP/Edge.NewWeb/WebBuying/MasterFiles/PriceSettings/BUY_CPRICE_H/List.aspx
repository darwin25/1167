<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Edge.Web.WebBuying.MasterFiles.PriceSettings.BUY_CPRICE_H.List" %>
            ...
            <ext:Panel ID="Panel2" ShowBorder="false" ShowHeader="false" runat="server" 
                ...
                <Items>
                    <ext:Grid ID="Grid1" ShowBorder="false" ShowHeader="false"  PageSize="3"
                        runat="server" EnableCheckBoxSelect="True" DataKeyNames="CPriceCode"
                        AllowPaging="true" IsDatabasePaging="true" ForceFit="true" OnPageIndexChange="Grid1_PageIndexChange" 
                        onrowdatabound="Grid1_RowDataBound"  OnSort="Grid1_Sort"
                        onprerowdatabound="Grid1_PreRowDataBound" AllowSorting="true">
                        <Toolbars>
                        ...
                        <Columns>
                            <ext:TemplateField Width="60px" HeaderText="Cost Code" SortField="CPriceCode">
                                <ItemTemplate>
                                    <asp:Label ID="lblCPriceCode" runat="server" Text='<%# Eval("CPriceCode") %>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
                            ...
                            <ext:TemplateField Width="60px" HeaderText="Supplier Code">
                                <ItemTemplate>
                                    <asp:Label ID="lblVendorCode" runat="server" Text='<%# Eval("VendorName") %>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
                            <ext:TemplateField Width="60px" HeaderText="Currency Code">
                                <ItemTemplate>
                                    <asp:Label ID="lblCurrencyCode" runat="server" Text='<%# Eval("CurrencyName") %>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
                            ...
                            <ext:TemplateField Width="60px" HeaderText="Approve By">
                             ...
                             <ext:WindowField ColumnID="ViewWindowField" Width="60px" WindowID="Window1" Icon="Page"
                                Text="View" ToolTip="View" DataTextFormatString="{0}" DataIFrameUrlFields="CPriceCode"
                            ...
                            <ext:WindowField ColumnID="EditWindowField" Width="60px" WindowID="Window2" Icon="PageEdit"
                                Text="Edit" ToolTip="Edit" DataTextFormatString="{0}" DataIFrameUrlFields="CPriceCode"
