<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" ValidateRequest="false" Inherits="Edge.Web.WebBuying.MasterFiles.BasicInformations.BRAND.Add" %>
...
<body>
    ...
    <ext:SimpleForm ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server"
        ...
        <Items>
            ...
            <ext:TextBox ID="StoreBrandName1" runat="server" Label="Brand Name" MaxLength="512" OnTextChanged="ConvertTextboxToUpperText"
                AutoPostBack="true">
            </ext:TextBox>
            <ext:TextBox ID="StoreBrandName2" runat="server" Label="品牌名称2" MaxLength="512" OnTextChanged="ConvertTextboxToUpperText"
                AutoPostBack="true">
            </ext:TextBox>
            <ext:TextBox ID="StoreBrandName3" runat="server" Label="品牌名称3" MaxLength="512" OnTextChanged="ConvertTextboxToUpperText"
                AutoPostBack="true">
            </ext:TextBox>
            <ext:HtmlEditor ID="StoreBrandDesc1" runat="server" Height="100" Label="品牌描述1" >
            </ext:HtmlEditor>
            <ext:HtmlEditor ID="StoreBrandDesc2" runat="server" Height="100" Label="品牌描述2">
            </ext:HtmlEditor>
            <ext:HtmlEditor ID="StoreBrandDesc3" runat="server" Height="100" Label="品牌描述3">
            </ext:HtmlEditor>
            ...
            <ext:TextBox ID="CardIssuerID" runat="server" Label="货品发行方">
            </ext:TextBox>
            <ext:TextBox ID="IndustryID" runat="server" Label="外键">
            </ext:TextBox>
