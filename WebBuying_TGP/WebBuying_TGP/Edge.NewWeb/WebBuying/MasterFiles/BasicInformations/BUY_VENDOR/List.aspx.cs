    ...
    public partial class List : PageBase
    {
        ...
        private void RptBind(string strWhere, string orderby)
        {
            try
            {
                ...
                BuyingVendorController controller = new BuyingVendorController();
                int count = 0;
            ...
            {
                logger.WriteErrorLog("Vendor", "Load Field", ex);
            }
        }
