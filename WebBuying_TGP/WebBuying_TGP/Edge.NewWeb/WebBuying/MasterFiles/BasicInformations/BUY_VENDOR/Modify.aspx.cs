...
{
    public partial class Modify : Edge.Web.Tools.BasePage<Edge.SVA.BLL.BUY_VENDOR, Edge.SVA.Model.BUY_VENDOR>
    {
        ...
        protected void btnSaveClose_Click(object sender, EventArgs e)
        {
            ...
            if (er.Success)
            {
                Tools.Logger.Instance.WriteOperationLog(this.PageName, "Update Vendor Success Code:" + controller.ViewModel.MainTable.VendorCode);
                CloseAndRefresh();
            }
            else
            {
                Tools.Logger.Instance.WriteOperationLog(this.PageName, "Update Vendor Failed Code:" + controller.ViewModel.MainTable == null ? "No Data" : controller.ViewModel.MainTable.VendorCode);
                ShowUpdateFailed();
            }
