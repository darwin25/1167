<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Edge.Web.WebBuying.MasterFiles.BasicInformations.BUY_BARCODE.List" %>
    ...
    <ext:Panel ID="Panel1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="3px"
        ...
        <Items>
            <ext:Form ID="SearchForm" ShowBorder="True" BodyPadding="5px" 
                ...
                <Rows>
                    <ext:FormRow runat="server" ColumnWidths="30% 5% 65%">
                        <Items>
                            <ext:TextBox ID="txtSelect" runat="server" Label="Select Product" Width="135px"></ext:TextBox>
                    ...
                    <ext:FormRow ID="FormRow2" runat="server" ColumnWidths="30% 5% 65%">
                        <Items>
                            <ext:TextBox ID="txtProdCode" runat="server" Label="Product Code" Width="135px" Enabled="false" Readonly="true"></ext:TextBox>
                            <ext:Label ID="Label2" runat="server" Hidden="true" HideMode="Display"/>
                            <ext:Label ID="Label3" runat="server" Hidden="true" HideMode="Display"/>
                        </Items>
                    </ext:FormRow>
                    <ext:FormRow ID="FormRow3" runat="server">
                        <Items>
                            <ext:TextBox ID="txtDesc" runat="server" Label="Description" Width="300px"></ext:TextBox>
                        </Items>
                    </ext:FormRow>
                    <ext:FormRow ID="FormRow1" runat="server" >
                        <Items>
                            <ext:TextBox ID="BarCode" runat="server" Label="Barcode" MaxLength="512" Hidden="true">
                            </ext:TextBox>
                            <ext:TextBox ID="ProdCode" runat="server" Label="Product Code" MaxLength="512" Hidden="true">
                            </ext:TextBox>
                            <ext:Button ID="SearchButton" Text="Search" Icon="Find" runat="server" OnClick="SearchButton_Click" Hidden="true">
                            </ext:Button>
                        </Items>
                    </ext:FormRow>
                </Rows>
            ...
            <ext:Panel ID="Panel2" ShowBorder="false" ShowHeader="false" runat="server" 
                ...
                <Items>
                    <ext:Grid ID="Grid1" ShowBorder="false" ShowHeader="false"  PageSize="3"
                        runat="server" EnableCheckBoxSelect="True" DataKeyNames="Barcode"
                        ...
                        <Columns>
                            <ext:TemplateField Width="60px" HeaderText="Barcode" SortField="Barcode">
                                <ItemTemplate>
                                    <asp:Label ID="lblBarcode" runat="server" Text='<%# Eval("Barcode") %>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
<%--                            <ext:TemplateField Width="60px" HeaderText="是否内部barcode" SortField="InternalBarcode">
                                <ItemTemplate>
                                    <asp:Label ID="Label4" runat="server" Text='<%# Eval("InternalBarcodeText") %>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>--%>
                            <ext:WindowField ColumnID="ViewWindowField" Width="60px" WindowID="Window1" Icon="Page"
                                Text="View" ToolTip="View" DataTextFormatString="{0}" DataIFrameUrlFields="Barcode"
                            ...
                            <ext:WindowField ColumnID="EditWindowField" Width="60px" WindowID="Window2" Icon="PageEdit"
                                Text="Edit" ToolTip="Edit" DataTextFormatString="{0}" DataIFrameUrlFields="Barcode"
    ...
    <ext:Window ID="Window3" Title="Add" Hidden="true" EnableIFrame="true" runat="server"
        CloseAction="HidePostBack" OnClose="WindowEdit_Close" IFrameUrl="about:blank" EnableMaximize="true" EnableResize="true"
        Target="Top" IsModal="True" Width="450px" Height="225px">
    </ext:Window>
