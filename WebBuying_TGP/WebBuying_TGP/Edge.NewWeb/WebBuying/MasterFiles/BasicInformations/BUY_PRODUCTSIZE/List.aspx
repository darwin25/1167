<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Edge.Web.WebBuying.MasterFiles.BasicInformations.BUY_PRODUCTSIZE.List" %>
            ...
            <ext:Panel ID="Panel2" ShowBorder="false" ShowHeader="false" runat="server" 
                ...
                <Items>
                    <ext:Grid ID="Grid1" ShowBorder="false" ShowHeader="false"  PageSize="3"
                        runat="server" EnableCheckBoxSelect="True" DataKeyNames="ProductSizeID"
                        ...
                        <Columns>
                            <ext:TemplateField Width="60px" HeaderText="Product Size Code" SortField="ProductSizeCode">
                                <ItemTemplate>
                                    <asp:Label ID="lblProductSizeCode" runat="server" Text='<%# Eval("ProductSizeCode") %>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
                            <ext:TemplateField Width="60px" HeaderText="Product Size Name 1">
                                <ItemTemplate>
                                    <asp:Label ID="lblProductSizeName1" runat="server" Text='<%# Eval("ProductSizeName1") %>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
                          <ext:WindowField ColumnID="ViewWindowField" Width="60px" WindowID="Window1" Icon="Page"
                                Text="View" ToolTip="View" DataTextFormatString="{0}" DataIFrameUrlFields="ProductSizeID"
                            ...
                            <ext:WindowField ColumnID="EditWindowField" Width="60px" WindowID="Window2" Icon="PageEdit"
                                Text="Edit" ToolTip="Edit" DataTextFormatString="{0}" DataIFrameUrlFields="ProductSizeID"
