...
namespace Edge.Web.WebBuying.MasterFiles.BasicInformations.BUY_PRODUCTSIZE
{
    public partial class List : PageBase
    {
        ...
        private void RptBind(string strWhere, string orderby)
        {
            try
            {
                ...
                if (SearchFlag.Text == "1")
                {
                    ...
                    if (!string.IsNullOrEmpty(code))
                    {
                        ...
                        sb.Append(" ProductSizeCode like '%");
                        sb.Append(code);
                        sb.Append("%'");
                    }
                    if (!string.IsNullOrEmpty(desc))
                    {
                        ...
                        string descLan = "ProductSizeName1";
                        sb.Append(descLan);
                        sb.Append(" like '%");
                        sb.Append(desc);
                        sb.Append("%'");
                ...
                BuyingProductSizeController controller = new BuyingProductSizeController();
                int count = 0;
            ...
            {
                logger.WriteErrorLog("ProductSize", "Load Field", ex);
            }
        }
