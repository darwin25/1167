<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Edge.Web.WebBuying.MasterFiles.BasicInformations.BUY_REPLEN.BUY_REPLEN_D.Add" %>
...
<body>
            ...
            <ext:GroupPanel ID="GroupPanel4" runat="server" EnableCollapse="True" Title="Fundamental Details">
                <Items>
                    <ext:SimpleForm ID="SimpleForm2" ShowHeader="false" ShowBorder="false" runat="server"
                        ...
                        <Items>
                            <ext:NumberBox runat="server" ID="MinStockQty" Label="Minimum Stock Qty">
                            </ext:NumberBox>
                            <ext:NumberBox runat="server" ID="RunningStockQty" Label="Normal Stock Qty">
                            </ext:NumberBox>
                            <ext:NumberBox runat="server" ID="OrderRoundUpQty" Label="Multiple of Order Quantity">
                            </ext:NumberBox>
                            ...
                            <ext:Form ID="SearchForm" ShowBorder="false" BodyPadding="0px" ShowHeader="False"
                                ...
                                <Rows>
                                    <ext:FormRow ID="FormRow1" runat="server" ColumnWidths="80% 15% 5%">
                                        <Items>
                                            <ext:TextBox ID="EntityCode" runat="server" Label="Entity Code" ShowRedStar="true" Required="true"
                                                Enabled="false">
                                            </ext:TextBox>
            ...
            <ext:GroupPanel ID="GroupPanel1" runat="server" EnableCollapse="True" Title="List">
                <Items>
                    <ext:Grid ID="Grid1" ShowBorder="false" ShowHeader="false" PageSize="10" runat="server"
                        EnableCheckBoxSelect="False" DataKeyNames="EntityCode" AllowPaging="true" IsDatabasePaging="true"
                        ...
                        <Columns>
                            ...
                            <ext:TemplateField Width="60px" HeaderText="Entity Code">
                                <ItemTemplate>
                                    <asp:Label ID="Label2" runat="server" Text='<%#Eval("EntityCode")%>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
                        </Columns>
                    </ext:Grid>
    ...
    <ext:HiddenField runat="server"  ID="hidUseReplenFormula"></ext:HiddenField>
    </form>
</body>
</html>
