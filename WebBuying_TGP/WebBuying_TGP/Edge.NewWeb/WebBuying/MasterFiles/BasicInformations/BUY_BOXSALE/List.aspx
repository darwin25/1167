<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Edge.Web.Controllers.WebBuying.MasterFiles.BasicInformations.BUY_BOXSALE.List" %>
                        ...
                        <Columns>
                            ...
                            <ext:TemplateField Width="60px" HeaderText="End Date">
                             ...
                             <ext:WindowField ColumnID="ViewWindowField" Width="60px" WindowID="Window1" Icon="Page"
                                ...
                                DataIFrameUrlFormatString="../../ComplexInformations/BUY_PRODUCT/Show.aspx?id={0}" DataWindowTitleFormatString="View"
                                Title="View" />
                            <ext:WindowField ColumnID="EditWindowField" Width="60px" WindowID="Window2" Icon="PageEdit"
                                Text="捆绑货品" ToolTip="捆绑货品" DataTextFormatString="{0}" DataIFrameUrlFields="ProdCode"
                                DataIFrameUrlFormatString="BundledGoods.aspx?ProdCode={0}" DataWindowTitleFormatString="捆绑货品"
                                Title="捆绑货品" />
                        </Columns>
                    </ext:Grid>
                </Items>
