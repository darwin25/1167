<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="Edge.Web.Controllers.WebBuying.MasterFiles.BasicInformations.BUY_BOXSALE.Add" %>
...
<body>
    ...
    <ext:SimpleForm ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server"
        ...
        <Items>
            ...
            <ext:Form ID="SearchForm" ShowHeader="false" ShowBorder="false" runat="server">
                <Rows>
                    <ext:FormRow ID="FormRow1" runat="server" ColumnWidths="70% 10% 20%">
                        <Items>
                            <ext:TextBox ID="ProdCode" runat="server" Label="子货品编码" Required="true" ShowRedStar="true"
                                Enabled="false">
                            </ext:TextBox>
                            <ext:Button ID="btnSelect" runat="server" Text="...">
                            </ext:Button>
                            <ext:Label ID="lbl123" runat="server" HideMode="Display">
                            </ext:Label>
                        </Items>
                    </ext:FormRow>
                </Rows>
            </ext:Form>
            <ext:TextBox ID="txtDesc" runat="server" Label="Description" Enabled="false" OnTextChanged="ConvertTextboxToUpperText"
                AutoPostBack="true">
            </ext:TextBox>
