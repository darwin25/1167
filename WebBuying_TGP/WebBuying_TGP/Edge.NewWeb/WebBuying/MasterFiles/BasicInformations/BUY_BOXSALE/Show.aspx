<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Show.aspx.cs" Inherits="Edge.Web.WebBuying.MasterFiles.BasicInformations.BUY_BOXSALE.Show" %>
            ...
            <ext:Form ID="Form3"   ShowHeader="false"
                ...
                <Rows>
                    ...
                    <ext:FormRow ID="FormRow2" runat="server" ColumnWidths="50% 50%">
                        <Items>
                            <ext:Label ID="Qty" runat="server" Label="子货品数量">
                            </ext:Label>
                            <ext:Label ID="MinQty" runat="server" Label="子货品最小数量">
                            </ext:Label>
                        </Items>
                    </ext:FormRow>
                    <ext:FormRow ID="FormRow3" runat="server" ColumnWidths="50% 50%">
                        <Items>
                            <ext:Label ID="MaxQty" runat="server" Label="子货品最大数量">
                            </ext:Label>
                            <ext:Label ID="DefaultQty" runat="server" Label="子货品默认数量">
                            </ext:Label>
                        </Items>
                    </ext:FormRow>
                    <ext:FormRow ID="FormRow4" runat="server" ColumnWidths="50% 50%">
                        <Items>
                            <ext:Label ID="Price" runat="server" Label="Price">
                            </ext:Label>
                            <ext:Label ID="PartValue" runat="server" Label="货品价格分摊值">
                            </ext:Label>
                        </Items>
                    </ext:FormRow>
                    <ext:FormRow ID="FormRow5" runat="server" ColumnWidths="50% 50%">
                        <Items>
                            <ext:Label ID="ValueType" runat="server" Label="货品价格分摊类型">
                            </ext:Label>
                        </Items>
                    </ext:FormRow>
                    <ext:FormRow ID="FormRow6" runat="server" ColumnWidths="50% 50%">
                        <Items>
                            <ext:Label ID="StartDate" runat="server" Label="生效日期">
                            </ext:Label>
                            <ext:Label ID="EndDate" runat="server" Label="失效日期">
                            </ext:Label>
                        </Items>
                    </ext:FormRow>
