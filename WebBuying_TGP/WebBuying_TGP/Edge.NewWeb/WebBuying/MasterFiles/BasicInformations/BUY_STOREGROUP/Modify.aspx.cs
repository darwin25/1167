...
{
    public partial class Modify : Edge.Web.Tools.BasePage<Edge.SVA.BLL.BUY_STOREGROUP, Edge.SVA.Model.BUY_STOREGROUP>
    {
        ...
        protected void btnSaveClose_Click(object sender, EventArgs e)
        {
            ...
            if (er.Success)
            {
                Tools.Logger.Instance.WriteOperationLog(this.PageName, "Update StoreGroup Success Code:" + controller.ViewModel.MainTable.StoreGroupCode);
                CloseAndPostBack();
            }
            else
            {
                Tools.Logger.Instance.WriteOperationLog(this.PageName, "Update StoreGroup Failed Code:" + controller.ViewModel.MainTable == null ? "No Data" : controller.ViewModel.MainTable.StoreGroupCode);
