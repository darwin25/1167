<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Edge.Web.WebBuying.MasterFiles.BasicInformations.BUY_STOREGROUP.List" %>
            ...
            <ext:Form ID="SearchForm" ShowBorder="True" BodyPadding="5px" 
                ...
                <Rows>
                    <ext:FormRow ID="FormRow1" runat="server">
                        <Items>
                            <ext:TextBox ID="Code" runat="server" Label="Store Group Code" MaxLength="512">
                            </ext:TextBox>
                            <ext:TextBox ID="Desc" runat="server" Label="店铺组名称1" MaxLength="512">
                            </ext:TextBox>
            ...
            <ext:Panel ID="Panel2" ShowBorder="false" ShowHeader="false" runat="server" 
                ...
                <Items>
                    <ext:Grid ID="Grid1" ShowBorder="false" ShowHeader="false"  PageSize="3"
                        runat="server" EnableCheckBoxSelect="True" DataKeyNames="StoreGroupID"
                        ...
                        <Columns>
                            <ext:TemplateField Width="60px" HeaderText="Store Group Code" SortField="StoreGroupCode">
                                <ItemTemplate>
                                    <asp:Label ID="lblStoreGroupCode" runat="server" Text='<%# Eval("StoreGroupCode") %>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
                            <ext:TemplateField Width="60px" HeaderText="店铺组名称1">
                                <ItemTemplate>
                                    <asp:Label ID="lblStoreGroupName1" runat="server" Text='<%# Eval("StoreGroupName1") %>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
                             <ext:WindowField ColumnID="ViewWindowField" Width="60px" WindowID="Window1" Icon="Page"
                                Text="View" ToolTip="View" DataTextFormatString="{0}" DataIFrameUrlFields="StoreGroupID"
                            ...
                            <ext:WindowField ColumnID="EditWindowField" Width="60px" WindowID="Window2" Icon="PageEdit"
                                Text="Edit" ToolTip="Edit" DataTextFormatString="{0}" DataIFrameUrlFields="StoreGroupID"
