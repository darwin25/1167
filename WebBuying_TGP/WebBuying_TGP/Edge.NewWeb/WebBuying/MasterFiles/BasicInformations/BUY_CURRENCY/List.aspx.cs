    ...
    public partial class List : PageBase
    {
        ...
        private void RptBind(string strWhere, string orderby)
        {
            try
            {
                ...
                BuyingCurrencyController controller = new BuyingCurrencyController();
                int count = 0;
            ...
            {
                logger.WriteErrorLog("Bank", "Load Field", ex);
            }
        }
        ...
        {
            Tools.SVASessionInfo.BuyingTendCode = this.Grid1.DataKeys[e.RowIndex][1].ToString();
            CloseAndPostBack();
        }
        ...
        protected void btnAddPicker_Click(object sender, EventArgs e)
        {
            ...
            Tools.SVASessionInfo.BuyingTendCode = sb.ToString().TrimEnd(',');
            CloseAndPostBack();
        }
    }
}