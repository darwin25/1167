<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Edge.Web.WebBuying.MasterFiles.BasicInformations.BUY_BANK.List" %>
            ...
            <ext:Form ID="SearchForm" ShowBorder="True" BodyPadding="5px" 
                ...
                <Rows>
                    <ext:FormRow runat="server">
                        <Items>
                            <ext:TextBox ID="Code" runat="server" Label="银行代码" MaxLength="512">
                            </ext:TextBox>
                            <ext:TextBox ID="Desc" runat="server" Label="银行名称1" MaxLength="512">
                            </ext:TextBox>
            ...
            <ext:Panel ID="Panel2" ShowBorder="false" ShowHeader="false" runat="server" 
                ...
                <Items>
                    <ext:Grid ID="Grid1" ShowBorder="false" ShowHeader="false"  PageSize="3"
                        runat="server" EnableCheckBoxSelect="True" DataKeyNames="BankID"
                        ...
                        <Columns>
                            <ext:TemplateField Width="60px" HeaderText="银行代码" SortField="BankCode">
                                <ItemTemplate>
                                    <asp:Label ID="lblBankCode" runat="server" Text='<%# Eval("BankCode") %>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
                            <ext:TemplateField Width="60px" HeaderText="银行名称1">
                                <ItemTemplate>
                                    <asp:Label ID="lblBankName1" runat="server" Text='<%# Eval("BankName") %>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
                            <ext:WindowField ColumnID="ViewWindowField" Width="60px" WindowID="Window1" Icon="Page"
                                Text="View" ToolTip="View" DataTextFormatString="{0}" DataIFrameUrlFields="BankID"
                            ...
                            <ext:WindowField ColumnID="EditWindowField" Width="60px" WindowID="Window2" Icon="PageEdit"
                                Text="Edit" ToolTip="Edit" DataTextFormatString="{0}" DataIFrameUrlFields="BankID"
