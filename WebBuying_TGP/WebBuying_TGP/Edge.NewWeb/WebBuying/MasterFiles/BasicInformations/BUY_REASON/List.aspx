<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Edge.Web.WebBuying.MasterFiles.BasicInformations.BUY_REASON.List" %>
            ...
            <ext:Form ID="SearchForm" ShowBorder="True" BodyPadding="5px" 
                ...
                <Rows>
                    <ext:FormRow ID="FormRow1" runat="server">
                        <Items>
                            <ext:TextBox ID="Code" runat="server" Label="Reason Code" MaxLength="512">
                            </ext:TextBox>
                            <ext:TextBox ID="Desc" runat="server" Label="Reason Description1" MaxLength="512">
                            </ext:TextBox>
            ...
            <ext:Panel ID="Panel2" ShowBorder="false" ShowHeader="false" runat="server" 
                ...
                <Items>
                    <ext:Grid ID="Grid1" ShowBorder="false" ShowHeader="false"  PageSize="3"
                        runat="server" EnableCheckBoxSelect="True" DataKeyNames="ReasonID"
                        ...
                        <Columns>
                            <ext:TemplateField Width="60px" HeaderText="Reason Code" SortField="ReasonCode">
                                <ItemTemplate>
                                    <asp:Label ID="lblReasonCode" runat="server" Text='<%# Eval("ReasonCode") %>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
                            <ext:TemplateField Width="60px" HeaderText="Reason Description1">
                                <ItemTemplate>
                            ...
                            <ext:WindowField ColumnID="ViewWindowField" Width="60px" WindowID="Window1" Icon="Page"
                                Text="View" ToolTip="View" DataTextFormatString="{0}" DataIFrameUrlFields="ReasonID"
                            ...
                            <ext:WindowField ColumnID="EditWindowField" Width="60px" WindowID="Window2" Icon="PageEdit"
                                Text="Edit" ToolTip="Edit" DataTextFormatString="{0}" DataIFrameUrlFields="ReasonID"
