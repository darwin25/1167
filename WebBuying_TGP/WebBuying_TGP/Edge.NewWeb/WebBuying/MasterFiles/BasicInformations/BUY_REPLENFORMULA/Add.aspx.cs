...
{
    public partial class Add : Edge.Web.Tools.BasePage<Edge.SVA.BLL.BUY_REPLENFORMULA, Edge.SVA.Model.BUY_REPLENFORMULA>
    {
        ...
        protected void btnSaveClose_Click(object sender, EventArgs e)
        {
            ...
            if (er.Success)
            {
                Tools.Logger.Instance.WriteOperationLog(this.PageName, "Add Replenformula Success Code:" + controller.ViewModel.MainTable.ReplenFormulaCode);
                CloseAndRefresh();
            }
            else
            {
                Tools.Logger.Instance.WriteOperationLog(this.PageName, "Add Replenformula Failed Code:" + controller.ViewModel.MainTable == null ? "No Data" : controller.ViewModel.MainTable.ReplenFormulaCode);
