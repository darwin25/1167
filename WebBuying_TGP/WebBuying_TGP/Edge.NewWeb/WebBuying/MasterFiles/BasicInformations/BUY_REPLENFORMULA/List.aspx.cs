...
namespace Edge.Web.WebBuying.MasterFiles.BasicInformations.BUY_REPLENFORMULA
{
    public partial class List : PageBase
    {
        ...
        private void RptBind(string strWhere, string orderby)
        {
            try
            {
                ...
                if (SearchFlag.Text == "1")
                {
                    ...
                    if (!string.IsNullOrEmpty(code))
                    {
                        ...
                        sb.Append(" ReplenFormulaCode like '%");
                        sb.Append(code);
                        sb.Append("%'");
                    }
                ...
                BuyingReplenformulaController controller = new BuyingReplenformulaController();
                int count = 0;
            ...
            {
                logger.WriteErrorLog("Replenformula", "Load Field", ex);
            }
        }
