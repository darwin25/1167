<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Edge.Web.WebBuying.MasterFiles.BasicInformations.BUY_REPLENFORMULA.Modify" %>
    ...
    <ext:SimpleForm ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server"
        ...
        <Items>
            <ext:TextBox ID="ReplenFormulaCode" runat="server" Label="Automatic Replenishment Code" Required="true"
                ShowRedStar="true" Enabled="false" LabelWidth="375"/>
            <ext:NumberBox ID="PreDefineDOC" runat="server" Label="Reserved Inventory Days" LabelWidth="375">
            </ext:NumberBox>
            ...
            <ext:NumberBox ID="AVGDailySalesPeriod" runat="server" Label="Number of days for the average number of sales" LabelWidth="375">
            </ext:NumberBox>
