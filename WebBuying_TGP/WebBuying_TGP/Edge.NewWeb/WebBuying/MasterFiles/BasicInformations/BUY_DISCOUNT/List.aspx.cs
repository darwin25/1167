    ...
    public partial class List : PageBase
    {
        ...
        private void RptBind(string strWhere, string orderby)
        {
            try
            {
                ...
                BuyingDiscountController controller = new BuyingDiscountController();
                int count = 0;
            ...
            {
                logger.WriteErrorLog("Reason", "Load Field", ex);
            }
        }
