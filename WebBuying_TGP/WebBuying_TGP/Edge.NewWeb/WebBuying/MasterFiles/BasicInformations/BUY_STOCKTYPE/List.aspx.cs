    ...
    public partial class List : PageBase
    {
        ...
        private void RptBind(string strWhere, string orderby)
        {
            try
            {
                ...
                BuyingStockTypeController controller = new BuyingStockTypeController();
                int count = 0;
            ...
            {
                logger.WriteErrorLog("StoreGroup", "Load Field", ex);
            }
        }
