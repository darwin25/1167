<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Show.aspx.cs" Inherits="Edge.Web.WebBuying.MasterFiles.BasicInformations.BUY_BRAND.Show" %>
                ...
                <Rows>
                    <ext:FormRow ID="FormRow11" runat="server" ColumnWidths="50% 50%">
                        <Items>
                            ...
                            <ext:Label ID="BrandName1" runat="server" Label="Brand Name 1">
                            </ext:Label>
                        </Items>
                    </ext:FormRow>
                    <ext:FormRow ID="FormRow12" runat="server" ColumnWidths="50% 50%">
                        <Items>
                            <ext:Label ID="BrandName2" runat="server" Label="品牌名称2">
                            </ext:Label>
                            <ext:Label ID="BrandName3" runat="server" Label="品牌名称3">
                            </ext:Label>
                        </Items>
                    </ext:FormRow>
                    <ext:FormRow ID="FormRow16" runat="server" ColumnWidths="50% 50%">
                        <Items>
                            <ext:Label ID="BrandDesc1" runat="server" Label="品牌描述1" EncodeText="false">
                            </ext:Label>
                            <ext:Label ID="BrandDesc2" runat="server" Label="品牌描述2" EncodeText="false">
                            </ext:Label>
                        </Items>
                    </ext:FormRow>
                    <ext:FormRow ID="FormRow17" runat="server" ColumnWidths="50% 50%">
                        <Items>
                            <ext:Label ID="BrandDesc3" runat="server" Label="品牌描述3" EncodeText="false">
                            </ext:Label>
                        </Items>
                    </ext:FormRow>                 
                    ...
                    <ext:FormRow ID="FormRow9" runat="server">
                        <Items>
                            <ext:Label ID="CardIssuerID" runat="server" Label="Translate__Special_121_Start发行方IDTranslate__Special_121_End">
                            </ext:Label>
