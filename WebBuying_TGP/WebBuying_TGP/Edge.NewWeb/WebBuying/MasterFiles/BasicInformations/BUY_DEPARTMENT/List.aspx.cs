...
namespace Edge.Web.WebBuying.MasterFiles.BasicInformations.BUY_DEPARTMENT
{
    public partial class List : PageBase
    {
        ...
        private void RptBind(string strWhere, string orderby)
        {
            ...
            {
                logger.WriteErrorLog("Department", "Load Field", ex);
            }
        }
        ...
        {
            Tools.SVASessionInfo.BuyingDepartCode = this.Grid1.DataKeys[e.RowIndex][0].ToString();
            CloseAndPostBack();
        }
        ...
        protected void btnAddPicker_Click(object sender, EventArgs e)
        {
            ...
            Tools.SVASessionInfo.BuyingDepartCode = sb.ToString().TrimEnd(',');
            CloseAndPostBack();
        }
    }
}