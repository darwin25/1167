<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Edge.Web.WebBuying.MasterFiles.BasicInformations.BUY_FULFILLMENTHOUSE.List" %>
            ...
            <ext:Panel ID="Panel2" ShowBorder="false" ShowHeader="false" runat="server" 
                ...
                <Items>
                    <ext:Grid ID="Grid1" ShowBorder="false" ShowHeader="false"  PageSize="3"
                        runat="server" EnableCheckBoxSelect="True" DataKeyNames="FulfillmentHouseID"
                        ...
                        <Columns>
                            <ext:TemplateField Width="60px" HeaderText="Supply Warehouse Code" SortField="FulfillmentHouseCode">
                                <ItemTemplate>
                                    <asp:Label ID="lblFulfillmentHouseCode" runat="server" Text='<%# Eval("FulfillmentHouseCode") %>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
                            <ext:TemplateField Width="60px" HeaderText="Supply Warehouse Name1">
                                <ItemTemplate>
                                    <asp:Label ID="lblFulfillmentHouseName1" runat="server" Text='<%# Eval("FulfillmentHouseName1") %>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
                            <ext:WindowField ColumnID="ViewWindowField" Width="60px" WindowID="Window1" Icon="Page"
                                Text="View" ToolTip="View" DataTextFormatString="{0}" DataIFrameUrlFields="FulfillmentHouseID"
                            ...
                            <ext:WindowField ColumnID="EditWindowField" Width="60px" WindowID="Window2" Icon="PageEdit"
                                Text="Edit" ToolTip="Edit" DataTextFormatString="{0}" DataIFrameUrlFields="FulfillmentHouseID"
