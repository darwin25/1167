...
namespace Edge.Web.WebBuying.MasterFiles.BasicInformations.BUY_FULFILLMENTHOUSE
{
    public partial class List : PageBase
    {
        ...
        private void RptBind(string strWhere, string orderby)
        {
            try
            {
                ...
                if (SearchFlag.Text == "1")
                {
                    ...
                    if (!string.IsNullOrEmpty(code))
                    {
                        ...
                        sb.Append(" FulfillmentHouseCode like '%");
                        sb.Append(code);
                        sb.Append("%'");
                    }
                    if (!string.IsNullOrEmpty(desc))
                    {
                        ...
                        string descLan = "FulfillmentHouseName1";
                        sb.Append(descLan);
                        sb.Append(" like '%");
                        sb.Append(desc);
                        sb.Append("%'");
                ...
                BuyingFulfillmenthouseController controller = new BuyingFulfillmenthouseController();
                int count = 0;
            ...
            {
                logger.WriteErrorLog("Fulfillmenthouse", "Load Field", ex);
            }
        }
