<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Edge.Web.WebBuying.MasterFiles.PromotionInfos.BUY_WEEKFLAG.List" %>
            ...
            <ext:Panel ID="Panel2" ShowBorder="false" ShowHeader="false" runat="server" 
                ...
                <Items>
                    <ext:Grid ID="Grid1" ShowBorder="false" ShowHeader="false"  PageSize="3"
                        runat="server" EnableCheckBoxSelect="True" DataKeyNames="WeekFlagID"
                        ...
                        <Columns>
                            <ext:TemplateField Width="60px" HeaderText="周设置编码" SortField="WeekFlagCode">
                                <ItemTemplate>
                                    <asp:Label ID="lblWeekFlagCode" runat="server" Text='<%# Eval("WeekFlagCode") %>'></asp:Label>
                                </ItemTemplate>
                            </ext:TemplateField>
                           ...
                           <ext:WindowField ColumnID="ViewWindowField" Width="60px" WindowID="Window1" Icon="Page"
                                Text="View" ToolTip="View" DataTextFormatString="{0}" DataIFrameUrlFields="WeekFlagID"
                            ...
                            <ext:WindowField ColumnID="EditWindowField" Width="60px" WindowID="Window2" Icon="PageEdit"
                                Text="Edit" ToolTip="Edit" DataTextFormatString="{0}" DataIFrameUrlFields="WeekFlagID"
