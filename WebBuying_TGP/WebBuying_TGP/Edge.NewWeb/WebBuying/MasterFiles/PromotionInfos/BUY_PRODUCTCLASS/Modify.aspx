<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Edge.Web.WebBuying.MasterFiles.PromotionInfos.BUY_PRODUCTCLASS.Modify" %>
    ...
    <ext:SimpleForm ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server"
        ...
        <Items>
            ...
            <ext:TextBox ID="ProdClassDesc3" runat="server" Label="货品大类描述3" OnTextChanged="ConvertTextboxToUpperText"
                AutoPostBack="true" />
            <ext:DropDownList ID="ParentID" runat="server" Label="父类">
            </ext:DropDownList>
