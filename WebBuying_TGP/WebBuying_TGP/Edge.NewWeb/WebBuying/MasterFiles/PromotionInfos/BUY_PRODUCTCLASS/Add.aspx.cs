...
{
    public partial class Add : Edge.Web.Tools.BasePage<Edge.SVA.BLL.BUY_PRODUCTCLASS, Edge.SVA.Model.BUY_PRODUCTCLASS>
    {
        ...
        protected void btnSaveClose_Click(object sender, System.EventArgs e)
        {
            ...
            if (er.Success)
            {
                Tools.Logger.Instance.WriteOperationLog(this.PageName, "Add ProdClass Success Code:" + controller.ViewModel.MainTable.ProdClassCode);
                CloseAndRefresh();
            }
            else
            {
                Tools.Logger.Instance.WriteOperationLog(this.PageName, "Add ProdClass Failed Code:" + controller.ViewModel.MainTable == null ? "No Data" : controller.ViewModel.MainTable.ProdClassCode);
