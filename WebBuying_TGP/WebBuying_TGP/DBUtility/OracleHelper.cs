                        ...
                        if (!String.IsNullOrEmpty(c.CommandText))
                        {
                            ...
                            if (c.EffentNextType == EffentNextType.WhenHaveContine || c.EffentNextType == EffentNextType.WhenNoHaveContine)
                            {
                                if (c.CommandText.ToLower().IndexOf("count(") == -1)
                                {
                                    ...
                                    {
                                        throw new Exception("Oracle:Contrary to requirements: " + c.CommandText + " Must comply with: select count(..Format");
                                    }
                                    //return false;
                                }
                                ...
                                if (c.EffentNextType == EffentNextType.WhenHaveContine && !isHave)
                                {
                                    ...
                                    {
                                        throw new Exception("Oracle:Contrary to requirements: " + c.CommandText + " Return value must be greater than 0");
                                    }
                                    //return false;
                                }
                                if (c.EffentNextType == EffentNextType.WhenNoHaveContine && isHave)
                                {
                                    ...
                                    {
                                        throw new Exception("Oracle:Contrary to requirements: " + c.CommandText + " The return value must equal 0");
                                    }
                                    //eturn false;
                                }
                                continue;
                            ...
                            if (c.EffentNextType == EffentNextType.ExcuteEffectRows && res == 0)
                            {
                                ...
                                {
                                    throw new Exception("Oracle:違背要求" + c.CommandText + "必須有影響行");
                                }
                                else
                                {
                                    throw new Exception("Oracle:Contrary to requirements: " + c.CommandText + " Must affect the line");
                                }
                                // return false;
                            }
                        }
