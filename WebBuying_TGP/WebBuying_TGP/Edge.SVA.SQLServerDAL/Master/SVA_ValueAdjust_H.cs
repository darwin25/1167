...
{
	/// <summary>
	/// 数据访问类:SVA_ValueAdjust_H
	/// </summary>
	public partial class SVA_ValueAdjust_H:ISVA_ValueAdjust_H
	{
		...
		public bool Exists(string Number)
		{
			...
			strSql.Append("select count(1) from SVA_ValueAdjust_H");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into SVA_ValueAdjust_H(");
			strSql.Append("Number,RefTxnNo,TxnDate,ShopID,ServerID,POSID,Note,Amount,TotalAmt,CardCount,Status,ApproveOn,ApproveBy,CreatedOn,CreatedBy,UpdatedOn,UpdatedBy)");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update SVA_ValueAdjust_H set ");
		...
		public bool Delete(string Number)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from SVA_ValueAdjust_H ");
			strSql.Append(" where Number=@Number ");
			SqlParameter[] parameters = {
					new SqlParameter("@Number", SqlDbType.VarChar,20)};
			parameters[0].Value = Number;
		...
		public Edge.SVA.Model.SVA_ValueAdjust_H GetModel(string Number)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Number,RefTxnNo,TxnDate,ShopID,ServerID,POSID,Note,Amount,TotalAmt,CardCount,Status,ApproveOn,ApproveBy,CreatedOn,CreatedBy,UpdatedOn,UpdatedBy from SVA_ValueAdjust_H ");
			strSql.Append(" where Number=@Number ");
			SqlParameter[] parameters = {
					new SqlParameter("@Number", SqlDbType.VarChar,20)};
			parameters[0].Value = Number;

			Edge.SVA.Model.SVA_ValueAdjust_H model=new Edge.SVA.Model.SVA_ValueAdjust_H();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Number,RefTxnNo,TxnDate,ShopID,ServerID,POSID,Note,Amount,TotalAmt,CardCount,Status,ApproveOn,ApproveBy,CreatedOn,CreatedBy,UpdatedOn,UpdatedBy ");
			strSql.Append(" FROM SVA_ValueAdjust_H ");
			if(strWhere.Trim()!="")
			{
        ...
        public DataSet GetList(int PageSize, int PageIndex, string strWhere, string filedOrder)
        {
			...
			parameters[0].Value = "SVA_ValueAdjust_H";
            parameters[1].Value = "*";
        ...
        public int GetCount(string strWhere)
        {
            ...
            sql.Append("select count(*) from SVA_ValueAdjust_H ");
