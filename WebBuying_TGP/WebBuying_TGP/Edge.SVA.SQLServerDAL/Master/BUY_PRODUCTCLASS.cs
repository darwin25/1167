...
{
	/// <summary>
	/// 数据访问类:BUY_PRODUCTCLASS
	/// </summary>
	public partial class BUY_PRODUCTCLASS:IBUY_PRODUCTCLASS
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ProdClassID", "BUY_PRODUCTCLASS"); 
		}
		...
		public bool Exists(string ProdClassCode,int ProdClassID)
		{
			...
			strSql.Append("select count(1) from BUY_PRODUCTCLASS");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Edge.SVA.Model.BUY_PRODUCTCLASS model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into BUY_PRODUCTCLASS(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Edge.SVA.Model.BUY_PRODUCTCLASS model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update BUY_PRODUCTCLASS set ");
		...
		public bool Delete(int ProdClassID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from BUY_PRODUCTCLASS ");
			strSql.Append(" where ProdClassID=@ProdClassID");
			SqlParameter[] parameters = {
					new SqlParameter("@ProdClassID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Edge.SVA.Model.BUY_PRODUCTCLASS GetModel(int ProdClassID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ProdClassID,ProdClassCode,ParentID,ProductSizeType,ProdClassDesc1,ProdClassDesc2,ProdClassDesc3,CreatedOn,CreatedBy,UpdatedOn,UpdatedBy from BUY_PRODUCTCLASS ");
			strSql.Append(" where ProdClassID=@ProdClassID");
			SqlParameter[] parameters = {
					new SqlParameter("@ProdClassID", SqlDbType.Int,4)
			};
			...
			Edge.SVA.Model.BUY_PRODUCTCLASS model=new Edge.SVA.Model.BUY_PRODUCTCLASS();
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM BUY_PRODUCTCLASS ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from BUY_PRODUCTCLASS T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "BUY_PRODUCTCLASS";
			parameters[1].Value = "ProdClassID";
