...
namespace Edge.SVA.SQLServerDAL
{
    ...
    /// </summary>
    public partial class Ord_ReturnOrder_D : IOrd_ReturnOrder_D
    {
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("Key", "Ord_ReturnOrder_D");
        }
        ...
        public bool Exists(int KeyID)
        {
            ...
            strSql.Append("select count(1) from Ord_ReturnOrder_D");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into Ord_ReturnOrder_D(");
            strSql.Append("ReturnOrderNumber,ProdCode,ReturnQty,Remark)");
            ...
            parameters[2].Value = model.ReturnQty;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update Ord_ReturnOrder_D set ");
            strSql.Append("ReturnOrderNumber=@ReturnOrderNumber,");
        ...
        public bool Delete(int KeyID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from Ord_ReturnOrder_D ");
            strSql.Append(" where KeyID=@KeyID");
            SqlParameter[] parameters = {
					new SqlParameter("@KeyID", SqlDbType.Int,4)
};
        ...
        public bool Delete(string ReturnOrderNumber)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from Ord_ReturnOrder_D ");
            strSql.Append(" where ReturnOrderNumber=@KeyID");
            SqlParameter[] parameters = {
        ...
        public Edge.SVA.Model.Ord_ReturnOrder_D GetModel(int KeyID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 KeyID,ReturnOrderNumber,ProdCode,ReturnQty,Remark from Ord_ReturnOrder_D ");
            strSql.Append(" where KeyID=@KeyID");
            SqlParameter[] parameters = {
					new SqlParameter("@KeyID", SqlDbType.Int,4)
};
            ...
            Edge.SVA.Model.Ord_ReturnOrder_D model = new Edge.SVA.Model.Ord_ReturnOrder_D();
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (ds.Tables[0].Rows[0]["ReturnQty"] != null && ds.Tables[0].Rows[0]["ReturnQty"].ToString() != "")
                {
                    model.ReturnQty = int.Parse(ds.Tables[0].Rows[0]["ReturnQty"].ToString());
                }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select KeyID,ReturnOrderNumber,ProdCode,ReturnQty,Remark ");
            strSql.Append(" FROM Ord_ReturnOrder_D ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" KeyID,ReturnOrderNumber,ProdCode,ReturnQty,Remark ");
            strSql.Append(" FROM Ord_ReturnOrder_D ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetList(int PageSize, int PageIndex, string strWhere, string filedOrder)
        {
            ...
            parameters[0].Value = "Ord_ReturnOrder_D";
            parameters[1].Value = "*";
        ...
        public int GetCount(string strWhere)
        {
            ...
            sql.Append("select count(*) from Ord_ReturnOrder_D ");
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from Ord_ReturnOrder_D T ");
            if (!string.IsNullOrEmpty(strWhere.Trim()))
            {
                strSql.Append(" WHERE " + strWhere);
            }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select sum(ReturnQty) as ReturnQty");
            strSql.Append(" FROM Ord_ReturnOrder_D ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
