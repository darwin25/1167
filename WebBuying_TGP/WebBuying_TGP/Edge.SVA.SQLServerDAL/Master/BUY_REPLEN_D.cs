...
namespace Edge.SVA.SQLServerDAL
{
    ...
    /// 创建时间：2016-07-13
	/// </summary>
	public partial class BUY_REPLEN_D:IBUY_REPLEN_D
	{
		public BUY_REPLEN_D()
		{}
		#region  Method
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("KeyID", "BUY_REPLEN_D"); 
		}
		...
		public bool Exists(int KeyID)
		{
			...
			strSql.Append("select count(1) from BUY_REPLEN_D");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into BUY_REPLEN_D(");
			strSql.Append("ReplenCode,EntityType,EntityCode,MinStockQty,RunningStockQty,OrderRoundUpQty)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@EntityCode", SqlDbType.VarChar,64),
			...
			parameters[1].Value = model.EntityType;
			parameters[2].Value = model.EntityCode;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update BUY_REPLEN_D set ");
			strSql.Append("ReplenCode=@ReplenCode,");
			strSql.Append("EntityType=@EntityType,");
			strSql.Append("EntityCode=@EntityCode,");
		...
		public bool Delete(int KeyID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from BUY_REPLEN_D ");
			strSql.Append(" where KeyID=@KeyID");
			SqlParameter[] parameters = {
					new SqlParameter("@KeyID", SqlDbType.Int,4)
			};
		...
		public Edge.SVA.Model.BUY_REPLEN_D GetModel(int KeyID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 KeyID,ReplenCode,EntityType,EntityCode,MinStockQty,RunningStockQty,OrderRoundUpQty from BUY_REPLEN_D ");
			strSql.Append(" where KeyID=@KeyID");
			SqlParameter[] parameters = {
					new SqlParameter("@KeyID", SqlDbType.Int,4)
			};
			...
			Edge.SVA.Model.BUY_REPLEN_D model=new Edge.SVA.Model.BUY_REPLEN_D();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["EntityCode"]!=null && ds.Tables[0].Rows[0]["EntityCode"].ToString()!="")
				{
					model.EntityCode=ds.Tables[0].Rows[0]["EntityCode"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select KeyID,ReplenCode,EntityType,EntityCode,MinStockQty,RunningStockQty,OrderRoundUpQty ");
			strSql.Append(" FROM BUY_REPLEN_D ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" KeyID,ReplenCode,EntityType,EntityCode,MinStockQty,RunningStockQty,OrderRoundUpQty ");
			strSql.Append(" FROM BUY_REPLEN_D ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from BUY_REPLEN_D T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "BUY_REPLEN_D";
