...
{
    /// <summary>
    /// 数据访问类:Ord_ShipmentOrder_H
    /// </summary>
    public partial class Ord_ShipmentOrder_H : IOrd_ShipmentOrder_H
    {
        public Ord_ShipmentOrder_H()
        { }
        #region  Method
        ...
        /// 是否存在该记录
        /// </summary>
        public bool Exists(string ShipmentOrderNumber)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from Ord_ShipmentOrder_H");
            strSql.Append(" where ShipmentOrderNumber=@ShipmentOrderNumber ");
        ...
        public bool Add(Edge.SVA.Model.Ord_ShipmentOrder_H model)
        {
            ...
            parameters[26].Value = model.DeliveryNumber;
            parameters[27].Value = model.LogisticsProviderID;
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Edge.SVA.Model.Ord_ShipmentOrder_H model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update Ord_ShipmentOrder_H set ");
            ...
            parameters[26].Value = model.LogisticsProviderID;
            parameters[27].Value = model.ShipmentOrderNumber;
        ...
        public bool Delete(string ShipmentOrderNumber)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from Ord_ShipmentOrder_H ");
            strSql.Append(" where ShipmentOrderNumber=@ShipmentOrderNumber ");
            SqlParameter[] parameters = {
					new SqlParameter("@ShipmentOrderNumber", SqlDbType.VarChar,64)};
            parameters[0].Value = ShipmentOrderNumber;
        ...
        /// 批量删除数据
        /// </summary>
        public bool DeleteList(string ShipmentOrderNumberlist)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from Ord_ShipmentOrder_H ");
            strSql.Append(" where ShipmentOrderNumber in (" + ShipmentOrderNumberlist + ")  ");
        ...
        /// 得到一个对象实体
        /// </summary>
        public Edge.SVA.Model.Ord_ShipmentOrder_H GetModel(string ShipmentOrderNumber)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ShipmentOrderNumber,OrderType,ReferenceNo,FromStoreID,FromContactName,");
            strSql.Append("FromContactPhone,FromMobile,FromEmail,FromAddress,StoreID,StoreContactName,StoreContactPhone,");
            strSql.Append("StoreContactEmail,StoreMobile,StoreAddress,Remark,CreatedBusDate,ApproveBusDate,ApprovalCode,");
            strSql.Append("ApproveStatus,ApproveOn,ApproveBy,CreatedOn,CreatedBy,UpdatedOn,UpdatedBy,DeliveryNumber,LogisticsProviderID ");
            strSql.Append(" from Ord_ShipmentOrder_H ");
            strSql.Append(" where ShipmentOrderNumber=@ShipmentOrderNumber ");
            SqlParameter[] parameters = {
					new SqlParameter("@ShipmentOrderNumber", SqlDbType.VarChar,64)};
            parameters[0].Value = ShipmentOrderNumber;

            Edge.SVA.Model.Ord_ShipmentOrder_H model = new Edge.SVA.Model.Ord_ShipmentOrder_H();
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  ShipmentOrderNumber,OrderType,ReferenceNo,FromStoreID,FromContactName,");
            strSql.Append("FromContactPhone,FromMobile,FromEmail,FromAddress,StoreID,StoreContactName,StoreContactPhone,");
            strSql.Append("StoreContactEmail,StoreMobile,StoreAddress,Remark,CreatedBusDate,ApproveBusDate,ApprovalCode,");
            strSql.Append("ApproveStatus,ApproveOn,ApproveBy,CreatedOn,CreatedBy,UpdatedOn,UpdatedBy,DeliveryNumber,LogisticsProviderID ");
            strSql.Append(" from Ord_ShipmentOrder_H ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" ShipmentOrderNumber,OrderType,ReferenceNo,FromStoreID,FromContactName,");
            strSql.Append("FromContactPhone,FromMobile,FromEmail,FromAddress,StoreID,StoreContactName,StoreContactPhone,");
            strSql.Append("StoreContactEmail,StoreMobile,StoreAddress,Remark,CreatedBusDate,ApproveBusDate,ApprovalCode,");
            strSql.Append("ApproveStatus,ApproveOn,ApproveBy,CreatedOn,CreatedBy,UpdatedOn,UpdatedBy,DeliveryNumber,LogisticsProviderID ");
            strSql.Append(" from Ord_ShipmentOrder_H ");
        ...
        public DataSet GetList(int PageSize, int PageIndex, string strWhere, string filedOrder)
        {
            ...
            parameters[0].Value = "Ord_ShipmentOrder_H";
            parameters[1].Value = "*";
        ...
        public int GetCount(string strWhere)
        {
            ...
            sql.Append("select count(*) from Ord_ShipmentOrder_H ");
        ...
        public DataSet GetListByParm(string strWhere, string filedOrder, string webSiteName)
        {
            ...
            strSql.Append("select Ord_ShipmentOrder_H.ShipmentOrderNumber,Ord_ShipmentOrder_H.OrderType,");
            strSql.Append("case Ord_ShipmentOrder_H.OrderType when 0 then'手动'else  '自动'end SimplifiedOrderTypeName,");
            strSql.Append("case Ord_ShipmentOrder_H.OrderType when 0 then '手動'else '手動'end as TraditionalOrderTypeName,");
            strSql.Append("case Ord_ShipmentOrder_H.OrderType when 0 then 'Manually'else 'Auto'end as EnglishOrderTypeName,");
            strSql.Append("ReferenceNo,FromStoreID,FromContactName,FromContactPhone,FromMobile, FromEmail,FromAddress,Ord_ShipmentOrder_H.StoreID,");
            strSql.Append("StoreContactName,StoreContactPhone,StoreContactEmail,StoreMobile,StoreAddress, Ord_ShipmentOrder_H.Remark,");
            ...
            strSql.Append("Convert(varchar(10),Ord_ShipmentOrder_H.ApproveOn,120)as ApproveOn,ApproveBy,u1.UserName as ApproveName,");
            strSql.Append("Convert(varchar(10),Ord_ShipmentOrder_H.CreatedOn,120)as CreatedOn,Ord_ShipmentOrder_H.CreatedBy,Accounts_Users.UserName as CreatedName,");
            strSql.Append("Convert(varchar(10),Ord_ShipmentOrder_H.UpdatedOn,120)as UpdatedOn,Ord_ShipmentOrder_H.UpdatedBy,u.UserName as UpdatedName,");
            strSql.Append("Ord_ShipmentOrder_D.ProdCode,Ord_ShipmentOrder_D.OrderQty,Ord_ShipmentOrder_D.ActualQty,");
            ...
            strSql.Append("from Ord_ShipmentOrder_H ");
            strSql.Append("left join Ord_ShipmentOrder_D on Ord_ShipmentOrder_H.ShipmentOrderNumber=Ord_ShipmentOrder_D.ShipmentOrderNumber ");
            strSql.Append("left join Accounts_Users on Ord_ShipmentOrder_H.CreatedBy=Accounts_Users.UserID ");
            strSql.Append("left join Accounts_Users as u  on Ord_ShipmentOrder_H.UpdatedBy=u.UserID ");
            strSql.Append("left join Accounts_Users as u1  on Ord_ShipmentOrder_H.ApproveBy=u1.UserID ");
            strSql.Append("left join BUY_PRODUCT on Ord_ShipmentOrder_D.ProdCode=BUY_PRODUCT.ProdCode ");
            strSql.Append("left join BUY_STORE on Ord_ShipmentOrder_H.StoreID=BUY_STORE.StoreID ");
            strSql.Append("left join BUY_STORE store1 on Ord_ShipmentOrder_H.FromStoreID=store1.StoreID ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from Ord_ShipmentOrder_H T ");
            if (!string.IsNullOrEmpty(strWhere.Trim()))
            {
                strSql.Append(" WHERE " + strWhere);
            }
