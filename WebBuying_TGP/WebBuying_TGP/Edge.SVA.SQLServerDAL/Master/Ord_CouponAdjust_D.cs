...
namespace Edge.SVA.SQLServerDAL
{
	...
	public partial class Ord_CouponAdjust_D:IOrd_CouponAdjust_D
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("KeyID", "Ord_CouponAdjust_D"); 
		}
		...
		public bool Exists(int KeyID)
		{
			...
			strSql.Append("select count(1) from Ord_CouponAdjust_D");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Edge.SVA.Model.Ord_CouponAdjust_D model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Edge.SVA.Model.Ord_CouponAdjust_D model)
		{
			StringBuilder strSql=new StringBuilder();
		...
		/// 得到一个对象实体
		/// </summary>
		public Edge.SVA.Model.Ord_CouponAdjust_D GetModel(int KeyID)
		{
			
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select  top 1 KeyID,CouponAdjustNumber,CouponNumber,CouponAmount from Ord_CouponAdjust_D ");
			strSql.Append(" where KeyID=@KeyID");
			SqlParameter[] parameters = {
					new SqlParameter("@KeyID", SqlDbType.Int,4)
};
		...
		{
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select KeyID,CouponAdjustNumber,CouponNumber,CouponAmount ");
			strSql.Append(" FROM Ord_CouponAdjust_D ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
            ...
            strSql.Append(" KeyID,CouponAdjustNumber,CouponNumber,CouponAmount ");
			strSql.Append(" FROM Ord_CouponAdjust_D ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
        ...
        public DataSet GetList(int PageSize, int PageIndex, string strWhere, string filedOrder)
        {
            ...
            parameters[0].Value = "Ord_CouponAdjust_D";
            parameters[1].Value = "*";
        ...
        public int GetCount(string strWhere)
        {
            ...
            sql.Append("select count(*) from Ord_CouponAdjust_D ");
