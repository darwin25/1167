...
namespace Edge.SVA.SQLServerDAL
{
	...
	/// 数据访问类:BUY_PO_D
	/// </summary>
	public partial class BUY_PO_D:IBUY_PO_D
	{
		public BUY_PO_D()
		{}
		#region  Method
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("KeyID", "BUY_PO_D"); 
		}
		...
		public bool Exists(int KeyID)
		{
			...
			strSql.Append("select count(1) from BUY_PO_D");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Edge.SVA.Model.BUY_PO_D model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into BUY_PO_D(");
			strSql.Append("POCode,ProdCode,Cost,AverageCost,UnitCost,Qty,FreeQty,GRNQty)");
			...
			parameters[3].Value = model.AverageCost;
			parameters[4].Value = model.UnitCost;
			parameters[5].Value = model.Qty;
			parameters[6].Value = model.FreeQty;
			parameters[7].Value = model.GRNQty;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Edge.SVA.Model.BUY_PO_D model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update BUY_PO_D set ");
		...
		public bool Delete(int KeyID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from BUY_PO_D ");
			strSql.Append(" where KeyID=@KeyID");
			SqlParameter[] parameters = {
					new SqlParameter("@KeyID", SqlDbType.Int,4)
			};
        ...
        public bool Delete(string POCode)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from BUY_PO_D ");
            strSql.Append(" where POCode=@KeyID");
            SqlParameter[] parameters = {
		...
		/// 得到一个对象实体
		/// </summary>
		public Edge.SVA.Model.BUY_PO_D GetModel(int KeyID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 KeyID,POCode,ProdCode,Cost,AverageCost,UnitCost,Qty,FreeQty,GRNQty from BUY_PO_D ");
			strSql.Append(" where KeyID=@KeyID");
			SqlParameter[] parameters = {
					new SqlParameter("@KeyID", SqlDbType.Int,4)
			};
			...
			Edge.SVA.Model.BUY_PO_D model=new Edge.SVA.Model.BUY_PO_D();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select KeyID,POCode,ProdCode,Cost,AverageCost,UnitCost,Qty,FreeQty,GRNQty ");
			strSql.Append(" FROM BUY_PO_D ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" KeyID,POCode,ProdCode,Cost,AverageCost,UnitCost,Qty,FreeQty,GRNQty ");
			strSql.Append(" FROM BUY_PO_D ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from BUY_PO_D T ");
