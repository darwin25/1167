...
{
    /// <summary>
    /// 数据访问类:BUY_PRODUCT_PIC_Pending
    /// 创建人：Lisa
    /// 创建时间：2016-08-08
    /// </summary>
    public partial class BUY_PRODUCT_PIC_Pending : IBUY_PRODUCT_PIC_Pending
    {
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("KeyID", "BUY_PRODUCT_PIC_Pending");
        }
        ...
        public bool Exists(int KeyID)
        {
            ...
            strSql.Append("select count(1) from BUY_PRODUCT_PIC_Pending");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into BUY_PRODUCT_PIC_Pending(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update BUY_PRODUCT_PIC_Pending set ");
        ...
        public bool Delete(int KeyID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from BUY_PRODUCT_PIC_Pending ");
            strSql.Append(" where KeyID=@KeyID");
            SqlParameter[] parameters = {
					new SqlParameter("@KeyID", SqlDbType.Int,4)
			};
        ...
        public Edge.SVA.Model.BUY_PRODUCT_PIC_Pending GetModel(int KeyID)
        {
            ...
            strSql.Append("ProductPicNote2,ProductPicNote3,IsVideo,Is360Pic,IsSizeCategory from BUY_PRODUCT_PIC_Pending ");
            strSql.Append(" where KeyID=@KeyID");
            SqlParameter[] parameters = {
					new SqlParameter("@KeyID", SqlDbType.Int,4)
			};
            ...
            Edge.SVA.Model.BUY_PRODUCT_PIC_Pending model = new Edge.SVA.Model.BUY_PRODUCT_PIC_Pending();
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from BUY_PRODUCT_PIC_Pending T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "BUY_PRODUCT_PIC_Pending";
