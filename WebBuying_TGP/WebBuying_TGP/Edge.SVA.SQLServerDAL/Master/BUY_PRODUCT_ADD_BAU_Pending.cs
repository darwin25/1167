...
{
    /// <summary>
    /// 数据访问类:BUY_PRODUCT_ADD_BAU_Pending
    /// 创建人：Lisa
    /// 创建时间：2016-08-08
    /// </summary>
    public partial class BUY_PRODUCT_ADD_BAU_Pending : IBUY_PRODUCT_ADD_BAU_Pending
    {
        ...
        public bool Exists(string ProdCode)
        {
            ...
            strSql.Append("select count(1) from BUY_PRODUCT_ADD_BAU_Pending");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into BUY_PRODUCT_ADD_BAU_Pending(");
        ...
        public bool Add(string prodCode)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into BUY_PRODUCT_ADD_BAU_Pending ");
            strSql.AppendFormat("select *from BUY_PRODUCT_ADD_BAU where ProdCode='{0}'", prodCode);
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update BUY_PRODUCT_ADD_BAU_Pending set ");
        ...
        public bool Delete(string ProdCode)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from BUY_PRODUCT_ADD_BAU_Pending ");
            strSql.Append(" where ProdCode=@ProdCode ");
            SqlParameter[] parameters = {
					new SqlParameter("@ProdCode", SqlDbType.VarChar,64)			};
            parameters[0].Value = ProdCode;
        ...
        public Edge.SVA.Model.BUY_PRODUCT_ADD_BAU_Pending GetModel(string ProdCode)
        {
            ...
            strSql.Append("DESIGNER,BUYER,MERCHANDISER,RETIRE_DATE,CompanyCode,Material,overview,style,fabric_care,SizeM1,SizeM2,");
            strSql.Append("SizeM3,SizeM4,SizeM5,SizeM6,SizeM7,SizeM8 ");
            strSql.Append("from BUY_PRODUCT_ADD_BAU_Pending");
            strSql.Append(" where ProdCode=@ProdCode ");
            SqlParameter[] parameters = {
					new SqlParameter("@ProdCode", SqlDbType.VarChar,64)			};
            parameters[0].Value = ProdCode;

            Edge.SVA.Model.BUY_PRODUCT_ADD_BAU_Pending model = new Edge.SVA.Model.BUY_PRODUCT_ADD_BAU_Pending();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Edge.SVA.Model.BUY_PRODUCT_ADD_BAU_Pending DataRowToModel(DataRow row)
        {
            Edge.SVA.Model.BUY_PRODUCT_ADD_BAU_Pending model = new Edge.SVA.Model.BUY_PRODUCT_ADD_BAU_Pending();
            if (row != null)
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from BUY_PRODUCT_ADD_BAU_Pending T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "BUY_PRODUCT_ADD_BAU_Pending";
