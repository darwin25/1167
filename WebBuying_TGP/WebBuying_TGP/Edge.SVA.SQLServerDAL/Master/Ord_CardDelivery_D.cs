...
{
	/// <summary>
	/// 数据访问类:Ord_CardDelivery_D
	/// </summary>
	public partial class Ord_CardDelivery_D:IOrd_CardDelivery_D
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("KeyID", "Ord_CardDelivery_D"); 
		}
		...
		public bool Exists(int KeyID)
		{
			...
			strSql.Append("select count(1) from Ord_CardDelivery_D");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Edge.SVA.Model.Ord_CardDelivery_D model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Ord_CardDelivery_D(");
			strSql.Append("CardDeliveryNumber,BrandID,CardTypeID,CardGradeID,Description,OrderQTY,PickQTY,ActualQTY,FirstCardNumber,EndCardNumber)");
			strSql.Append(" values (");
			strSql.Append("@CardDeliveryNumber,@BrandID,@CardTypeID,@CardGradeID,@Description,@OrderQTY,@PickQTY,@ActualQTY,@FirstCardNumber,@EndCardNumber)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("@CardDeliveryNumber", SqlDbType.VarChar,64),
			...
			parameters[0].Value = model.CardDeliveryNumber;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Edge.SVA.Model.Ord_CardDelivery_D model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Ord_CardDelivery_D set ");
			strSql.Append("CardDeliveryNumber=@CardDeliveryNumber,");
		...
		public bool Delete(int KeyID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Ord_CardDelivery_D ");
			strSql.Append(" where KeyID=@KeyID");
			SqlParameter[] parameters = {
					new SqlParameter("@KeyID", SqlDbType.Int,4)
};
		...
		/// 得到一个对象实体
		/// </summary>
		public Edge.SVA.Model.Ord_CardDelivery_D GetModel(int KeyID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 KeyID,CardDeliveryNumber,BrandID,CardTypeID,CardGradeID,Description,OrderQTY,PickQTY,ActualQTY,FirstCardNumber,EndCardNumber from Ord_CardDelivery_D ");
			strSql.Append(" where KeyID=@KeyID");
			SqlParameter[] parameters = {
					new SqlParameter("@KeyID", SqlDbType.Int,4)
};
			...
			Edge.SVA.Model.Ord_CardDelivery_D model=new Edge.SVA.Model.Ord_CardDelivery_D();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["CardDeliveryNumber"]!=null && ds.Tables[0].Rows[0]["CardDeliveryNumber"].ToString()!="")
				{
					model.CardDeliveryNumber=ds.Tables[0].Rows[0]["CardDeliveryNumber"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select KeyID,CardDeliveryNumber,BrandID,CardTypeID,CardGradeID,Description,OrderQTY,PickQTY,ActualQTY,FirstCardNumber,EndCardNumber ");
			strSql.Append(" FROM Ord_CardDelivery_D ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" KeyID,CardDeliveryNumber,BrandID,CardTypeID,CardGradeID,Description,OrderQTY,PickQTY,ActualQTY,FirstCardNumber,EndCardNumber ");
			strSql.Append(" FROM Ord_CardDelivery_D ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
        ...
        public DataSet GetList(int PageSize, int PageIndex, string strWhere, string filedOrder)
        {
            ...
            parameters[0].Value = "Ord_CardDelivery_D";
            parameters[1].Value = "*";
        ...
        public int GetCount(string strWhere)
        {
            ...
            sql.Append("select count(*) from Ord_CardDelivery_D ");
