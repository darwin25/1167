...
{
    /// <summary>
    /// 数据访问类:Promotion_Gift_PLU
    /// </summary>
    public partial class Promotion_Gift_PLU : IPromotion_Gift_PLU
    {
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("KeyID", "Promotion_Gift_PLU");
        }
        ...
        public bool Exists(int KeyID)
        {
            ...
            strSql.Append("select count(1) from Promotion_Gift_PLU");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into Promotion_Gift_PLU(");
            strSql.Append("PromotionCode,GiftSeq,EntityNum,EntityType)");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update Promotion_Gift_PLU set ");
            strSql.Append("PromotionCode=@PromotionCode,");
            strSql.Append("GiftSeq=@GiftSeq,");
        ...
        public bool Delete(int KeyID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from Promotion_Gift_PLU ");
            strSql.Append(" where KeyID=@KeyID");
            SqlParameter[] parameters = {
					new SqlParameter("@KeyID", SqlDbType.Int,4)
			};
        ...
        public bool DeleteGif(int GiftSeq)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from Promotion_Gift_PLU ");
            strSql.Append(" where GiftSeq=@GiftSeq");
            SqlParameter[] parameters = {
					new SqlParameter("@GiftSeq", SqlDbType.Int,4)
			};
            parameters[0].Value = GiftSeq;
        ...
        public Edge.SVA.Model.Promotion_Gift_PLU GetModel(int KeyID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 KeyID,PromotionCode,GiftSeq,EntityNum,EntityType from Promotion_Gift_PLU ");
            strSql.Append(" where KeyID=@KeyID");
            SqlParameter[] parameters = {
					new SqlParameter("@KeyID", SqlDbType.Int,4)
			};
            ...
            Edge.SVA.Model.Promotion_Gift_PLU model = new Edge.SVA.Model.Promotion_Gift_PLU();
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select KeyID,PromotionCode,GiftSeq,EntityNum,EntityType ");
            strSql.Append(" FROM Promotion_Gift_PLU ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" KeyID,PromotionCode,GiftSeq,EntityNum,EntityType ");
            strSql.Append(" FROM Promotion_Gift_PLU ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from Promotion_Gift_PLU T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "Promotion_Gift_PLU";
