...
namespace Edge.SVA.SQLServerDAL
{
	...
	/// 数据访问类:BUY_RPRICE_H
	/// </summary>
	public partial class BUY_RPRICE_H:IBUY_RPRICE_H
	{
		public BUY_RPRICE_H()
		{}
		#region  Method
		...
		public bool Exists(string RPriceCode)
		{
			...
			strSql.Append("select count(1) from BUY_RPRICE_H");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into BUY_RPRICE_H(");
			strSql.Append("RPriceCode,StoreCode,StoreGroupCode,StartDate,EndDate,CurrencyCode,Note,CreatedBusDate,ApproveBusDate,ApprovalCode,ApproveStatus,ApproveOn,ApproveBy,CreatedOn,CreatedBy,UpdatedOn,UpdatedBy)");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update BUY_RPRICE_H set ");
			...
			parameters[16].Value = model.RPriceCode;
		...
		public bool Delete(string RPriceCode)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from BUY_RPRICE_H ");
			strSql.Append(" where RPriceCode=@RPriceCode ");
			SqlParameter[] parameters = {
					new SqlParameter("@RPriceCode", SqlDbType.VarChar,64)			};
			parameters[0].Value = RPriceCode;
		...
		public bool DeleteList(string RPriceCodelist )
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from BUY_RPRICE_H ");
			strSql.Append(" where RPriceCode in ("+RPriceCodelist + ")  ");
		...
		public Edge.SVA.Model.BUY_RPRICE_H GetModel(string RPriceCode)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 RPriceCode,StoreCode,StoreGroupCode,StartDate,EndDate,CurrencyCode,Note,CreatedBusDate,ApproveBusDate,ApprovalCode,ApproveStatus,ApproveOn,ApproveBy,CreatedOn,CreatedBy,UpdatedOn,UpdatedBy from BUY_RPRICE_H ");
			strSql.Append(" where RPriceCode=@RPriceCode ");
			SqlParameter[] parameters = {
					new SqlParameter("@RPriceCode", SqlDbType.VarChar,64)			};
			parameters[0].Value = RPriceCode;

			Edge.SVA.Model.BUY_RPRICE_H model=new Edge.SVA.Model.BUY_RPRICE_H();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select RPriceCode,StoreCode,StoreGroupCode,StartDate,EndDate,CurrencyCode,Note,CreatedBusDate,ApproveBusDate,ApprovalCode,ApproveStatus,ApproveOn,ApproveBy,CreatedOn,CreatedBy,UpdatedOn,UpdatedBy ");
			strSql.Append(" FROM BUY_RPRICE_H ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			{
				strSql.Append("order by T.RPriceCode desc");
			}
			strSql.Append(")AS Row, T.*  from BUY_RPRICE_H T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "BUY_RPRICE_H";
			parameters[1].Value = "RPriceCode";
