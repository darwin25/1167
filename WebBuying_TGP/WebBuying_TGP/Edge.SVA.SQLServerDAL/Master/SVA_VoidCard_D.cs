...
{
	/// <summary>
	/// 数据访问类:SVA_VoidCard_D
	/// </summary>
	public partial class SVA_VoidCard_D:ISVA_VoidCard_D
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("SeqNo", "SVA_VoidCard_D"); 
		}
		...
		public bool Exists(string Number,int SeqNo)
		{
			...
			strSql.Append("select count(1) from SVA_VoidCard_D");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into SVA_VoidCard_D(");
			strSql.Append("Number,SeqNo,UID,CardNo,CardTypeID,CardGradID,Remark)");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update SVA_VoidCard_D set ");
		...
		public bool Delete(string Number,int SeqNo)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from SVA_VoidCard_D ");
			strSql.Append(" where Number=@Number and SeqNo=@SeqNo ");
			SqlParameter[] parameters = {
					new SqlParameter("@Number", SqlDbType.VarChar,20),
					new SqlParameter("@SeqNo", SqlDbType.Int,4)};
		...
		public Edge.SVA.Model.SVA_VoidCard_D GetModel(string Number,int SeqNo)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Number,SeqNo,UID,CardNo,CardTypeID,CardGradID,Remark from SVA_VoidCard_D ");
			strSql.Append(" where Number=@Number and SeqNo=@SeqNo ");
			SqlParameter[] parameters = {
					new SqlParameter("@Number", SqlDbType.VarChar,20),
					new SqlParameter("@SeqNo", SqlDbType.Int,4)};
			...
			Edge.SVA.Model.SVA_VoidCard_D model=new Edge.SVA.Model.SVA_VoidCard_D();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Number,SeqNo,UID,CardNo,CardTypeID,CardGradID,Remark ");
			strSql.Append(" FROM SVA_VoidCard_D ");
			if(strWhere.Trim()!="")
			{
        ...
        public DataSet GetList(int PageSize, int PageIndex, string strWhere, string filedOrder)
        {
			...
			parameters[0].Value = "SVA_VoidCard_D";
            parameters[1].Value = "*";
        ...
        public int GetCount(string strWhere)
        {
            ...
            sql.Append("select count(*) from SVA_VoidCard_D ");
