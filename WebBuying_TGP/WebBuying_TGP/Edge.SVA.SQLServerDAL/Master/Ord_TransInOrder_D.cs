...
{
    /// <summary>
    /// 数据访问类:Ord_TransInOrder_D
    /// </summary>
    public partial class Ord_TransInOrder_D : IOrd_TransInOrder_D
    {
        ...
        public int GetMaxId()
        {
            return DbHelperSQL.GetMaxID("Key", "Ord_TransInOrder_D");
        }
        ...
        public bool Exists(int KeyID)
        {
            ...
            strSql.Append("select count(1) from Ord_TransInOrder_D");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into Ord_TransInOrder_D(");
            strSql.Append("TransInOrderNumber,ProdCode,TransInQty,ReasonID,Remark)");
            ...
            SqlParameter[] parameters = {
					...
					new SqlParameter("@TransInQty", SqlDbType.Int,4),
            ...
            parameters[2].Value = model.TransInQty;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update Ord_TransInOrder_D set ");
            strSql.Append("TransInOrderNumber=@TransInOrderNumber,");
            strSql.Append("ProdCode=@ProdCode,");
            strSql.Append("TransInQty=@TransInQty,");
        ...
        public bool Delete(int KeyID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from Ord_TransInOrder_D ");
            strSql.Append(" where KeyID=@KeyID");
            SqlParameter[] parameters = {
					new SqlParameter("@KeyID", SqlDbType.Int,4)
};
        ...
        public bool Delete(string TransInOrderNumber)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from Ord_TransInOrder_D ");
            strSql.Append(" where TransInOrderNumber=@KeyID");
            SqlParameter[] parameters = {
        ...
        public Edge.SVA.Model.Ord_TransInOrder_D GetModel(int KeyID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 KeyID,TransInOrderNumber,ProdCode,TransInQty,ReasonID,Remark from Ord_TransInOrder_D ");
            strSql.Append(" where KeyID=@KeyID");
            SqlParameter[] parameters = {
					new SqlParameter("@KeyID", SqlDbType.Int,4)
};
            ...
            Edge.SVA.Model.Ord_TransInOrder_D model = new Edge.SVA.Model.Ord_TransInOrder_D();
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (ds.Tables[0].Rows[0]["TransInQty"] != null && ds.Tables[0].Rows[0]["TransInQty"].ToString() != "")
                {
                    model.TransInQty = int.Parse(ds.Tables[0].Rows[0]["TransInQty"].ToString());
                }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select KeyID,TransInOrderNumber,ProdCode,TransInQty,ReasonID,Remark ");
            strSql.Append(" FROM Ord_TransInOrder_D ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" KeyID,TransInOrderNumber,ProdCode,TransInQty,ReasonID,Remark ");
            strSql.Append(" FROM Ord_TransInOrder_D ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetList(int PageSize, int PageIndex, string strWhere, string filedOrder)
        {
            ...
            parameters[0].Value = "Ord_TransInOrder_D";
            parameters[1].Value = "*";
        ...
        public int GetCount(string strWhere)
        {
            ...
            sql.Append("select count(*) from Ord_TransInOrder_D ");
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from Ord_TransInOrder_D T ");
            if (!string.IsNullOrEmpty(strWhere.Trim()))
            {
                strSql.Append(" WHERE " + strWhere);
            }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select sum(TransInQty) as TransInQty");
            strSql.Append(" FROM Ord_TransInOrder_D ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
