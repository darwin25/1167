...
{
	/// <summary>
	/// 数据访问类:Ord_CouponPicking_H
	/// </summary>
	public partial class Ord_CouponPicking_H:IOrd_CouponPicking_H
	{
		...
		/// 是否存在该记录
		/// </summary>
		public bool Exists(string CouponPickingNumber)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from Ord_CouponPicking_H");
			strSql.Append(" where CouponPickingNumber=@CouponPickingNumber ");
			SqlParameter[] parameters = {
					new SqlParameter("@CouponPickingNumber", SqlDbType.VarChar,64)};
			parameters[0].Value = CouponPickingNumber;
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Edge.SVA.Model.Ord_CouponPicking_H model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Ord_CouponPicking_H(");
			strSql.Append("CouponPickingNumber,ReferenceNo,StoreID,CustomerID,Remark,CreatedBusDate,ApproveBusDate,ApprovalCode,ApproveStatus,ApproveOn,ApproveBy,CreatedOn,CreatedBy,UpdatedOn,UpdatedBy)");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Edge.SVA.Model.Ord_CouponPicking_H model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Ord_CouponPicking_H set ");
			...
			parameters[14].Value = model.CouponPickingNumber;
		...
		/// 删除一条数据
		/// </summary>
		public bool Delete(string CouponPickingNumber)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Ord_CouponPicking_H ");
			strSql.Append(" where CouponPickingNumber=@CouponPickingNumber ");
			SqlParameter[] parameters = {
					new SqlParameter("@CouponPickingNumber", SqlDbType.VarChar,64)};
			parameters[0].Value = CouponPickingNumber;
		...
		/// 批量删除数据
		/// </summary>
		public bool DeleteList(string CouponPickingNumberlist )
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Ord_CouponPicking_H ");
			strSql.Append(" where CouponPickingNumber in ("+CouponPickingNumberlist + ")  ");
		...
		/// 得到一个对象实体
		/// </summary>
		public Edge.SVA.Model.Ord_CouponPicking_H GetModel(string CouponPickingNumber)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 CouponPickingNumber,ReferenceNo,StoreID,CustomerID,Remark,CreatedBusDate,ApproveBusDate,ApprovalCode,ApproveStatus,ApproveOn,ApproveBy,CreatedOn,CreatedBy,UpdatedOn,UpdatedBy from Ord_CouponPicking_H ");
			strSql.Append(" where CouponPickingNumber=@CouponPickingNumber ");
			SqlParameter[] parameters = {
					new SqlParameter("@CouponPickingNumber", SqlDbType.VarChar,64)};
			parameters[0].Value = CouponPickingNumber;

			Edge.SVA.Model.Ord_CouponPicking_H model=new Edge.SVA.Model.Ord_CouponPicking_H();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select CouponPickingNumber,ReferenceNo,StoreID,CustomerID,Remark,CreatedBusDate,ApproveBusDate,ApprovalCode,ApproveStatus,ApproveOn,ApproveBy,CreatedOn,CreatedBy,UpdatedOn,UpdatedBy ");
			strSql.Append(" FROM Ord_CouponPicking_H ");
			if(strWhere.Trim()!="")
			{
        ...
        public DataSet GetList(int PageSize, int PageIndex, string strWhere, string filedOrder)
        {
            ...
            parameters[0].Value = "Ord_CouponPicking_H";
            parameters[1].Value = "*";
        ...
        public int GetCount(string strWhere)
        {
            ...
            sql.Append("select count(*) from Ord_CouponPicking_H ");
