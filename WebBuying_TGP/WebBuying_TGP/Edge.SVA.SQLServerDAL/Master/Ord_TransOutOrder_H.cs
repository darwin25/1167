...
{
    /// <summary>
    /// 数据访问类:Ord_TransOutOrder_H
    /// </summary>
    public partial class Ord_TransOutOrder_H : IOrd_TransOutOrder_H
    {
        ...
        /// 是否存在该记录
        /// </summary>
        public bool Exists(string TransOutOrderNumber)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from Ord_TransOutOrder_H");
            strSql.Append(" where TransOutOrderNumber=@TransOutOrderNumber ");
        ...
        /// 增加一条数据
        /// </summary>
        public bool Add(Edge.SVA.Model.Ord_TransOutOrder_H model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into Ord_TransOutOrder_H(");
            strSql.Append("TransOutOrderNumber,ReferenceNo,FromStoreID,FromContactName,FromContactPhone,FromMobile,FromEmail,FromAddress,StoreID,StoreContactName,StoreContactPhone,StoreContactEmail,StoreMobile,StoreAddress,Remark,CreatedBusDate,ApproveBusDate,ApprovalCode,ApproveStatus,ApproveOn,ApproveBy,CreatedOn,CreatedBy,UpdatedOn,UpdatedBy)");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Edge.SVA.Model.Ord_TransOutOrder_H model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update Ord_TransOutOrder_H set ");
            ...
            parameters[24].Value = model.TransOutOrderNumber;
        ...
        public bool Delete(string TransOutOrderNumber)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from Ord_TransOutOrder_H ");
            strSql.Append(" where TransOutOrderNumber=@TransOutOrderNumber ");
            SqlParameter[] parameters = {
					new SqlParameter("@TransOutOrderNumber", SqlDbType.VarChar,64)};
            parameters[0].Value = TransOutOrderNumber;
        ...
        /// 批量删除数据
        /// </summary>
        public bool DeleteList(string TransOutOrderNumberlist)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from Ord_TransOutOrder_H ");
            strSql.Append(" where TransOutOrderNumber in (" + TransOutOrderNumberlist + ")  ");
        ...
        /// 得到一个对象实体
        /// </summary>
        public Edge.SVA.Model.Ord_TransOutOrder_H GetModel(string TransOutOrderNumber)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 TransOutOrderNumber,ReferenceNo,FromStoreID,FromContactName,FromContactPhone,FromMobile,FromEmail,FromAddress,StoreID,StoreContactName,StoreContactPhone,StoreContactEmail,StoreMobile,StoreAddress,Remark,CreatedBusDate,ApproveBusDate,ApprovalCode,ApproveStatus,ApproveOn,ApproveBy,CreatedOn,CreatedBy,UpdatedOn,UpdatedBy from Ord_TransOutOrder_H ");
            strSql.Append(" where TransOutOrderNumber=@TransOutOrderNumber ");
            SqlParameter[] parameters = {
					new SqlParameter("@TransOutOrderNumber", SqlDbType.VarChar,64)			};
            parameters[0].Value = TransOutOrderNumber;

            Edge.SVA.Model.Ord_TransOutOrder_H model = new Edge.SVA.Model.Ord_TransOutOrder_H();
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select TransOutOrderNumber , ReferenceNo , FromStoreID , FromContactName , FromContactPhone , FromMobile , FromEmail , FromAddress , StoreID , StoreContactName , StoreContactPhone , StoreContactEmail , StoreMobile , StoreAddress  , Remark , CreatedBusDate , ApproveBusDate , ApprovalCode , ApproveStatus , ApproveOn , ApproveBy , CreatedOn , CreatedBy , UpdatedOn , UpdatedBy ");
            strSql.Append(" FROM Ord_TransOutOrder_H ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByParm(string strWhere, string filedOrder, string webSiteName)
        {
            ...
            strSql.Append("select Ord_TransOutOrder_H.TransOutOrderNumber,");
            strSql.Append("ReferenceNo,FromStoreID,FromContactName,FromContactPhone,FromMobile, ");
            strSql.Append("FromEmail,FromAddress,Ord_TransOutOrder_H.StoreID,StoreContactName,");
            strSql.Append("StoreContactPhone,StoreContactEmail,StoreMobile,StoreAddress, ");
            strSql.Append("Ord_TransOutOrder_H.Remark,Convert(varchar(10),CreatedBusDate,120)as CreatedBusDate ,");
            ...
            strSql.Append("Convert(varchar(10),Ord_TransOutOrder_H.ApproveOn,120)as ApproveOn,ApproveBy,u1.UserName as ApproveName,");
            strSql.Append("Convert(varchar(10),Ord_TransOutOrder_H.CreatedOn,120)as CreatedOn,Ord_TransOutOrder_H.CreatedBy,");
            strSql.Append("Accounts_Users.UserName as CreatedName,Convert(varchar(10),Ord_TransOutOrder_H.UpdatedOn,120)as UpdatedOn,");
            strSql.Append("Ord_TransOutOrder_H.UpdatedBy,u.UserName as UpdatedName,Ord_TransOutOrder_D.ProdCode,Ord_TransOutOrder_D.TransOutQty,");
            ...
            strSql.Append(" Ord_TransOutOrder_D.ReasonID ");
            strSql.Append("from Ord_TransOutOrder_H ");
            strSql.Append("left join Ord_TransOutOrder_D on Ord_TransOutOrder_H.TransOutOrderNumber=Ord_TransOutOrder_D.TransOutOrderNumber ");
            strSql.Append("left join Accounts_Users on Ord_TransOutOrder_H.CreatedBy=Accounts_Users.UserID ");
            strSql.Append("left join Accounts_Users as u  on Ord_TransOutOrder_H.UpdatedBy=u.UserID ");
            strSql.Append("left join Accounts_Users as u1  on Ord_TransOutOrder_H.ApproveBy=u1.UserID ");
            strSql.Append("left join BUY_PRODUCT on Ord_TransOutOrder_D.ProdCode=BUY_PRODUCT.ProdCode ");
            strSql.Append("left join BUY_STORE on Ord_TransOutOrder_H.StoreID=BUY_STORE.StoreID ");
            strSql.Append("left join BUY_STORE store1 on Ord_TransOutOrder_H.FromStoreID=store1.StoreID ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        public DataSet GetList(int PageSize, int PageIndex, string strWhere, string filedOrder)
        {
            ...
            parameters[0].Value = "Ord_TransOutOrder_H";
            parameters[1].Value = "*";
        ...
        public int GetCount(string strWhere)
        {
            ...
            sql.Append("select count(*) from Ord_TransOutOrder_H ");
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from Ord_TransOutOrder_H T ");
            if (!string.IsNullOrEmpty(strWhere.Trim()))
            {
                strSql.Append(" WHERE " + strWhere);
            }
