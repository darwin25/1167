...
{
    /// <summary>
    /// 数据访问类:Ord_PickingOrder_H
    /// </summary>
    public partial class Ord_PickingOrder_H : IOrd_PickingOrder_H
    {
        public Ord_PickingOrder_H()
        { }
        #region  Method
        ...
        /// 是否存在该记录
        /// </summary>
        public bool Exists(string PickingOrderNumber)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from Ord_PickingOrder_H");
            strSql.Append(" where PickingOrderNumber=@PickingOrderNumber ");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Edge.SVA.Model.Ord_PickingOrder_H model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update Ord_PickingOrder_H set ");
            ...
            parameters[25].Value = model.PickingOrderNumber;
        ...
        public bool Delete(string PickingOrderNumber)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from Ord_PickingOrder_H ");
            strSql.Append(" where PickingOrderNumber=@PickingOrderNumber ");
            SqlParameter[] parameters = {
					new SqlParameter("@PickingOrderNumber", SqlDbType.VarChar,64)};
            parameters[0].Value = PickingOrderNumber;
        ...
        /// 批量删除数据
        /// </summary>
        public bool DeleteList(string PickingOrderNumberlist)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from Ord_PickingOrder_H ");
            strSql.Append(" where PickingOrderNumber in (" + PickingOrderNumberlist + ")  ");
        ...
        /// 得到一个对象实体
        /// </summary>
        public Edge.SVA.Model.Ord_PickingOrder_H GetModel(string PickingOrderNumber)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 PickingOrderNumber,OrderType,ReferenceNo,FromStoreID,FromContactName,FromContactPhone,FromMobile,FromEmail,FromAddress,StoreID,StoreContactName,StoreContactPhone,StoreContactEmail,StoreMobile,StoreAddress,Remark,CreatedBusDate,ApproveBusDate,ApprovalCode,ApproveStatus,ApproveOn,ApproveBy,CreatedOn,CreatedBy,UpdatedOn,UpdatedBy from Ord_PickingOrder_H ");
            strSql.Append(" where PickingOrderNumber=@PickingOrderNumber ");
            SqlParameter[] parameters = {
					new SqlParameter("@PickingOrderNumber", SqlDbType.VarChar,64)			};
            parameters[0].Value = PickingOrderNumber;

            Edge.SVA.Model.Ord_PickingOrder_H model = new Edge.SVA.Model.Ord_PickingOrder_H();
        ...
        public DataSet GetListByParm(string strWhere, string filedOrder, string webSiteName)
        {
            ...
            strSql.Append("select Ord_PickingOrder_H.PickingOrderNumber,Ord_PickingOrder_H.OrderType,");
            strSql.Append("case Ord_PickingOrder_H.OrderType when 0 then'手动'else  '自动'end SimplifiedOrderTypeName,");
            strSql.Append("case Ord_PickingOrder_H.OrderType when 0 then '手動'else '手動'end as TraditionalOrderTypeName,");
            strSql.Append("case Ord_PickingOrder_H.OrderType when 0 then 'Manually'else 'Auto'end as EnglishOrderTypeName,");
            strSql.Append("ReferenceNo,FromStoreID,FromContactName,FromContactPhone,FromMobile, FromEmail,FromAddress,Ord_PickingOrder_H.StoreID,");
            strSql.Append("StoreContactName,StoreContactPhone,StoreContactEmail,StoreMobile,StoreAddress, Ord_PickingOrder_H.Remark,");
            ...
            strSql.Append("Convert(varchar(10),Ord_PickingOrder_H.ApproveOn,120)as ApproveOn,ApproveBy,u1.UserName as ApproveName,");
            strSql.Append("Convert(varchar(10),Ord_PickingOrder_H.CreatedOn,120)as CreatedOn,Ord_PickingOrder_H.CreatedBy,Accounts_Users.UserName as CreatedName,");
            strSql.Append("Convert(varchar(10),Ord_PickingOrder_H.UpdatedOn,120)as UpdatedOn,Ord_PickingOrder_H.UpdatedBy,u.UserName as UpdatedName,");
            strSql.Append("Ord_PickingOrder_D.ProdCode,Ord_PickingOrder_D.OrderQty,Ord_PickingOrder_D.ActualQty,");
            ...
            strSql.Append("from Ord_PickingOrder_H ");
            strSql.Append("left join Ord_PickingOrder_D on Ord_PickingOrder_H.PickingOrderNumber=Ord_PickingOrder_D.PickingOrderNumber ");
            strSql.Append("left join Accounts_Users on Ord_PickingOrder_H.CreatedBy=Accounts_Users.UserID ");
            strSql.Append("left join Accounts_Users as u  on Ord_PickingOrder_H.UpdatedBy=u.UserID ");
            strSql.Append("left join Accounts_Users as u1  on Ord_PickingOrder_H.ApproveBy=u1.UserID ");
            strSql.Append("left join BUY_PRODUCT on Ord_PickingOrder_D.ProdCode=BUY_PRODUCT.ProdCode ");
            strSql.Append("left join BUY_STORE on Ord_PickingOrder_H.StoreID=BUY_STORE.StoreID ");
            strSql.Append("left join BUY_STORE store1 on Ord_PickingOrder_H.FromStoreID=store1.StoreID ");
            if (strWhere.Trim() != "")
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select PickingOrderNumber , OrderType , ReferenceNo , FromStoreID , FromContactName , FromContactPhone , FromMobile , FromEmail , FromAddress , StoreID , StoreContactName , StoreContactPhone , StoreContactEmail , StoreMobile , StoreAddress  , Remark , CreatedBusDate , ApproveBusDate , ApprovalCode , ApproveStatus , ApproveOn , ApproveBy , CreatedOn , CreatedBy , UpdatedOn , UpdatedBy ");
            strSql.Append(" FROM Ord_PickingOrder_H ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetList(int PageSize, int PageIndex, string strWhere, string filedOrder)
        {
            ...
            parameters[0].Value = "Ord_PickingOrder_H";
            parameters[1].Value = "*";
        ...
        public int GetCount(string strWhere)
        {
            ...
            sql.Append("select count(*) from Ord_PickingOrder_H ");
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from Ord_PickingOrder_H T ");
            if (!string.IsNullOrEmpty(strWhere.Trim()))
            {
                strSql.Append(" WHERE " + strWhere);
            }
