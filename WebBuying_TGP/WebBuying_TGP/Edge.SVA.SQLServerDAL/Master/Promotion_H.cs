...
namespace Edge.SVA.SQLServerDAL
{
	...
	/// 数据访问类:Promotion_H
	/// </summary>
	public partial class Promotion_H:IPromotion_H
	{
		public Promotion_H()
		{}
		#region  Method
		...
		public bool Exists(string PromotionCode)
		{
			...
			strSql.Append("select count(1) from Promotion_H");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Promotion_H(");
			strSql.Append("PromotionCode,PromotionDesc1,PromotionDesc2,PromotionDesc3,PromotionNote,StoreID,StoreGroupID,StartDate,EndDate,StartTime,EndTime,DayFlagCode,WeekFlagCode,MonthFlagCode,LoyaltyFlag,CreatedBusDate,ApproveBusDate,ApprovalCode,ApproveStatus,ApproveOn,ApproveBy,CreatedOn,CreatedBy,UpdatedOn,UpdatedBy)");
			strSql.Append(" values (");
			strSql.Append("@PromotionCode,@PromotionDesc1,@PromotionDesc2,@PromotionDesc3,@PromotionNote,@StoreID,@StoreGroupID,@StartDate,@EndDate,@StartTime,@EndTime,@DayFlagCode,@WeekFlagCode,@MonthFlagCode,@LoyaltyFlag,@CreatedBusDate,@ApproveBusDate,@ApprovalCode,@ApproveStatus,@ApproveOn,@ApproveBy,@CreatedOn,@CreatedBy,@UpdatedOn,@UpdatedBy)");
			SqlParameter[] parameters = {
					new SqlParameter("@PromotionCode", SqlDbType.VarChar,64),
					new SqlParameter("@PromotionDesc1", SqlDbType.VarChar,512),
					new SqlParameter("@PromotionDesc2", SqlDbType.VarChar,512),
					new SqlParameter("@PromotionDesc3", SqlDbType.VarChar,512),
					new SqlParameter("@PromotionNote", SqlDbType.VarChar,512),
			...
			parameters[1].Value = model.PromotionDesc1;
			parameters[2].Value = model.PromotionDesc2;
			parameters[3].Value = model.PromotionDesc3;
			parameters[4].Value = model.PromotionNote;
			parameters[5].Value = model.StoreID;
			parameters[6].Value = model.StoreGroupID;
			...
			parameters[14].Value = model.LoyaltyFlag;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Promotion_H set ");
			strSql.Append("PromotionDesc1=@PromotionDesc1,");
			strSql.Append("PromotionDesc2=@PromotionDesc2,");
			strSql.Append("PromotionDesc3=@PromotionDesc3,");
			strSql.Append("PromotionNote=@PromotionNote,");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@UpdatedBy", SqlDbType.Int,4),
					new SqlParameter("@PromotionCode", SqlDbType.VarChar,64)};
			parameters[0].Value = model.PromotionDesc1;
			parameters[1].Value = model.PromotionDesc2;
			parameters[2].Value = model.PromotionDesc3;
			parameters[3].Value = model.PromotionNote;
			...
			parameters[13].Value = model.LoyaltyFlag;
			...
			parameters[24].Value = model.PromotionCode;
		...
		public bool Delete(string PromotionCode)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Promotion_H ");
			strSql.Append(" where PromotionCode=@PromotionCode ");
			SqlParameter[] parameters = {
					new SqlParameter("@PromotionCode", SqlDbType.VarChar,64)			};
			parameters[0].Value = PromotionCode;
		...
		public Edge.SVA.Model.Promotion_H GetModel(string PromotionCode)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 PromotionCode,PromotionDesc1,PromotionDesc2,PromotionDesc3,PromotionNote,StoreID,StoreGroupID,StartDate,EndDate,StartTime,EndTime,DayFlagCode,WeekFlagCode,MonthFlagCode,LoyaltyFlag,CreatedBusDate,ApproveBusDate,ApprovalCode,ApproveStatus,ApproveOn,ApproveBy,CreatedOn,CreatedBy,UpdatedOn,UpdatedBy from Promotion_H ");
			strSql.Append(" where PromotionCode=@PromotionCode ");
			SqlParameter[] parameters = {
					new SqlParameter("@PromotionCode", SqlDbType.VarChar,64)			};
			parameters[0].Value = PromotionCode;

			Edge.SVA.Model.Promotion_H model=new Edge.SVA.Model.Promotion_H();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["PromotionDesc1"]!=null && ds.Tables[0].Rows[0]["PromotionDesc1"].ToString()!="")
				{
					model.PromotionDesc1=ds.Tables[0].Rows[0]["PromotionDesc1"].ToString();
				}
				if(ds.Tables[0].Rows[0]["PromotionDesc2"]!=null && ds.Tables[0].Rows[0]["PromotionDesc2"].ToString()!="")
				{
					model.PromotionDesc2=ds.Tables[0].Rows[0]["PromotionDesc2"].ToString();
				}
				if(ds.Tables[0].Rows[0]["PromotionDesc3"]!=null && ds.Tables[0].Rows[0]["PromotionDesc3"].ToString()!="")
				{
					model.PromotionDesc3=ds.Tables[0].Rows[0]["PromotionDesc3"].ToString();
				}
				if(ds.Tables[0].Rows[0]["PromotionNote"]!=null && ds.Tables[0].Rows[0]["PromotionNote"].ToString()!="")
				{
					model.PromotionNote=ds.Tables[0].Rows[0]["PromotionNote"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select PromotionCode,PromotionDesc1,PromotionDesc2,PromotionDesc3,PromotionNote,StoreID,StoreGroupID,StartDate,EndDate,StartTime,EndTime,DayFlagCode,WeekFlagCode,MonthFlagCode,LoyaltyFlag,CreatedBusDate,ApproveBusDate,ApprovalCode,ApproveStatus,ApproveOn,ApproveBy,CreatedOn,CreatedBy,UpdatedOn,UpdatedBy ");
			strSql.Append(" FROM Promotion_H ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Promotion_H T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Promotion_H";
