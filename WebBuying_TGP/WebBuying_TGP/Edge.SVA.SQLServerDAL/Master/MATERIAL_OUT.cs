...
namespace Edge.SVA.SQLServerDAL
{
    ...
    /// 创建时间：2016-02-25
	/// </summary>
	public partial class MATERIAL_OUT:IMATERIAL_OUT
	{
		public MATERIAL_OUT()
		{}
		#region  Method
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("MATERIALID", "MATERIAL_OUT"); 
		}
		...
		public bool Exists(int MATERIALID)
		{
			...
			strSql.Append("select count(1) from MATERIAL_OUT");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into MATERIAL_OUT(");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update MATERIAL_OUT set ");
		...
		public bool Delete(int MATERIALID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from MATERIAL_OUT ");
			strSql.Append(" where MATERIALID=@MATERIALID");
			SqlParameter[] parameters = {
					new SqlParameter("@MATERIALID", SqlDbType.Int,4)
			};
		...
		public Edge.SVA.Model.MATERIAL_OUT GetModel(int MATERIALID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 MATERIALID,MATERIALCode,MATERIALName1,MATERIALName2,MATERIALName3 from MATERIAL_OUT ");
			strSql.Append(" where MATERIALID=@MATERIALID");
			SqlParameter[] parameters = {
					new SqlParameter("@MATERIALID", SqlDbType.Int,4)
			};
			...
			Edge.SVA.Model.MATERIAL_OUT model=new Edge.SVA.Model.MATERIAL_OUT();
		...
		/// 得到一个对象实体
		/// </summary>
		public Edge.SVA.Model.MATERIAL_OUT DataRowToModel(DataRow row)
		{
			Edge.SVA.Model.MATERIAL_OUT model=new Edge.SVA.Model.MATERIAL_OUT();
			if (row != null)
			{
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM MATERIAL_OUT ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from MATERIAL_OUT T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "MATERIAL_OUT";
