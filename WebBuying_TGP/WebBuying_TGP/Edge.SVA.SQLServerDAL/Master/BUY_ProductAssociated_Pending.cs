...
{
	/// <summary>
	/// 数据访问类:BUY_ProductAssociated_Pending
    /// 创建人：Lisa
    /// 创建时间：2016-08-08
	/// </summary>
	public partial class BUY_ProductAssociated_Pending:IBUY_ProductAssociated_Pending
	{
		public BUY_ProductAssociated_Pending()
		{}
		#region  Method
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("KeyID", "BUY_ProductAssociated_Pending"); 
		}
		...
		public bool Exists(int KeyID)
		{
			...
			strSql.Append("select count(1) from BUY_ProductAssociated_Pending");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Edge.SVA.Model.BUY_ProductAssociated_Pending model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into BUY_ProductAssociated_Pending(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Edge.SVA.Model.BUY_ProductAssociated_Pending model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update BUY_ProductAssociated_Pending set ");
		...
		public bool Delete(int KeyID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from BUY_ProductAssociated_Pending ");
			strSql.Append(" where KeyID=@KeyID");
			SqlParameter[] parameters = {
					new SqlParameter("@KeyID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Edge.SVA.Model.BUY_ProductAssociated_Pending GetModel(int KeyID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 KeyID,ProdCode,SeqNo,AssociatedProdCode,AssociatedProdName,AssociatedProdFile,Note,CreatedOn,CreatedBy,UpdatedOn,UpdatedBy from BUY_ProductAssociated_Pending ");
			strSql.Append(" where KeyID=@KeyID");
			SqlParameter[] parameters = {
					new SqlParameter("@KeyID", SqlDbType.Int,4)
			};
			...
			Edge.SVA.Model.BUY_ProductAssociated_Pending model=new Edge.SVA.Model.BUY_ProductAssociated_Pending();
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM BUY_ProductAssociated_Pending ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from BUY_ProductAssociated_Pending T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "BUY_ProductAssociated_Pending";
