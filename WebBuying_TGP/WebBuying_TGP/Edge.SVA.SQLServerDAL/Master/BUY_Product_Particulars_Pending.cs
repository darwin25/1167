...
{
	/// <summary>
	/// 数据访问类:BUY_Product_Particulars_Pending
    /// 创建人：Lisa
    /// 创建时间：2016-08-08
	/// </summary>
	public partial class BUY_Product_Particulars_Pending:IBUY_Product_Particulars_Pending
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("LanguageID", "BUY_Product_Particulars_Pending"); 
		}
		...
		public bool Exists(string ProdCode,int LanguageID)
		{
			...
			strSql.Append("select count(1) from BUY_Product_Particulars_Pending");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Edge.SVA.Model.BUY_Product_Particulars_Pending model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into BUY_Product_Particulars_Pending(");
        ...
        public bool Add(string ProdCdoe)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into BUY_Product_Particulars_Pending ");
            strSql.AppendFormat("select *from BUY_Product_Particulars where ProdCode='{0}'",ProdCdoe); 
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Edge.SVA.Model.BUY_Product_Particulars_Pending model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update BUY_Product_Particulars_Pending set ");
		...
		public bool Delete(string ProdCode,int LanguageID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from BUY_Product_Particulars_Pending ");
			strSql.Append(" where ProdCode=@ProdCode and LanguageID=@LanguageID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ProdCode", SqlDbType.VarChar,64),
					new SqlParameter("@LanguageID", SqlDbType.Int,4)			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Edge.SVA.Model.BUY_Product_Particulars_Pending GetModel(string ProdCode,int LanguageID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ProdCode,LanguageID,ProdFunction,ProdIngredients,ProdInstructions,PackDesc,PackUnit,Memo1,Memo2,Memo3,Memo4,Memo5,Memo6,MemoTitle1,MemoTitle2,MemoTitle3,MemoTitle4,MemoTitle5,MemoTitle6,ProductPriority from BUY_Product_Particulars_Pending ");
			strSql.Append(" where ProdCode=@ProdCode and LanguageID=@LanguageID ");
			SqlParameter[] parameters = {
					new SqlParameter("@ProdCode", SqlDbType.VarChar,64),
					new SqlParameter("@LanguageID", SqlDbType.Int,4)			};
			...
			Edge.SVA.Model.BUY_Product_Particulars_Pending model=new Edge.SVA.Model.BUY_Product_Particulars_Pending();
			...
			if(ds.Tables[0].Rows.Count>0)
			{
				...
				if(ds.Tables[0].Rows[0]["ProductPriority"]!=null && ds.Tables[0].Rows[0]["ProductPriority"].ToString()!="")
				{
					model.ProductPriority=int.Parse(ds.Tables[0].Rows[0]["ProductPriority"].ToString());
				}
				return model;
			}
			else
        ...
        public Edge.SVA.Model.BUY_Product_Particulars_Pending GetParticularsPending(string ProdCode)
        {
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM BUY_Product_Particulars_Pending ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from BUY_Product_Particulars_Pending T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "BUY_Product_Particulars_Pending";
			parameters[1].Value = "LanguageID";
