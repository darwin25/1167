...
{
	/// <summary>
	/// 数据访问类:SVA_VoidCard_H
	/// </summary>
	public partial class SVA_VoidCard_H:ISVA_VoidCard_H
	{
		...
		public bool Exists(string Number)
		{
			...
			strSql.Append("select count(1) from SVA_VoidCard_H");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Edge.SVA.Model.SVA_VoidCard_H model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into SVA_VoidCard_H(");
			strSql.Append("Number,RefTxnNo,TxnDate,ShopID,ServerID,POSID,Note,CardCount,FormNo,Status,ApproveOn,ApproveBy,CreatedOn,CreatedBy,UpdatedOn,UpdatedBy)");
			...
			parameters[8].Value = model.FormNo;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Edge.SVA.Model.SVA_VoidCard_H model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update SVA_VoidCard_H set ");
			...
			parameters[7].Value = model.FormNo;
			...
			parameters[15].Value = model.Number;
		...
		public bool Delete(string Number)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from SVA_VoidCard_H ");
			strSql.Append(" where Number=@Number ");
			SqlParameter[] parameters = {
					new SqlParameter("@Number", SqlDbType.VarChar,20)};
			parameters[0].Value = Number;
		...
		/// 得到一个对象实体
		/// </summary>
		public Edge.SVA.Model.SVA_VoidCard_H GetModel(string Number)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 Number,RefTxnNo,TxnDate,ShopID,ServerID,POSID,Note,CardCount,FormNo,Status,ApproveOn,ApproveBy,CreatedOn,CreatedBy,UpdatedOn,UpdatedBy from SVA_VoidCard_H ");
			strSql.Append(" where Number=@Number ");
			SqlParameter[] parameters = {
					new SqlParameter("@Number", SqlDbType.VarChar,20)};
			parameters[0].Value = Number;

			Edge.SVA.Model.SVA_VoidCard_H model=new Edge.SVA.Model.SVA_VoidCard_H();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select Number,RefTxnNo,TxnDate,ShopID,ServerID,POSID,Note,CardCount,FormNo,Status,ApproveOn,ApproveBy,CreatedOn,CreatedBy,UpdatedOn,UpdatedBy ");
			strSql.Append(" FROM SVA_VoidCard_H ");
			if(strWhere.Trim()!="")
			{
        ...
        public DataSet GetList(int PageSize, int PageIndex, string strWhere, string filedOrder)
        {
			...
			parameters[0].Value = "SVA_VoidCard_H";
            parameters[1].Value = "*";
        ...
        public int GetCount(string strWhere)
        {
            ...
            sql.Append("select count(*) from SVA_VoidCard_H ");
