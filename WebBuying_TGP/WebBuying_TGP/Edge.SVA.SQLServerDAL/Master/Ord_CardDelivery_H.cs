...
{
	/// <summary>
	/// 数据访问类:Ord_CardDelivery_H
	/// </summary>
	public partial class Ord_CardDelivery_H:IOrd_CardDelivery_H
	{
		...
		public bool Exists(string CardDeliveryNumber)
		{
			...
			strSql.Append("select count(1) from Ord_CardDelivery_H");
			strSql.Append(" where CardDeliveryNumber=@CardDeliveryNumber ");
			SqlParameter[] parameters = {
					new SqlParameter("@CardDeliveryNumber", SqlDbType.VarChar,64)};
			parameters[0].Value = CardDeliveryNumber;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Ord_CardDelivery_H(");
			strSql.Append("CardDeliveryNumber,ReferenceNo,StoreID,CustomerID,NeedActive,Remark,CreatedBusDate,ApproveBusDate,ApprovalCode,ApproveStatus,ApproveOn,ApproveBy,CreatedOn,CreatedBy,UpdatedOn,UpdatedBy)");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Ord_CardDelivery_H set ");
			...
			parameters[15].Value = model.CardDeliveryNumber;
		...
		public bool Delete(string CardDeliveryNumber)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Ord_CardDelivery_H ");
			strSql.Append(" where CardDeliveryNumber=@CardDeliveryNumber ");
			SqlParameter[] parameters = {
					new SqlParameter("@CardDeliveryNumber", SqlDbType.VarChar,64)};
			parameters[0].Value = CardDeliveryNumber;
		...
		public bool DeleteList(string CardDeliveryNumberlist )
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Ord_CardDelivery_H ");
			strSql.Append(" where CardDeliveryNumber in ("+CardDeliveryNumberlist + ")  ");
		...
		public Edge.SVA.Model.Ord_CardDelivery_H GetModel(string CardDeliveryNumber)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 CardDeliveryNumber,ReferenceNo,StoreID,CustomerID,NeedActive,Remark,CreatedBusDate,ApproveBusDate,ApprovalCode,ApproveStatus,ApproveOn,ApproveBy,CreatedOn,CreatedBy,UpdatedOn,UpdatedBy from Ord_CardDelivery_H ");
			strSql.Append(" where CardDeliveryNumber=@CardDeliveryNumber ");
			SqlParameter[] parameters = {
					new SqlParameter("@CardDeliveryNumber", SqlDbType.VarChar,64)};
			parameters[0].Value = CardDeliveryNumber;

			Edge.SVA.Model.Ord_CardDelivery_H model=new Edge.SVA.Model.Ord_CardDelivery_H();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select CardDeliveryNumber,ReferenceNo,StoreID,CustomerID,NeedActive,Remark,CreatedBusDate,ApproveBusDate,ApprovalCode,ApproveStatus,ApproveOn,ApproveBy,CreatedOn,CreatedBy,UpdatedOn,UpdatedBy ");
			strSql.Append(" FROM Ord_CardDelivery_H ");
			if(strWhere.Trim()!="")
			{
        ...
        public DataSet GetList(int PageSize, int PageIndex, string strWhere, string filedOrder)
        {
            ...
            parameters[0].Value = "Ord_CardDelivery_H";
            parameters[1].Value = "*";
        ...
        public int GetCount(string strWhere)
        {
            ...
            sql.Append("select count(*) from Ord_CardDelivery_H ");
