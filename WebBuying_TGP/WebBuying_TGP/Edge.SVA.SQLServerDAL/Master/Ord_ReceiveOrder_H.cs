...
{
    /// <summary>
    /// 数据访问类:Ord_ReceiveOrder_H
    /// </summary>
    public partial class Ord_ReceiveOrder_H : IOrd_ReceiveOrder_H
    {
        public Ord_ReceiveOrder_H()
        { }
        #region  Method
        ...
        /// 是否存在该记录
        /// </summary>
        public bool Exists(string ReceiveOrderNumber)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from Ord_ReceiveOrder_H");
            strSql.Append(" where ReceiveOrderNumber=@ReceiveOrderNumber ");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Edge.SVA.Model.Ord_ReceiveOrder_H model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update Ord_ReceiveOrder_H set ");
            ...
            parameters[26].Value = model.ReceiveOrderNumber;
        ...
        public bool Delete(string ReceiveOrderNumber)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from Ord_ReceiveOrder_H ");
            strSql.Append(" where ReceiveOrderNumber=@ReceiveOrderNumber ");
            SqlParameter[] parameters = {
					new SqlParameter("@ReceiveOrderNumber", SqlDbType.VarChar,64)};
            parameters[0].Value = ReceiveOrderNumber;
        ...
        /// 批量删除数据
        /// </summary>
        public bool DeleteList(string ReceiveOrderNumberlist)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from Ord_ReceiveOrder_H ");
            strSql.Append(" where ReceiveOrderNumber in (" + ReceiveOrderNumberlist + ")  ");
        ...
        /// 得到一个对象实体
        /// </summary>
        public Edge.SVA.Model.Ord_ReceiveOrder_H GetModel(string ReceiveOrderNumber)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ReceiveOrderNumber,OrderType,ReceiveType,ReferenceNo,FromStoreID,FromContactName,FromContactPhone,FromMobile,FromEmail,FromAddress,StoreID,StoreContactName,StoreContactPhone,StoreContactEmail,StoreMobile,StoreAddress,Remark,CreatedBusDate,ApproveBusDate,ApprovalCode,ApproveStatus,ApproveOn,ApproveBy,CreatedOn,CreatedBy,UpdatedOn,UpdatedBy from Ord_ReceiveOrder_H ");
            strSql.Append(" where ReceiveOrderNumber=@ReceiveOrderNumber ");
            SqlParameter[] parameters = {
					new SqlParameter("@ReceiveOrderNumber", SqlDbType.VarChar,64)			};
            parameters[0].Value = ReceiveOrderNumber;

            Edge.SVA.Model.Ord_ReceiveOrder_H model = new Edge.SVA.Model.Ord_ReceiveOrder_H();
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select ReceiveOrderNumber , OrderType ,ReceiveType, ReferenceNo , FromStoreID , FromContactName , FromContactPhone , FromMobile , FromEmail , FromAddress , StoreID , StoreContactName , StoreContactPhone , StoreContactEmail , StoreMobile , StoreAddress  , Remark , CreatedBusDate , ApproveBusDate , ApprovalCode , ApproveStatus , ApproveOn , ApproveBy , CreatedOn , CreatedBy , UpdatedOn , UpdatedBy ");
            strSql.Append(" FROM Ord_ReceiveOrder_H ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByParm(string strWhere, string filedOrder, string webSiteName)
        {
            ...
            strSql.Append("select Ord_ReceiveOrder_H.ReceiveOrderNumber,Ord_ReceiveOrder_H.OrderType,");
            strSql.Append("case Ord_ReceiveOrder_H.OrderType when 0 then'手动'else  '自动'end SimplifiedOrderTypeName,");
            strSql.Append("case Ord_ReceiveOrder_H.OrderType when 0 then '手動'else '手動'end as TraditionalOrderTypeName,");
            strSql.Append("case Ord_ReceiveOrder_H.OrderType when 0 then 'Manually'else 'Auto'end as EnglishOrderTypeName,");
            strSql.Append("ReferenceNo,FromStoreID,FromContactName,FromContactPhone,FromMobile, FromEmail,FromAddress,Ord_ReceiveOrder_H.StoreID,");
            strSql.Append("StoreContactName,StoreContactPhone,StoreContactEmail,StoreMobile,StoreAddress, Ord_ReceiveOrder_H.Remark,");
            ...
            strSql.Append("Convert(varchar(10),Ord_ReceiveOrder_H.ApproveOn,120)as ApproveOn,ApproveBy,u1.UserName as ApproveName,");
            strSql.Append("Convert(varchar(10),Ord_ReceiveOrder_H.CreatedOn,120)as CreatedOn,Ord_ReceiveOrder_H.CreatedBy,Accounts_Users.UserName as CreatedName,");
            strSql.Append("Convert(varchar(10),Ord_ReceiveOrder_H.UpdatedOn,120)as UpdatedOn,Ord_ReceiveOrder_H.UpdatedBy,u.UserName as UpdatedName,");
            strSql.Append("Ord_ReceiveOrder_D.ProdCode,Ord_ReceiveOrder_D.OrderQty,Ord_ReceiveOrder_D.ReceiveQty,");
            ...
            strSql.Append("from Ord_ReceiveOrder_H ");
            strSql.Append("left join Ord_ReceiveOrder_D on Ord_ReceiveOrder_H.ReceiveOrderNumber=Ord_ReceiveOrder_D.ReceiveOrderNumber ");
            strSql.Append("left join Accounts_Users on Ord_ReceiveOrder_H.CreatedBy=Accounts_Users.UserID ");
            strSql.Append("left join Accounts_Users as u  on Ord_ReceiveOrder_H.UpdatedBy=u.UserID ");
            strSql.Append("left join Accounts_Users as u1  on Ord_ReceiveOrder_H.ApproveBy=u1.UserID ");
            strSql.Append("left join BUY_PRODUCT on Ord_ReceiveOrder_D.ProdCode=BUY_PRODUCT.ProdCode ");
            strSql.Append("left join BUY_STORE on Ord_ReceiveOrder_H.StoreID=BUY_STORE.StoreID ");
            strSql.Append("left join BUY_STORE store1 on Ord_ReceiveOrder_H.FromStoreID=store1.StoreID ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        public DataSet GetList(int PageSize, int PageIndex, string strWhere, string filedOrder)
        {
            ...
            parameters[0].Value = "Ord_ReceiveOrder_H";
            parameters[1].Value = "*";
        ...
        public int GetCount(string strWhere)
        {
            ...
            sql.Append("select count(*) from Ord_ReceiveOrder_H ");
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from Ord_ReceiveOrder_H T ");
            if (!string.IsNullOrEmpty(strWhere.Trim()))
            {
                strSql.Append(" WHERE " + strWhere);
            }
        ...
        /// </summary>
        public DataSet ExportStoreReceiveData(string ReceiveOrderNumber, int OrderType)
        {
            SqlParameter[] parameters = {
            ...
            return DbHelperSQL.RunProcedure("ExportStoreReceiveData", parameters, "ds");
        }


        /// <summary>
        /// GetReceiveOrderHeader
        /// </summary>
        public DataSet GetReceiveOrderHeader(string ShipmentOrderNumber)
        {
            SqlParameter[] parameters = {
					new SqlParameter("@ShipmentOrderNumber", SqlDbType.VarChar, 64),    
					};
            ...
            return DbHelperSQL.RunProcedure("GetReceiveOrderHeader", parameters, "ds");
        }

        /// <summary>
        /// GetReceiveOrderDetail
        /// </summary>
        public DataSet GetReceiveOrderDetail(string ShipmentOrderNumber)
        {
            SqlParameter[] parameters = {
					new SqlParameter("@ShipmentOrderNumber", SqlDbType.VarChar, 64),    
					};
            ...
            return DbHelperSQL.RunProcedure("GetReceiveOrderDetail", parameters, "ds");
        }
        #endregion  Method
    }
}
