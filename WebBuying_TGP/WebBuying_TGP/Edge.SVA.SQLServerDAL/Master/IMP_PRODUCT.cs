...
namespace Edge.SVA.SQLServerDAL
{
    ...
    /// 创建时间：2016-07-08
    /// </summary>
    public partial class IMP_PRODUCT : IIMP_PRODUCT
    {
        public IMP_PRODUCT()
        { }
        #region  BasicMethod
        ...
        public bool Exists(string INTERNAL_PRODUCT_CODE)
        {
            ...
            strSql.Append("select count(1) from IMP_PRODUCT");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into IMP_PRODUCT(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update IMP_PRODUCT set ");
        ...
        public bool Delete(string INTERNAL_PRODUCT_CODE)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from IMP_PRODUCT ");
            strSql.Append(" where INTERNAL_PRODUCT_CODE=@INTERNAL_PRODUCT_CODE ");
            SqlParameter[] parameters = {
					new SqlParameter("@INTERNAL_PRODUCT_CODE", SqlDbType.VarChar,64)			};
            parameters[0].Value = INTERNAL_PRODUCT_CODE;
        ...
        /// 得到一个对象实体
        /// </summary>
        public Edge.SVA.Model.IMP_PRODUCT GetModel(string BARCODE)
        {
            ...
            Edge.SVA.Model.IMP_PRODUCT model = new Edge.SVA.Model.IMP_PRODUCT();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Edge.SVA.Model.IMP_PRODUCT DataRowToModel(DataRow row)
        {
            Edge.SVA.Model.IMP_PRODUCT model = new Edge.SVA.Model.IMP_PRODUCT();
            if (row != null)
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from IMP_PRODUCT T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "IMP_PRODUCT";
