...
{
	/// <summary>
	/// 数据访问类:BUY_PRODUCTSIZE
	/// </summary>
	public partial class BUY_PRODUCTSIZE:IBUY_PRODUCTSIZE
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ProductSizeID", "BUY_PRODUCTSIZE"); 
		}
		...
		public bool Exists(string ProductSizeCode,int ProductSizeID)
		{
			...
			strSql.Append("select count(1) from BUY_PRODUCTSIZE");
		...
		/// 增加一条数据
		/// </summary>
		public int Add(Edge.SVA.Model.BUY_PRODUCTSIZE model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into BUY_PRODUCTSIZE(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Edge.SVA.Model.BUY_PRODUCTSIZE model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update BUY_PRODUCTSIZE set ");
		...
		public bool Delete(int ProductSizeID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from BUY_PRODUCTSIZE ");
			strSql.Append(" where ProductSizeID=@ProductSizeID");
			SqlParameter[] parameters = {
					new SqlParameter("@ProductSizeID", SqlDbType.Int,4)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Edge.SVA.Model.BUY_PRODUCTSIZE GetModel(int ProductSizeID)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 ProductSizeID,ProductSizeCode,ProductSizeType,ProductSizeName1,ProductSizeName2,ProductSizeName3,ProductSizeNote from BUY_PRODUCTSIZE ");
			strSql.Append(" where ProductSizeID=@ProductSizeID");
			SqlParameter[] parameters = {
					new SqlParameter("@ProductSizeID", SqlDbType.Int,4)
			};
			...
			Edge.SVA.Model.BUY_PRODUCTSIZE model=new Edge.SVA.Model.BUY_PRODUCTSIZE();
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM BUY_PRODUCTSIZE ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from BUY_PRODUCTSIZE T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "BUY_PRODUCTSIZE";
			parameters[1].Value = "ProductSizeID";
