...
{
    /// <summary>
    /// 数据访问类:Ord_HQReceiveOrder_H
    /// </summary>
    public partial class Ord_HQReceiveOrder_H : IOrd_HQReceiveOrder_H
    {
        public Ord_HQReceiveOrder_H()
        { }
        #region  Method
        ...
        /// 是否存在该记录
        /// </summary>
        public bool Exists(string HQReceiveOrderNumber)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from Ord_HQReceiveOrder_H");
            strSql.Append(" where HQReceiveOrderNumber=@HQReceiveOrderNumber ");
            SqlParameter[] parameters = {
					new SqlParameter("@HQReceiveOrderNumber", SqlDbType.VarChar,64)};
            parameters[0].Value = HQReceiveOrderNumber;
        ...
        public bool Add(Edge.SVA.Model.Ord_HQReceiveOrder_H model)
        {
            ...
            parameters[0].Value = model.HQReceiveOrderNumber;
            parameters[1].Value = model.OrderType;
            parameters[2].Value = model.ReceiveType;
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Edge.SVA.Model.Ord_HQReceiveOrder_H model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update Ord_HQReceiveOrder_H set ");
            ...
            parameters[1].Value = model.ReceiveType;
            ...
            parameters[26].Value = model.HQReceiveOrderNumber;
        ...
        /// 删除一条数据
        /// </summary>
        public bool Delete(string HQReceiveOrderNumber)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from Ord_HQReceiveOrder_H ");
            strSql.Append(" where HQReceiveOrderNumber=@HQReceiveOrderNumber ");
            SqlParameter[] parameters = {
					new SqlParameter("@HQReceiveOrderNumber", SqlDbType.VarChar,64)};
            parameters[0].Value = HQReceiveOrderNumber;
        ...
        /// 批量删除数据
        /// </summary>
        public bool DeleteList(string HQReceiveOrderNumberlist)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from Ord_HQReceiveOrder_H ");
            strSql.Append(" where HQReceiveOrderNumber in (" + HQReceiveOrderNumberlist + ")  ");
        ...
        /// 得到一个对象实体
        /// </summary>
        public Edge.SVA.Model.Ord_HQReceiveOrder_H GetModel(string HQReceiveOrderNumber)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 HQReceiveOrderNumber,OrderType,ReceiveType,ReferenceNo,FromStoreID,FromContactName,FromContactPhone,FromMobile,FromEmail,FromAddress,StoreID,StoreContactName,StoreContactPhone,StoreContactEmail,StoreMobile,StoreAddress,Remark,CreatedBusDate,ApproveBusDate,ApprovalCode,ApproveStatus,ApproveOn,ApproveBy,CreatedOn,CreatedBy,UpdatedOn,UpdatedBy from Ord_HQReceiveOrder_H ");
            strSql.Append(" where HQReceiveOrderNumber=@HQReceiveOrderNumber ");
            SqlParameter[] parameters = {
					new SqlParameter("@HQReceiveOrderNumber", SqlDbType.VarChar,64)			};
            parameters[0].Value = HQReceiveOrderNumber;

            Edge.SVA.Model.Ord_HQReceiveOrder_H model = new Edge.SVA.Model.Ord_HQReceiveOrder_H();
            DataSet ds = DbHelperSQL.Query(strSql.ToString(), parameters);
            if (ds.Tables[0].Rows.Count > 0)
            {
                if (ds.Tables[0].Rows[0]["HQReceiveOrderNumber"] != null && ds.Tables[0].Rows[0]["HQReceiveOrderNumber"].ToString() != "")
                {
                    model.HQReceiveOrderNumber = ds.Tables[0].Rows[0]["HQReceiveOrderNumber"].ToString();
                }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select HQReceiveOrderNumber , OrderType ,ReceiveType, ReferenceNo , FromStoreID , FromContactName , FromContactPhone , FromMobile , FromEmail , FromAddress , StoreID , StoreContactName , StoreContactPhone , StoreContactEmail , StoreMobile , StoreAddress  , Remark , CreatedBusDate , ApproveBusDate , ApprovalCode , ApproveStatus , ApproveOn , ApproveBy , CreatedOn , CreatedBy , UpdatedOn , UpdatedBy ");
            strSql.Append(" FROM Ord_HQReceiveOrder_H ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByParm(string strWhere, string filedOrder, string webSiteName)
        {
            ...
            strSql.Append("select Ord_HQReceiveOrder_H.HQReceiveOrderNumber,Ord_HQReceiveOrder_H.OrderType,");
            strSql.Append("case Ord_HQReceiveOrder_H.OrderType when 0 then'手动'else  '自动'end SimplifiedOrderTypeName,");
            strSql.Append("case Ord_HQReceiveOrder_H.OrderType when 0 then '手動'else '手動'end as TraditionalOrderTypeName,");
            strSql.Append("case Ord_HQReceiveOrder_H.OrderType when 0 then 'Manually'else 'Auto'end as EnglishOrderTypeName,");
            strSql.Append("ReferenceNo,FromStoreID,FromContactName,FromContactPhone,FromMobile, FromEmail,FromAddress,");
            strSql.Append("Ord_HQReceiveOrder_H.StoreID,StoreContactName,StoreContactPhone,StoreContactEmail,StoreMobile,StoreAddress,");
            strSql.Append("Ord_HQReceiveOrder_H.Remark,Convert(varchar(10),CreatedBusDate,120)as CreatedBusDate,");
            ...
            strSql.Append("Convert(varchar(10),Ord_HQReceiveOrder_H.ApproveOn,120)as ApproveOn,ApproveBy,u1.UserName as ApproveName, ");
            strSql.Append("Convert(varchar(10),Ord_HQReceiveOrder_H.CreatedOn,120)as CreatedOn,Ord_HQReceiveOrder_H.CreatedBy,");
            strSql.Append("Accounts_Users.UserName as CreatedName, Convert(varchar(10),Ord_HQReceiveOrder_H.UpdatedOn,120)as UpdatedOn,");
            strSql.Append("Ord_HQReceiveOrder_H.UpdatedBy,u.UserName as UpdatedName, Ord_HQReceiveOrder_D.ProdCode,");
            strSql.Append("Ord_HQReceiveOrder_D.OrderQty,Ord_HQReceiveOrder_D.ReceiveQty,BUY_STORE.StoreName1 as EEnglishStoreName ,BUY_STORE.StoreName2 as ESimplifiedStoreName,");
            strSql.Append("BUY_STORE.StoreName3 as ETraditionalStoreName,BUY_STORE.StoreAddressDetail1, BUY_STORE.Contact,BUY_STORE.ContactPhone,");
            strSql.Append("st2.StoreName1 as OEnglishStoreName,st2.StoreName2 as OSimplifiedStoreName,st2.StoreName3 as OTraditionalStoreName,");
            strSql.Append("BUY_PRODUCT.ProdDesc1,BUY_PRODUCT.ProdDesc2,BUY_PRODUCT.ProdDesc3,@WebSiteName as WebSiteName ");
            strSql.Append("from Ord_HQReceiveOrder_H ");
            strSql.Append("left join Ord_HQReceiveOrder_D on Ord_HQReceiveOrder_H.HQReceiveOrderNumber=Ord_HQReceiveOrder_D.HQReceiveOrderNumber ");
            strSql.Append("left join Accounts_Users on Ord_HQReceiveOrder_H.CreatedBy=Accounts_Users.UserID ");
            strSql.Append("left join Accounts_Users as u  on Ord_HQReceiveOrder_H.UpdatedBy=u.UserID ");
            strSql.Append("left join Accounts_Users as u1  on Ord_HQReceiveOrder_H.ApproveBy=u1.UserID ");
            strSql.Append("left join BUY_PRODUCT on Ord_HQReceiveOrder_D.ProdCode=BUY_PRODUCT.ProdCode ");
            strSql.Append("left join BUY_STORE on Ord_HQReceiveOrder_H.StoreID=BUY_STORE.StoreID ");
            //strSql.Append("left join BUY_VENDOR  on Ord_HQReceiveOrder_H.FromStoreID=BUY_VENDOR.VendorID ");
            strSql.Append(" left join BUY_STORE st2  on Ord_HQReceiveOrder_H.FromStoreID=st2.StoreID ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        public DataSet GetList(int PageSize, int PageIndex, string strWhere, string filedOrder)
        {
            ...
            parameters[0].Value = "Ord_HQReceiveOrder_H";
            parameters[1].Value = "*";
        ...
        public int GetCount(string strWhere)
        {
            ...
            sql.Append("select count(*) from Ord_HQReceiveOrder_H ");
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            {
                strSql.Append("order by T.HQReceiveOrderNumber desc");
            }
            strSql.Append(")AS Row, T.*  from Ord_HQReceiveOrder_H T ");
            if (!string.IsNullOrEmpty(strWhere.Trim()))
            {
                strSql.Append(" WHERE " + strWhere);
            }
