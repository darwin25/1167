...
namespace Edge.SVA.SQLServerDAL
{
	...
	/// 数据访问类:STK_STake02
	/// </summary>
	public partial class STK_STake02:ISTK_STake02
	{
        public STK_STake02()
		{}
		#region  Method
		...
		public int GetMaxId()
		{
            return DbHelperSQL.GetMaxID("SEQ", "STK_STake02"); 
		}
        ...
        public bool Exists(string StockTakeNumber, int StoreID, string ProdCode, string SerialNo)
		{
            ...
            strSql.Append("select count(1) from STK_STake02");
		...
		{
			StringBuilder strSql=new StringBuilder();
            strSql.Append("insert into STK_STake02(");
		...
		{
			StringBuilder strSql=new StringBuilder();
            strSql.Append("update STK_STake02 set ");
        ...
        public bool Delete(string StockTakeNumber, int StoreID, string ProdCode, string StoreType, string SerialNo)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from STK_STake02 ");
        ...
        public Edge.SVA.Model.STK_STAKE02 GetModel(string StockTakeNumber, int StoreID, string ProdCode, string StoreType, string SerialNo)
		{
			...
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select top 1 StoreID, StockTakeNumber, ProdCode, StockType, QTY, Status, SerialNo, SEQ, CreatedOn from STK_STake02 ");
            strSql.Append(" where StoreID=@StoreID and StockTakeNumber = @StockTakeNumber and ProdCode = @ProdCode and StockType = @StockType and SerialNo = @SerialNo");
			SqlParameter[] parameters = {
					new SqlParameter("@StoreID", SqlDbType.Int,4),
					new SqlParameter("@StockTakeNumber", SqlDbType.VarChar,64),
            ...
            Edge.SVA.Model.STK_STAKE02 model = new Edge.SVA.Model.STK_STAKE02();
		...
		public DataSet GetList(string strWhere)
		{
            ...
            strSql.Append(" FROM STK_STake02 ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
            ...
            strSql.Append(")AS Row, T.*  from STK_STake02 T ");
