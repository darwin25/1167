...
{
	/// <summary>
	/// 数据访问类:Ord_CardOrderForm_H
	/// </summary>
	public partial class Ord_CardOrderForm_H:IOrd_CardOrderForm_H
	{
		...
		public bool Exists(string CardOrderFormNumber)
		{
			...
			strSql.Append("select count(1) from Ord_CardOrderForm_H");
			strSql.Append(" where CardOrderFormNumber=@CardOrderFormNumber ");
			SqlParameter[] parameters = {
					new SqlParameter("@CardOrderFormNumber", SqlDbType.VarChar,64)};
			parameters[0].Value = CardOrderFormNumber;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Ord_CardOrderForm_H(");
			strSql.Append("CardOrderFormNumber,StoreID,CustomerType,CustomerID,SendMethod,SendAddress,ContactName,ContactNumber,Email,SMSMMS,Remark,CreatedBusDate,ApproveBusDate,ApprovalCode,ApproveStatus,ApproveOn,ApproveBy,CreatedOn,CreatedBy,UpdatedOn,UpdatedBy)");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Ord_CardOrderForm_H set ");
			...
			parameters[20].Value = model.CardOrderFormNumber;
		...
		public bool Delete(string CardOrderFormNumber)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Ord_CardOrderForm_H ");
			strSql.Append(" where CardOrderFormNumber=@CardOrderFormNumber ");
			SqlParameter[] parameters = {
					new SqlParameter("@CardOrderFormNumber", SqlDbType.VarChar,64)};
			parameters[0].Value = CardOrderFormNumber;
		...
		public bool DeleteList(string CardOrderFormNumberlist )
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Ord_CardOrderForm_H ");
			strSql.Append(" where CardOrderFormNumber in ("+CardOrderFormNumberlist + ")  ");
		...
		public Edge.SVA.Model.Ord_CardOrderForm_H GetModel(string CardOrderFormNumber)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 CardOrderFormNumber,StoreID,CustomerType,CustomerID,SendMethod,SendAddress,ContactName,ContactNumber,Email,SMSMMS,Remark,CreatedBusDate,ApproveBusDate,ApprovalCode,ApproveStatus,ApproveOn,ApproveBy,CreatedOn,CreatedBy,UpdatedOn,UpdatedBy from Ord_CardOrderForm_H ");
			strSql.Append(" where CardOrderFormNumber=@CardOrderFormNumber ");
			SqlParameter[] parameters = {
					new SqlParameter("@CardOrderFormNumber", SqlDbType.VarChar,64)};
			parameters[0].Value = CardOrderFormNumber;

			Edge.SVA.Model.Ord_CardOrderForm_H model=new Edge.SVA.Model.Ord_CardOrderForm_H();
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select CardOrderFormNumber,StoreID,CustomerType,CustomerID,SendMethod,SendAddress,ContactName,ContactNumber,Email,SMSMMS,Remark,CreatedBusDate,ApproveBusDate,ApprovalCode,ApproveStatus,ApproveOn,ApproveBy,CreatedOn,CreatedBy,UpdatedOn,UpdatedBy ");
			strSql.Append(" FROM Ord_CardOrderForm_H ");
			if(strWhere.Trim()!="")
			{
        ...
        public DataSet GetList(int PageSize, int PageIndex, string strWhere, string filedOrder)
        {
            ...
            parameters[0].Value = "Ord_CardOrderForm_H";
            parameters[1].Value = "*";
        ...
        public int GetCount(string strWhere)
        {
            ...
            sql.Append("select count(*) from Ord_CardOrderForm_H ");
