...
{
	/// <summary>
    /// 数据访问类:Ord_StoreOrder_H
	/// </summary>
	public partial class Ord_StoreOrder_H:IOrd_StoreOrder_H
	{
		public Ord_StoreOrder_H()
		{}
		#region  Method
		...
		/// 是否存在该记录
		/// </summary>
		public bool Exists(string StoreOrderNumber)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select count(1) from Ord_StoreOrder_H");
			strSql.Append(" where StoreOrderNumber=@StoreOrderNumber ");
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Edge.SVA.Model.Ord_StoreOrder_H model)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update Ord_StoreOrder_H set ");
            ...
            parameters[25].Value = model.StoreOrderNumber;
		...
		public bool Delete(string StoreOrderNumber)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Ord_StoreOrder_H ");
			strSql.Append(" where StoreOrderNumber=@StoreOrderNumber ");
			SqlParameter[] parameters = {
					new SqlParameter("@StoreOrderNumber", SqlDbType.VarChar,64)};
			parameters[0].Value = StoreOrderNumber;
		...
		/// 批量删除数据
		/// </summary>
		public bool DeleteList(string StoreOrderNumberlist )
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Ord_StoreOrder_H ");
			strSql.Append(" where StoreOrderNumber in ("+StoreOrderNumberlist + ")  ");
        ...
        /// 得到一个对象实体
        /// </summary>
        public Edge.SVA.Model.Ord_StoreOrder_H GetModel(string StoreOrderNumber)
        {

            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 StoreOrderNumber,OrderType,ReferenceNo,FromStoreID,FromContactName,FromContactPhone,FromMobile,FromEmail,FromAddress,StoreID,StoreContactName,StoreContactPhone,StoreContactEmail,StoreMobile,StoreAddress,Remark,CreatedBusDate,ApproveBusDate,ApprovalCode,ApproveStatus,ApproveOn,ApproveBy,CreatedOn,CreatedBy,UpdatedOn,UpdatedBy from Ord_StoreOrder_H ");
            strSql.Append(" where StoreOrderNumber=@StoreOrderNumber ");
            SqlParameter[] parameters = {
					new SqlParameter("@StoreOrderNumber", SqlDbType.VarChar,64)			};
            parameters[0].Value = StoreOrderNumber;

            Edge.SVA.Model.Ord_StoreOrder_H model = new Edge.SVA.Model.Ord_StoreOrder_H();
		...
		{
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select StoreOrderNumber , OrderType , ReferenceNo , FromStoreID , FromContactName , FromContactPhone , FromMobile , FromEmail , FromAddress , StoreID , StoreContactName , StoreContactPhone , StoreContactEmail , StoreMobile , StoreAddress  , Remark , CreatedBusDate , ApproveBusDate , ApprovalCode , ApproveStatus , ApproveOn , ApproveBy , CreatedOn , CreatedBy , UpdatedOn , UpdatedBy ");
			strSql.Append(" FROM Ord_StoreOrder_H ");
			if(strWhere.Trim()!="")
			{
        ...
        public DataSet GetListByParm(string strWhere, string filedOrder, string webSiteName)
        {
            ...
            strSql.Append("select Ord_StoreOrder_H.StoreOrderNumber,Ord_StoreOrder_H.OrderType,");
            strSql.Append("case Ord_StoreOrder_H.OrderType when 0 then'手动'else  '自动'end SimplifiedOrderTypeName,");
            strSql.Append("case Ord_StoreOrder_H.OrderType when 0 then '手動'else '手動'end as TraditionalOrderTypeName,");
            strSql.Append("case Ord_StoreOrder_H.OrderType when 0 then 'Manually'else 'Auto'end as EnglishOrderTypeName,");
            strSql.Append("ReferenceNo,FromStoreID,FromContactName,FromContactPhone,FromMobile, FromEmail,FromAddress,");
            strSql.Append("Ord_StoreOrder_H.StoreID,StoreContactName,StoreContactPhone,StoreContactEmail,StoreMobile,StoreAddress,");
            strSql.Append("Remark,Convert(varchar(10),CreatedBusDate,120)as CreatedBusDate ,Convert(varchar(10),ApproveBusDate,120)as ApproveBusDate,");
            ...
            strSql.Append("Convert(varchar(10),Ord_StoreOrder_H.ApproveOn,120)as ApproveOn,ApproveBy,u1.UserName as ApproveName,");
            strSql.Append("Convert(varchar(10),Ord_StoreOrder_H.CreatedOn,120)as CreatedOn,Ord_StoreOrder_H.CreatedBy,Accounts_Users.UserName as CreatedName,");
            strSql.Append("Convert(varchar(10),Ord_StoreOrder_H.UpdatedOn,120)as UpdatedOn,Ord_StoreOrder_H.UpdatedBy,u.UserName as UpdatedName,");
            strSql.Append("Ord_StoreOrder_D.ProdCode,Ord_StoreOrder_D.OrderQty,BUY_STORE.StoreName1 as EEnglishStoreName ,BUY_STORE.StoreName2 as ESimplifiedStoreName,");
            ...
            strSql.Append("store1.StoreName1 as OEnglishStoreName,store1.StoreName2 as OSimplifiedStoreName,store1.StoreName3 as OTraditionalStoreName ,");
            strSql.Append("BUY_PRODUCT.ProdDesc1,BUY_PRODUCT.ProdDesc2,BUY_PRODUCT.ProdDesc3,@WebSiteName as WebSiteName,Price,OrderQty*Price as totalPrice");
            //strSql.Append(",'" + webSiteName + "' as  WebSiteName ");
            strSql.Append(" from Ord_StoreOrder_H ");
            strSql.Append("left join Ord_StoreOrder_D on Ord_StoreOrder_H.StoreOrderNumber=Ord_StoreOrder_D.StoreOrderNumber ");
            strSql.Append("left join Accounts_Users on Ord_StoreOrder_H.CreatedBy=Accounts_Users.UserID ");
            strSql.Append("left join Accounts_Users as u  on Ord_StoreOrder_H.UpdatedBy=u.UserID ");
            strSql.Append("left join Accounts_Users as u1  on Ord_StoreOrder_H.ApproveBy=u1.UserID ");
            strSql.Append("left join BUY_PRODUCT on Ord_StoreOrder_D.ProdCode=BUY_PRODUCT.ProdCode ");
            strSql.Append("left join BUY_STORE on Ord_StoreOrder_H.StoreID=BUY_STORE.StoreID ");
            strSql.Append("left join BUY_STORE store1 on Ord_StoreOrder_H.FromStoreID=store1.StoreID ");
            ...
            strSql.Append("AND StartDate <= GETDATE() AND EndDate >= GETDATE()) BUY_RPRICE_M on BUY_PRODUCT.ProdCode = BUY_RPRICE_M.ProdCode ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        public DataSet GetList(int PageSize, int PageIndex, string strWhere, string filedOrder)
        {
            ...
            parameters[0].Value = "Ord_StoreOrder_H";
            parameters[1].Value = "*";
        ...
        public int GetCount(string strWhere)
        {
            ...
            sql.Append("select count(*) from Ord_StoreOrder_H ");
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from Ord_StoreOrder_H T ");
            if (!string.IsNullOrEmpty(strWhere.Trim()))
            {
                strSql.Append(" WHERE " + strWhere);
            }
        ...
        public DataSet ExportStoreOrderData(string StoreOrderNumber)
        {
            ...
            return DbHelperSQL.RunProcedure("ExportStoreOrderData", parameters, "ds");
        }
		#endregion  Method
	}
}
