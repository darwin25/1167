...
namespace Edge.SVA.BLL
{
	...
	///Pend
	/// </summary>
	public partial class BUY_PRODUCT_PIC_Pending
	{
		private readonly IBUY_PRODUCT_PIC_Pending dal=DataAccess.CreateBUY_PRODUCT_PIC_Pending();
		public BUY_PRODUCT_PIC_Pending()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
		public int  Add(Edge.SVA.Model.BUY_PRODUCT_PIC_Pending model)
		{
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Edge.SVA.Model.BUY_PRODUCT_PIC_Pending model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
		public Edge.SVA.Model.BUY_PRODUCT_PIC_Pending GetModel(int KeyID)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Edge.SVA.Model.BUY_PRODUCT_PIC_Pending GetModelByCache(int KeyID)
		{
			
			string CacheKey = "BUY_PRODUCT_PIC_PendingModel-" + KeyID;
			...
			return (Edge.SVA.Model.BUY_PRODUCT_PIC_Pending)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Edge.SVA.Model.BUY_PRODUCT_PIC_Pending> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Edge.SVA.Model.BUY_PRODUCT_PIC_Pending> DataTableToList(DataTable dt)
		{
			List<Edge.SVA.Model.BUY_PRODUCT_PIC_Pending> modelList = new List<Edge.SVA.Model.BUY_PRODUCT_PIC_Pending>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Edge.SVA.Model.BUY_PRODUCT_PIC_Pending model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Edge.SVA.Model.BUY_PRODUCT_PIC_Pending();
