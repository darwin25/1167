...
namespace Edge.SVA.BLL
{
	...
	{
		private readonly IBUY_PRODUCTSIZE dal=DataAccess.CreateBUY_PRODUCTSIZE();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Edge.SVA.Model.BUY_PRODUCTSIZE GetModelByCache(int ProductSizeID)
		{
			
			string CacheKey = "BUY_PRODUCTSIZEModel-" + ProductSizeID;
			...
			return (Edge.SVA.Model.BUY_PRODUCTSIZE)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Edge.SVA.Model.BUY_PRODUCTSIZE> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Edge.SVA.Model.BUY_PRODUCTSIZE> DataTableToList(DataTable dt)
		{
			List<Edge.SVA.Model.BUY_PRODUCTSIZE> modelList = new List<Edge.SVA.Model.BUY_PRODUCTSIZE>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Edge.SVA.Model.BUY_PRODUCTSIZE model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Edge.SVA.Model.BUY_PRODUCTSIZE();
