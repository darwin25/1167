...
namespace Edge.SVA.BLL
{
	...
	/// 盘点注册
	/// </summary>
	public partial class STK_STake02
	{
		private readonly ISTK_STake02 dal=DataAccess.CreateSTK_STake02();
        public STK_STake02()
		{}
		#region  Method
		...
		/// 增加一条数据
		/// </summary>
        public int Add(Edge.SVA.Model.STK_STAKE02 model)
		{
		...
		/// 更新一条数据
		/// </summary>
        public bool Update(Edge.SVA.Model.STK_STAKE02 model)
		{
		...
		/// 得到一个对象实体
		/// </summary>
        public Edge.SVA.Model.STK_STAKE02 GetModel(string StockTakeNumber, int StoreID, string ProdCode, string StoreType, string SerialNo)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
        public Edge.SVA.Model.STK_STAKE02 GetModelByCache(string StockTakeNumber, int StoreID, string ProdCode, string StoreType, string SerialNo)
		{
            ...
            return (Edge.SVA.Model.STK_STAKE02)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
        public List<Edge.SVA.Model.STK_STAKE02> GetModelList(string strWhere)
		{            
		...
		/// 获得数据列表
		/// </summary>
        public List<Edge.SVA.Model.STK_STAKE02> DataTableToList(DataTable dt)
		{
            List<Edge.SVA.Model.STK_STAKE02> modelList = new List<Edge.SVA.Model.STK_STAKE02>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
                Edge.SVA.Model.STK_STAKE02 model;
				for (int n = 0; n < rowsCount; n++)
				{
                    model = new Edge.SVA.Model.STK_STAKE02();
