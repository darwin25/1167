...
namespace Edge.SVA.BLL
{
    ...
    {
        private readonly IOrd_StockAdjust_H dal = DataAccess.CreateOrd_StockAdjust_H();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Edge.SVA.Model.Ord_StockAdjust_H GetModel(string POCode)
        {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public Edge.SVA.Model.Ord_StockAdjust_H GetModelByCache(string POCode)
        {

            string CacheKey = "Ord_StockAdjust_HModel-" + POCode;
            ...
            return (Edge.SVA.Model.Ord_StockAdjust_H)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<Edge.SVA.Model.Ord_StockAdjust_H> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Edge.SVA.Model.Ord_StockAdjust_H> DataTableToList(DataTable dt)
        {
            List<Edge.SVA.Model.Ord_StockAdjust_H> modelList = new List<Edge.SVA.Model.Ord_StockAdjust_H>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Edge.SVA.Model.Ord_StockAdjust_H model;
                for (int n = 0; n < rowsCount; n++)
                {
                    model = new Edge.SVA.Model.Ord_StockAdjust_H();
