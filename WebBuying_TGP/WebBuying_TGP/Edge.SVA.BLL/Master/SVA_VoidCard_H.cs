...
namespace Edge.SVA.BLL
{
	...
	{
		private readonly ISVA_VoidCard_H dal=DataAccess.CreateSVA_VoidCard_H();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Edge.SVA.Model.SVA_VoidCard_H GetModelByCache(string Number)
		{
			
			string CacheKey = "SVA_VoidCard_HModel-" + Number;
			...
			return (Edge.SVA.Model.SVA_VoidCard_H)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Edge.SVA.Model.SVA_VoidCard_H> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Edge.SVA.Model.SVA_VoidCard_H> DataTableToList(DataTable dt)
		{
			List<Edge.SVA.Model.SVA_VoidCard_H> modelList = new List<Edge.SVA.Model.SVA_VoidCard_H>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Edge.SVA.Model.SVA_VoidCard_H model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Edge.SVA.Model.SVA_VoidCard_H();
