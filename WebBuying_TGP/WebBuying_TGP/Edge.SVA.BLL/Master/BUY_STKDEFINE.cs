...
namespace Edge.SVA.BLL
{
	...
	{
		private readonly IBUY_STKDEFINE dal=DataAccess.CreateBUY_STKDEFINE();
		...
		{
			return dal.Exists(STKDefineCode,StoreCode,DeptCode,KeyID);
		}
		...
		public bool Delete(string STKDefineCode,string StoreCode,string DeptCode,int KeyID)
		{
			...
			return dal.Delete(STKDefineCode,StoreCode,DeptCode,KeyID);
		}
		/// <summary>
		/// 删除一条数据
		/// </summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Edge.SVA.Model.BUY_STKDEFINE GetModelByCache(int KeyID)
		{
			
			string CacheKey = "BUY_STKDEFINEModel-" + KeyID;
			...
			return (Edge.SVA.Model.BUY_STKDEFINE)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Edge.SVA.Model.BUY_STKDEFINE> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Edge.SVA.Model.BUY_STKDEFINE> DataTableToList(DataTable dt)
		{
			List<Edge.SVA.Model.BUY_STKDEFINE> modelList = new List<Edge.SVA.Model.BUY_STKDEFINE>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Edge.SVA.Model.BUY_STKDEFINE model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Edge.SVA.Model.BUY_STKDEFINE();
					if(dt.Rows[n]["KeyID"]!=null && dt.Rows[n]["KeyID"].ToString()!="")
					{
						model.KeyID=int.Parse(dt.Rows[n]["KeyID"].ToString());
					}
					if(dt.Rows[n]["STKDefineCode"]!=null && dt.Rows[n]["STKDefineCode"].ToString()!="")
					{
					model.STKDefineCode=dt.Rows[n]["STKDefineCode"].ToString();
					}
