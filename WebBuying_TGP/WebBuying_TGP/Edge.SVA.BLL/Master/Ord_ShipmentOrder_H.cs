...
namespace Edge.SVA.BLL
{
	...
	/// PO单主表
	/// </summary>
	public partial class Ord_ShipmentOrder_H
	{
		private readonly IOrd_ShipmentOrder_H dal=DataAccess.CreateOrd_ShipmentOrder_H();
		...
		/// 得到一个对象实体
		/// </summary>
		public Edge.SVA.Model.Ord_ShipmentOrder_H GetModel(string POCode)
		{
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Edge.SVA.Model.Ord_ShipmentOrder_H GetModelByCache(string POCode)
		{
			
			string CacheKey = "Ord_ShipmentOrder_HModel-" + POCode;
			...
			return (Edge.SVA.Model.Ord_ShipmentOrder_H)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Edge.SVA.Model.Ord_ShipmentOrder_H> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Edge.SVA.Model.Ord_ShipmentOrder_H> DataTableToList(DataTable dt)
		{
			List<Edge.SVA.Model.Ord_ShipmentOrder_H> modelList = new List<Edge.SVA.Model.Ord_ShipmentOrder_H>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Edge.SVA.Model.Ord_ShipmentOrder_H model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Edge.SVA.Model.Ord_ShipmentOrder_H();

                    if (dt.Rows[n]["ShipmentOrderNumber"] != null && dt.Rows[n]["ShipmentOrderNumber"].ToString() != "")
                    {
                        model.ShipmentOrderNumber = dt.Rows[n]["ShipmentOrderNumber"].ToString();
                    }
