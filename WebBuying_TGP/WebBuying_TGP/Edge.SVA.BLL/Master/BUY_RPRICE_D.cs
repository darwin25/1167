...
namespace Edge.SVA.BLL
{
	...
	{
		private readonly IBUY_RPRICE_D dal=DataAccess.CreateBUY_RPRICE_D();
		public BUY_RPRICE_D()
		{}
		#region  Method
        ...
        public bool DeleteStr(string strWhere)
       {
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Edge.SVA.Model.BUY_RPRICE_D GetModelByCache(int KeyID)
		{
			
			string CacheKey = "BUY_RPRICE_DModel-" + KeyID;
			...
			return (Edge.SVA.Model.BUY_RPRICE_D)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Edge.SVA.Model.BUY_RPRICE_D> GetModelList(string strWhere)
		{
		...
		{
			List<Edge.SVA.Model.BUY_RPRICE_D> modelList = new List<Edge.SVA.Model.BUY_RPRICE_D>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Edge.SVA.Model.BUY_RPRICE_D model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Edge.SVA.Model.BUY_RPRICE_D();
