...
namespace Edge.SVA.BLL
{
    ...
    /// PO单主表
    /// </summary>
    public partial class Ord_ReceiveOrder_H
    {
        private readonly IOrd_ReceiveOrder_H dal = DataAccess.CreateOrd_ReceiveOrder_H();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Edge.SVA.Model.Ord_ReceiveOrder_H GetModel(string POCode)
        {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public Edge.SVA.Model.Ord_ReceiveOrder_H GetModelByCache(string POCode)
        {

            string CacheKey = "Ord_ReceiveOrder_HModel-" + POCode;
            ...
            return (Edge.SVA.Model.Ord_ReceiveOrder_H)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<Edge.SVA.Model.Ord_ReceiveOrder_H> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Edge.SVA.Model.Ord_ReceiveOrder_H> DataTableToList(DataTable dt)
        {
            List<Edge.SVA.Model.Ord_ReceiveOrder_H> modelList = new List<Edge.SVA.Model.Ord_ReceiveOrder_H>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Edge.SVA.Model.Ord_ReceiveOrder_H model;
                for (int n = 0; n < rowsCount; n++)
                {
                    model = new Edge.SVA.Model.Ord_ReceiveOrder_H();
        ...
        {
            return dal.ExportStoreReceiveData(ReceiveOrderNumber, OrderType);
        }

        public DataSet GetReceiveOrderHeader(string ShipmentOrderNumber)
        {
            return dal.GetReceiveOrderHeader(ShipmentOrderNumber);
        }

        public DataSet GetReceiveOrderDetail(string ShipmentOrderNumber)
        {
            return dal.GetReceiveOrderDetail(ShipmentOrderNumber);
        }
