...
namespace Edge.SVA.BLL
{
	...
	{
		private readonly IPromotion_Hit_PLU dal=DataAccess.CreatePromotion_Hit_PLU();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Edge.SVA.Model.Promotion_Hit_PLU GetModelByCache(int KeyID)
		{
			
			string CacheKey = "Promotion_Hit_PLUModel-" + KeyID;
			...
			return (Edge.SVA.Model.Promotion_Hit_PLU)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Edge.SVA.Model.Promotion_Hit_PLU> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Edge.SVA.Model.Promotion_Hit_PLU> DataTableToList(DataTable dt)
		{
			List<Edge.SVA.Model.Promotion_Hit_PLU> modelList = new List<Edge.SVA.Model.Promotion_Hit_PLU>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Edge.SVA.Model.Promotion_Hit_PLU model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Edge.SVA.Model.Promotion_Hit_PLU();
