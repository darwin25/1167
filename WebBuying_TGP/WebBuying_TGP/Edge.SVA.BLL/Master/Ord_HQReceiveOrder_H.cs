...
namespace Edge.SVA.BLL
{
    ...
    /// PO单主表
    /// </summary>
    public partial class Ord_HQReceiveOrder_H
    {
        private readonly IOrd_HQReceiveOrder_H dal = DataAccess.CreateOrd_HQReceiveOrder_H();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Edge.SVA.Model.Ord_HQReceiveOrder_H GetModel(string POCode)
        {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public Edge.SVA.Model.Ord_HQReceiveOrder_H GetModelByCache(string POCode)
        {

            string CacheKey = "Ord_HQReceiveOrder_HModel-" + POCode;
            ...
            return (Edge.SVA.Model.Ord_HQReceiveOrder_H)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<Edge.SVA.Model.Ord_HQReceiveOrder_H> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Edge.SVA.Model.Ord_HQReceiveOrder_H> DataTableToList(DataTable dt)
        {
            List<Edge.SVA.Model.Ord_HQReceiveOrder_H> modelList = new List<Edge.SVA.Model.Ord_HQReceiveOrder_H>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Edge.SVA.Model.Ord_HQReceiveOrder_H model;
                for (int n = 0; n < rowsCount; n++)
                {
                    model = new Edge.SVA.Model.Ord_HQReceiveOrder_H();
