...
namespace Edge.SVA.BLL
{
	...
	{
		private readonly IBUY_PO_D dal=DataAccess.CreateBUY_PO_D();
		public BUY_PO_D()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Edge.SVA.Model.BUY_PO_D GetModelByCache(int KeyID)
		{
			
			string CacheKey = "BUY_PO_DModel-" + KeyID;
			...
			return (Edge.SVA.Model.BUY_PO_D)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Edge.SVA.Model.BUY_PO_D> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Edge.SVA.Model.BUY_PO_D> DataTableToList(DataTable dt)
		{
			List<Edge.SVA.Model.BUY_PO_D> modelList = new List<Edge.SVA.Model.BUY_PO_D>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Edge.SVA.Model.BUY_PO_D model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Edge.SVA.Model.BUY_PO_D();
