...
namespace Edge.SVA.BLL
{
	...
	{
		private readonly IOrd_CouponPicking_D dal=DataAccess.CreateOrd_CouponPicking_D();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Edge.SVA.Model.Ord_CouponPicking_D GetModelByCache(int KeyID)
		{
			
			string CacheKey = "Ord_CouponPicking_DModel-" + KeyID;
			...
			return (Edge.SVA.Model.Ord_CouponPicking_D)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Edge.SVA.Model.Ord_CouponPicking_D> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Edge.SVA.Model.Ord_CouponPicking_D> DataTableToList(DataTable dt)
		{
			List<Edge.SVA.Model.Ord_CouponPicking_D> modelList = new List<Edge.SVA.Model.Ord_CouponPicking_D>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Edge.SVA.Model.Ord_CouponPicking_D model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Edge.SVA.Model.Ord_CouponPicking_D();
					...
					if(dt.Rows[n]["PickupDateTime"]!=null && dt.Rows[n]["PickupDateTime"].ToString()!="")
					{
						model.PickupDateTime=DateTime.Parse(dt.Rows[n]["PickupDateTime"].ToString());
					}
					modelList.Add(model);
				}
			}
