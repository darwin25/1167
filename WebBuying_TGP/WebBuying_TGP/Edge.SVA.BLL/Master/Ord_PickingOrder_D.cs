...
namespace Edge.SVA.BLL
{
	...
	{
		private readonly IOrd_PickingOrder_D dal=DataAccess.CreateOrd_PickingOrder_D();
        ...
        {
            return dal.Delete(PickingOrderNumber);
        }
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Edge.SVA.Model.Ord_PickingOrder_D GetModelByCache(int KeyID)
		{
			
			string CacheKey = "Ord_PickingOrder_DModel-" + KeyID;
			...
			return (Edge.SVA.Model.Ord_PickingOrder_D)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Edge.SVA.Model.Ord_PickingOrder_D> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Edge.SVA.Model.Ord_PickingOrder_D> DataTableToList(DataTable dt)
		{
			List<Edge.SVA.Model.Ord_PickingOrder_D> modelList = new List<Edge.SVA.Model.Ord_PickingOrder_D>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Edge.SVA.Model.Ord_PickingOrder_D model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Edge.SVA.Model.Ord_PickingOrder_D();
