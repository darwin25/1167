...
namespace Edge.SVA.BLL
{
	...
	{
		private readonly IOrd_CouponDelivery_H dal=DataAccess.CreateOrd_CouponDelivery_H();
		...
		{
			return dal.Exists(CouponDeliveryNumber);
		}
		...
		public bool Delete(string CouponDeliveryNumber)
		{
			...
			return dal.Delete(CouponDeliveryNumber);
		}
		/// <summary>
		/// 删除一条数据
		/// </summary>
		...
		{
			return dal.DeleteList(CouponDeliveryNumberlist );
		}
		...
		public Edge.SVA.Model.Ord_CouponDelivery_H GetModel(string CouponDeliveryNumber)
		{
			...
			return dal.GetModel(CouponDeliveryNumber);
		}

		/// <summary>
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Edge.SVA.Model.Ord_CouponDelivery_H GetModelByCache(string CouponDeliveryNumber)
		{
			
			string CacheKey = "Ord_CouponDelivery_HModel-" + CouponDeliveryNumber;
			object objModel = Edge.Common.DataCache.GetCache(CacheKey);
			if (objModel == null)
			{
				try
				{
					objModel = dal.GetModel(CouponDeliveryNumber);
					if (objModel != null)
					{
			...
			return (Edge.SVA.Model.Ord_CouponDelivery_H)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Edge.SVA.Model.Ord_CouponDelivery_H> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Edge.SVA.Model.Ord_CouponDelivery_H> DataTableToList(DataTable dt)
		{
			List<Edge.SVA.Model.Ord_CouponDelivery_H> modelList = new List<Edge.SVA.Model.Ord_CouponDelivery_H>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Edge.SVA.Model.Ord_CouponDelivery_H model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Edge.SVA.Model.Ord_CouponDelivery_H();
