...
namespace Edge.SVA.BLL
{
	...
	{
		private readonly IOrd_ShipmentOrder_D dal=DataAccess.CreateOrd_ShipmentOrder_D();
        ...
        {
            return dal.Delete(ShipmentOrderNumber);
        }
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Edge.SVA.Model.Ord_ShipmentOrder_D GetModelByCache(int KeyID)
		{
			
			string CacheKey = "Ord_ShipmentOrder_DModel-" + KeyID;
			...
			return (Edge.SVA.Model.Ord_ShipmentOrder_D)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Edge.SVA.Model.Ord_ShipmentOrder_D> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Edge.SVA.Model.Ord_ShipmentOrder_D> DataTableToList(DataTable dt)
		{
			List<Edge.SVA.Model.Ord_ShipmentOrder_D> modelList = new List<Edge.SVA.Model.Ord_ShipmentOrder_D>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Edge.SVA.Model.Ord_ShipmentOrder_D model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Edge.SVA.Model.Ord_ShipmentOrder_D();
