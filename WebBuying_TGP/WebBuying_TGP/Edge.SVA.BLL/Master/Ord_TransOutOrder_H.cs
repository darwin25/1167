...
namespace Edge.SVA.BLL
{
    ...
    {
        private readonly IOrd_TransOutOrder_H dal = DataAccess.CreateOrd_TransOutOrder_H();
        ...
        /// 得到一个对象实体
        /// </summary>
        public Edge.SVA.Model.Ord_TransOutOrder_H GetModel(string POCode)
        {
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public Edge.SVA.Model.Ord_TransOutOrder_H GetModelByCache(string POCode)
        {

            string CacheKey = "Ord_TransOutOrder_HModel-" + POCode;
            ...
            return (Edge.SVA.Model.Ord_TransOutOrder_H)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<Edge.SVA.Model.Ord_TransOutOrder_H> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<Edge.SVA.Model.Ord_TransOutOrder_H> DataTableToList(DataTable dt)
        {
            List<Edge.SVA.Model.Ord_TransOutOrder_H> modelList = new List<Edge.SVA.Model.Ord_TransOutOrder_H>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                Edge.SVA.Model.Ord_TransOutOrder_H model;
                for (int n = 0; n < rowsCount; n++)
                {
                    model = new Edge.SVA.Model.Ord_TransOutOrder_H();

                    if (dt.Rows[n]["TransOutOrderNumber"] != null && dt.Rows[n]["TransOutOrderNumber"].ToString() != "")
                    {
                        model.TransOutOrderNumber = dt.Rows[n]["TransOutOrderNumber"].ToString();
                    }
