...
namespace Edge.SVA.BLL
{
	...
	{
		private readonly IBUY_PRODUCTCLASS dal=DataAccess.CreateBUY_PRODUCTCLASS();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Edge.SVA.Model.BUY_PRODUCTCLASS GetModelByCache(int ProdClassID)
		{
			
			string CacheKey = "BUY_PRODUCTCLASSModel-" + ProdClassID;
			...
			return (Edge.SVA.Model.BUY_PRODUCTCLASS)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Edge.SVA.Model.BUY_PRODUCTCLASS> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Edge.SVA.Model.BUY_PRODUCTCLASS> DataTableToList(DataTable dt)
		{
			List<Edge.SVA.Model.BUY_PRODUCTCLASS> modelList = new List<Edge.SVA.Model.BUY_PRODUCTCLASS>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Edge.SVA.Model.BUY_PRODUCTCLASS model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Edge.SVA.Model.BUY_PRODUCTCLASS();
