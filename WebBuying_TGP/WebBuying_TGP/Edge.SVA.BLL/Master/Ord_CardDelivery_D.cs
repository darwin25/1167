...
namespace Edge.SVA.BLL
{
	/// <summary>
	/// 卡送货单子表
	///根据 Ord_CardPicking_D产生
	/// </summary>
	public partial class Ord_CardDelivery_D
	{
		private readonly IOrd_CardDelivery_D dal=DataAccess.CreateOrd_CardDelivery_D();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Edge.SVA.Model.Ord_CardDelivery_D GetModelByCache(int KeyID)
		{
			
			string CacheKey = "Ord_CardDelivery_DModel-" + KeyID;
			...
			return (Edge.SVA.Model.Ord_CardDelivery_D)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Edge.SVA.Model.Ord_CardDelivery_D> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Edge.SVA.Model.Ord_CardDelivery_D> DataTableToList(DataTable dt)
		{
			List<Edge.SVA.Model.Ord_CardDelivery_D> modelList = new List<Edge.SVA.Model.Ord_CardDelivery_D>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Edge.SVA.Model.Ord_CardDelivery_D model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new Edge.SVA.Model.Ord_CardDelivery_D();
