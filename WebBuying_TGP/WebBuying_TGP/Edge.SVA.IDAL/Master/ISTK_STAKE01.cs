...
namespace Edge.SVA.IDAL
{
    ...
    public interface ISTK_STake01
	{
		...
		/// 增加一条数据
		/// </summary>
		int Add(Edge.SVA.Model.STK_STAKE01 model);
		/// <summary>
		/// 更新一条数据
		/// </summary>
		bool Update(Edge.SVA.Model.STK_STAKE01 model);
		/// <summary>
		/// 删除一条数据
		/// </summary>
		...
		/// 得到一个对象实体
		/// </summary>
        Edge.SVA.Model.STK_STAKE01 GetModel(string StockTakeNumber, int StoreID, string ProdCode, string StoreType, string SerialNo);
		/// <summary>
		/// 获得数据列表
		/// </summary>
