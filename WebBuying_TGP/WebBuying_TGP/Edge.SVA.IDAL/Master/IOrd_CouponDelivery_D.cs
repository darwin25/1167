...
{
	/// <summary>
	/// 接口层优惠劵送货单子表  根据 Ord_CouponPicking_D产生
	/// </summary>
	public partial interface IOrd_CouponDelivery_D
	{
		...
		/// 增加一条数据
		/// </summary>
		int Add(Edge.SVA.Model.Ord_CouponDelivery_D model);
		/// <summary>
		/// 更新一条数据
		/// </summary>
		bool Update(Edge.SVA.Model.Ord_CouponDelivery_D model);
		/// <summary>
		/// 删除一条数据
		/// </summary>
		...
		/// 得到一个对象实体
		/// </summary>
		Edge.SVA.Model.Ord_CouponDelivery_D GetModel(int KeyID);
		/// <summary>
		/// 获得数据列表
		/// </summary>
