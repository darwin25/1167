...
namespace Edge.SVA.IDAL
{
    ...
    /// 接口层卡订货单明细。 表中brandID
    /// </summary>
    public interface IOrd_TransInOrder_D
    {
        #region  成员方法
        /// <summary>
        /// 得到最大ID
        ...
        /// 增加一条数据
        /// </summary>
        int Add(Edge.SVA.Model.Ord_TransInOrder_D model);
        /// <summary>
        /// 更新一条数据
        /// </summary>
        bool Update(Edge.SVA.Model.Ord_TransInOrder_D model);
        /// <summary>
        /// 删除一条数据
        /// </summary>
        ...
        /// 得到一个对象实体
        /// </summary>
        Edge.SVA.Model.Ord_TransInOrder_D GetModel(int KeyID);
        /// <summary>
        /// 获得数据列表
        /// </summary>
