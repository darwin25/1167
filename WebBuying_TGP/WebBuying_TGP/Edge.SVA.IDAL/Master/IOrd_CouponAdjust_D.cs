...
namespace Edge.SVA.IDAL
{
    ...
    public partial interface IOrd_CouponAdjust_D
	{
		...
		/// 增加一条数据
		/// </summary>
		int Add(Edge.SVA.Model.Ord_CouponAdjust_D model);
		/// <summary>
		/// 更新一条数据
		/// </summary>
		bool Update(Edge.SVA.Model.Ord_CouponAdjust_D model);
		/// <summary>
		/// 删除一条数据
		/// </summary>
		...
		/// 得到一个对象实体
		/// </summary>
		Edge.SVA.Model.Ord_CouponAdjust_D GetModel(int KeyID);
		/// <summary>
		/// 获得数据列表
		/// </summary>
